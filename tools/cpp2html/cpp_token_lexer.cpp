...
{
    static soul::ast::common::TokenCollection tokens("cpp.token.lexer.tokens");
    if (!tokens.Initialized())
    {
        ...
        tokens.AddToken(new soul::ast::common::Token(FLOATLIT, "FLOATLIT", "floating literal"));
        tokens.AddToken(new soul::ast::common::Token(INTLIT, "INTLIT", "integer literal"));
        tokens.AddToken(new soul::ast::common::Token(CHARLIT, "CHARLIT", "character literal"));
        tokens.AddToken(new soul::ast::common::Token(STRINGLIT, "STRINGLIT", "string literal"));
        tokens.AddToken(new soul::ast::common::Token(BEGINRAWSTRINGLIT, "BEGINRAWSTRINGLIT", "'begin raw string literal'"));
        tokens.AddToken(new soul::ast::common::Token(COLONCOLON, "COLONCOLON", "'::'"));
        tokens.AddToken(new soul::ast::common::Token(COMMA, "COMMA", "','"));
        tokens.AddToken(new soul::ast::common::Token(ASSIGN, "ASSIGN", "'='"));
        tokens.AddToken(new soul::ast::common::Token(MULASSIGN, "MULASSIGN", "'*='"));
        tokens.AddToken(new soul::ast::common::Token(DIVASSIGN, "DIVASSIGN", "'/='"));
        tokens.AddToken(new soul::ast::common::Token(REMASSIGN, "REMASSIGN", "'%='"));
        tokens.AddToken(new soul::ast::common::Token(ADDASSIGN, "ADDASSIGN", "'+='"));
        tokens.AddToken(new soul::ast::common::Token(SUBASSIGN, "SUBASSIGN", "'-='"));
        tokens.AddToken(new soul::ast::common::Token(SHIFTRIGHTASSIGN, "SHIFTRIGHTASSIGN", "'>>='"));
        tokens.AddToken(new soul::ast::common::Token(SHIFTLEFTASSIGN, "SHIFTLEFTASSIGN", "'<<='"));
        tokens.AddToken(new soul::ast::common::Token(ANDASSIGN, "ANDASSIGN", "'&='"));
        tokens.AddToken(new soul::ast::common::Token(XORASSIGN, "XORASSIGN", "'^='"));
        tokens.AddToken(new soul::ast::common::Token(ORASSIGN, "ORASSIGN", "'|='"));
        tokens.AddToken(new soul::ast::common::Token(QUEST, "QUEST", "'?'"));
        tokens.AddToken(new soul::ast::common::Token(COLON, "COLON", "':'"));
        tokens.AddToken(new soul::ast::common::Token(OROR, "OROR", "'||'"));
        tokens.AddToken(new soul::ast::common::Token(AMPAMP, "AMPAMP", "'&&'"));
        ...
        tokens.AddToken(new soul::ast::common::Token(SPACESHIP, "SPACESHIP", "<=>"));
        tokens.AddToken(new soul::ast::common::Token(LANGLE, "LANGLE", "'<'"));
        tokens.AddToken(new soul::ast::common::Token(RANGLE, "RANGLE", "'>'"));
        tokens.AddToken(new soul::ast::common::Token(SHIFTLEFT, "SHIFTLEFT", "'<<'"));
        tokens.AddToken(new soul::ast::common::Token(SHIFTRIGHT, "SHIFTRIGHT", "'>>'"));
        ...
        tokens.AddToken(new soul::ast::common::Token(DOTSTAR, "DOTSTAR", "'.*'"));
        tokens.AddToken(new soul::ast::common::Token(ARROWSTAR, "ARROWSTAR", "'->*'"));
        tokens.AddToken(new soul::ast::common::Token(LPAREN, "LPAREN", "'('"));
        tokens.AddToken(new soul::ast::common::Token(RPAREN, "RPAREN", "')'"));
        tokens.AddToken(new soul::ast::common::Token(PLUSPLUS, "PLUSPLUS", "'++'"));
        tokens.AddToken(new soul::ast::common::Token(MINUSMINUS, "MINUSMINUS", "'--'"));
        ...
        tokens.AddToken(new soul::ast::common::Token(LINECOMMENT, "LINECOMMENT", "line comment"));
        tokens.AddToken(new soul::ast::common::Token(BLOCKCOMMENT, "BLOCKCOMMENT", "block comment"));
        tokens.AddToken(new soul::ast::common::Token(BLOCKCOMMENTLINE, "BLOCKCOMMENTLINE", "block comment line"));
        ...
        tokens.AddToken(new soul::ast::common::Token(PP, "PP", "pp"));
        tokens.AddToken(new soul::ast::common::Token(OTHER, "OTHER", "other"));
        tokens.AddToken(new soul::ast::common::Token(__THREAD, "__THREAD", "'__thread'"));
        tokens.AddToken(new soul::ast::common::Token(__DECLSPEC, "__DECLSPEC", "'__declspec'"));
        tokens.AddToken(new soul::ast::common::Token(__CDECL, "__CDECL", "'__cdecl'"));
        tokens.AddToken(new soul::ast::common::Token(__FASTCALL, "__FASTCALL", "'__fastcall'"));
        tokens.AddToken(new soul::ast::common::Token(__STDCALL, "__STDCALL", "'__stdcall'"));
        tokens.AddToken(new soul::ast::common::Token(__THISCALL, "__THISCALL", "'__thiscall'"));
        tokens.AddToken(new soul::ast::common::Token(__VECTORCALL, "__VECTORCALL", "'__vectorcall'"));
        tokens.AddToken(new soul::ast::common::Token(__INT64, "__INT64", "'__int64'"));
        tokens.AddToken(new soul::ast::common::Token(__INT32, "__INT32", "'__int32'"));
        tokens.AddToken(new soul::ast::common::Token(__INT16, "__INT16", "'__int16'"));
        tokens.AddToken(new soul::ast::common::Token(__INT8, "__INT8", "'__int8'"));
        tokens.AddToken(new soul::ast::common::Token(__UNALIGNED, "__UNALIGNED", "'__unaligned'"));
        tokens.AddToken(new soul::ast::common::Token(__INLINE, "__INLINE", "'__inline'"));
        tokens.AddToken(new soul::ast::common::Token(__NULLPTR, "__NULLPTR", "'__nullptr'"));
        tokens.AddToken(new soul::ast::common::Token(__PRAGMA, "__PRAGMA", "'__pragma'"));
