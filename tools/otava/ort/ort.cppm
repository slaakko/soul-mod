...
export extern "C" void* ort_debug_operator_new(void* block, const char* function, const char* sourceFilePath, int line);
export extern "C" void ort_print_memory_leaks();
export extern "C" void ort_preprocess_args(int argc, const char** argv, int* pargc, const char*** pargv);
...
export extern "C" std::uint64_t ort_file_size(const char* filePath);
export extern "C" std::int64_t ort_last_write_time(const char* filePath);
export extern "C" void ort_set_last_write_time(const char* dest, const char* source);
export extern "C" void ort_create_directories(const char* directoryPath);
...
export extern "C" void ort_debug_break();
export extern "C" bool ort_path_exists(const char* path);
