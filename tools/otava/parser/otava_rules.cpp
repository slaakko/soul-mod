...
std::map<int64_t, std::string>* GetRuleNameMapPtr()
{
    ...
    static std::map<int64_t, std::string> ruleNameMap = {
        ...
        { 1303477245251158042, "ClassParser.MemberInitializerList" },
        { 1303477245251158043, "ClassParser.MemberInitializer" },
        { 1303477245251158044, "ClassParser.MemberInitializerId" },
        { 1303477245251158045, "ClassParser.PureSpecifier" },
        { 1303477245251158046, "ClassParser.AccessSpecifier" },
        { 1303477245251158047, "ClassParser.Private" },
        { 1303477245251158048, "ClassParser.VirtualSpecifier" },
        ...
        { 3962850076434366470, "GuardParser.NoDeclSpecFunctionDeclarationGuard" },
        { 3962850076434366471, "GuardParser.NoDeclSpecFunctionDefinitionGuard" },
