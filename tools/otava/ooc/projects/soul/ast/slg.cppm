...
public:
    ...
    inline const std::vector<std::unique_ptr<Keyword>>& GetKeywords() const noexcept { return keywords; }
private:
...
public:
    ...
    inline const std::vector<std::unique_ptr<Expression>>& GetExpressions() const noexcept { return expressions; }
private:
