...
public:
    ...
    inline const std::map<std::string, std::unique_ptr<AttributeNode>>& Attributes() const noexcept { return attributeMap; }
    AttributeNode* GetAttributeNode(const std::string& attributeName) const noexcept;
