...
{
public:
    Expr(ExprKind kind_) noexcept;
    virtual ~Expr();
    inline ExprKind Kind() const noexcept { return kind; }
...
{
public:
    UnaryExpr(Operator op_, Expr* operand_) noexcept;
    inline Operator Op() const noexcept { return op; }
    inline Expr* Operand() const noexcept { return operand.get(); }
...
{
public:
    BinaryExpr(Operator op_, Expr* left_, Expr* right_) noexcept;
    inline Operator Op() const noexcept { return op; }
    inline Expr* Left() const noexcept { return left.get(); }
    inline Expr* Right() const noexcept { return right.get(); }
    std::unique_ptr<soul::xml::xpath::Object> Evaluate(Context& context) const override;
    soul::xml::Element* ToXmlElement() const override;
private:
    Operator op;
...
{
public:
    FilterExpr(Expr* subject_, Expr* predicate_) noexcept;
    inline Expr* Subject() const noexcept { return subject.get(); }
    inline Expr* Predicate() const noexcept { return predicate.get(); }
    std::unique_ptr<soul::xml::xpath::Object> Evaluate(Context& context) const override;
    soul::xml::Element* ToXmlElement() const override;
private:
...
{
public:
    NodeTest(NodeTestKind kind_) noexcept;
    virtual ~NodeTest();
    inline NodeTestKind Kind() const noexcept { return kind; }
...
{
public:
    PILiteralNodeTest(Literal* literal_) noexcept;
    inline Literal* Lit() const noexcept { return literal.get(); }
...
public:
    ...
    inline const std::string& Prefix() const noexcept { return prefix; }
    bool Select(soul::xml::Node* node, soul::xml::Axis axis) const override;
    soul::xml::Element* ToXmlElement() const override;
private:
    std::string prefix;
...
public:
    ...
    inline NodeTest* GetNodeTest() const noexcept { return nodeTest.get(); }
    void AddPredicate(Expr* predicate);
    inline const std::vector<std::unique_ptr<Expr>>& Predicates() const noexcept { return predicates; }
    std::unique_ptr<soul::xml::xpath::Object> Evaluate(Context& context) const override;
    soul::xml::Element* ToXmlElement() const override;
private:
    soul::xml::Axis axis;
...
public:
    ...
    inline const std::string& VariableName() const noexcept { return variableName; }
    std::unique_ptr<soul::xml::xpath::Object> Evaluate(Context& context) const override;
    soul::xml::Element* ToXmlElement() const override;
private:
...
{
public:
    NumberExpr(double value_) noexcept;
...
public:
    ...
    inline const std::string& FunctionName() const noexcept { return functionName; }
