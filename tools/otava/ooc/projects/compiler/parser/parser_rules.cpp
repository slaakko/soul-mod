...
std::map<std::int64_t, std::string>* GetRuleNameMapPtr()
{
    ...
    static std::map<std::int64_t, std::string> ruleNameMap = {
        ...
        { 8966079074640330753, "DeclarationParser.DeclarationSpecifierSequence" },
        { 8966079074640330754, "DeclarationParser.DeclarationSeq" },
        { 8966079074640330755, "DeclarationParser.NamespaceDeclarationSeq" },
        { 8966079074640330756, "DeclarationParser.RBraceNext" },
        { 8966079074640330757, "DeclarationParser.Declaration" },
        { 8966079074640330758, "DeclarationParser.BlockDeclaration" },
        { 8966079074640330759, "DeclarationParser.NoDeclSpecFunctionDeclaration" },
        { 8966079074640330760, "DeclarationParser.EmptyDeclaration" },
        { 8966079074640330761, "DeclarationParser.SimpleDeclaration" },
        { 8966079074640330762, "DeclarationParser.AsmDeclaration" },
        { 8966079074640330763, "DeclarationParser.Asm" },
        { 8966079074640330764, "DeclarationParser.LinkageSpecification" },
        { 8966079074640330765, "DeclarationParser.NamespaceDefinition" },
        { 8966079074640330766, "DeclarationParser.NamedNamespaceDefinition" },
        { 8966079074640330767, "DeclarationParser.UnnamedNamespaceDefinition" },
        { 8966079074640330768, "DeclarationParser.NestedNamespaceDefinition" },
        { 8966079074640330769, "DeclarationParser.NamespaceAliasDefinition" },
        { 8966079074640330770, "DeclarationParser.QualifiedNamespaceSpecifier" },
        { 8966079074640330771, "DeclarationParser.NamespaceBody" },
        { 8966079074640330772, "DeclarationParser.NestedNamespaceSpecifier" },
        { 8966079074640330773, "DeclarationParser.Namespace" },
        { 8966079074640330774, "DeclarationParser.NamespaceName" },
        { 8966079074640330775, "DeclarationParser.UsingDeclaration" },
        { 8966079074640330776, "DeclarationParser.Using" },
        { 8966079074640330777, "DeclarationParser.UsingDeclaratorList" },
        { 8966079074640330778, "DeclarationParser.UsingDeclarator" },
        { 8966079074640330779, "DeclarationParser.UsingEnumDeclaration" },
        { 8966079074640330780, "DeclarationParser.UsingDirective" },
        { 8966079074640330781, "DeclarationParser.StaticAssertDeclaration" },
        { 8966079074640330782, "DeclarationParser.StaticAssert" },
        { 8966079074640330783, "DeclarationParser.AliasDeclaration" },
        { 8966079074640330784, "DeclarationParser.DeclSpecifierSeq" },
        { 8966079074640330785, "DeclarationParser.Inline" },
        { 8966079074640330786, "DeclarationParser.DeclSpecifier" },
        { 8966079074640330787, "DeclarationParser.StorageClassSpecifier" },
        { 8966079074640330788, "DeclarationParser.FunctionSpecifier" },
        { 8966079074640330789, "DeclarationParser.ExplicitSpecifier" },
        { 8966079074640330790, "DeclarationParser.InitDeclaratorList" },
        { 8966079074640330791, "DeclarationParser.InitDeclarator" },
        { 8966079074640330792, "DeclarationParser.DeclaratorPushClassScope" },
        { 8966079074640330793, "DeclarationParser.Declarator" },
        { 8966079074640330794, "DeclarationParser.PtrDeclarator" },
        { 8966079074640330795, "DeclarationParser.NoPtrDeclarator" },
        { 8966079074640330796, "DeclarationParser.ParametersAndQualifiers" },
        { 8966079074640330797, "DeclarationParser.TrailingReturnType" },
        { 8966079074640330798, "DeclarationParser.PtrOperator" },
        { 8966079074640330799, "DeclarationParser.AbstractDeclarator" },
        { 8966079074640330800, "DeclarationParser.NoPtrAbstractDeclarator" },
        { 8966079074640330801, "DeclarationParser.PtrAbstractDeclarator" },
        { 8966079074640330802, "DeclarationParser.AbstractPackDeclarator" },
        { 8966079074640330803, "DeclarationParser.NoPtrAbstractPackDeclarator" },
        { 8966079074640330804, "DeclarationParser.DeclaratorId" },
        { 8966079074640330805, "DeclarationParser.Ptr" },
        { 8966079074640330806, "DeclarationParser.LvalueRef" },
        { 8966079074640330807, "DeclarationParser.RvalueRef" },
        { 8966079074640330808, "DeclarationParser.RefQualifier" },
        { 8966079074640330809, "DeclarationParser.CVQualifierSeq" },
        { 8966079074640330810, "DeclarationParser.CVQualifier" },
        { 8966079074640330811, "DeclarationParser.NoexceptSpecifier" },
        { 8966079074640330812, "DeclarationParser.ThrowSpecifier" },
        { 8966079074640330813, "DeclarationParser.AttributeDeclaration" },
        ...
        { 4756117359045902388, "ExpressionParser.ThrowExpression" },
        ...
        { 4569043890895585306, "StatementParser.TryStatement" },
        { 4569043890895585307, "StatementParser.HandlerSequence" },
        { 4569043890895585308, "StatementParser.Handler" },
        { 4569043890895585309, "StatementParser.ExceptionDeclaration" },
