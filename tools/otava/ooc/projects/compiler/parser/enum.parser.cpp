...
// this file has been automatically generated from 'D:/work/soul-mod/tools/otava/projects/compiler/parser/enum.parser' using soul parser generator ospg version 5.0.0
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::EnumeratorDefinitionNode(span, enumerator.release(), value.release(), assignSpan));
            }
        }
        *parentMatch0 = match;
    }
