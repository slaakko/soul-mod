...
// this file has been automatically generated from 'D:/work/soul-mod/tools/otava/projects/compiler/parser/identifier.parser' using soul parser generator ospg version 5.0.0
...
soul::parser::Match IdentifierParser<LexerT>::UnqualifiedId(LexerT& lexer, otava::symbols::Context* context)
{
    ...
    switch (*lexer)
    {
                ...
                soul::parser::Match* parentMatch2 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch3 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch4 = &match;
                        {
                            ...
                            {
                                std::int64_t pos = lexer.GetPos();
                                soul::parser::Match match = otava::parser::templates::TemplateParser<LexerT>::TemplateId(lexer, context);
                    ...
                    *parentMatch2 = match;
                    if (!match.hit)
                    {
                        ...
                        lexer.SetPos(save);
                        {
                            ...
                            {
                                std::int64_t pos = lexer.GetPos();
                                soul::parser::Match match = otava::parser::function::FunctionParser<LexerT>::ConversionFunctionId(lexer, context);
        ...
        case otava::token::TILDE:
        {
            ...
            {
                std::int64_t pos = lexer.GetPos();
                soul::parser::Match match = otava::parser::function::FunctionParser<LexerT>::DestructorId(lexer, context);
...
soul::parser::Match IdentifierParser<LexerT>::QualifiedId(LexerT& lexer, otava::symbols::Context* context)
{
    ...
    soul::ast::Span templatePos = soul::ast::Span();
                                        ...
                                        {
                                            {
                                                ...
                                                #endif
                                                return soul::parser::Match(true, new otava::ast::QualifiedIdNode(span, nns.release(), new otava::ast::PrefixNode(templatePos, tmp.release(), unqualifiedId.release())));
                                            }
                                        }
                                        *parentMatch9 = match;
                                    }
                                ...
                                {
                                    {
                                        ...
                                        if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "QualifiedId");
                                        #endif
                                        return soul::parser::Match(true, new otava::ast::QualifiedIdNode(span, nns.release(), unqualifiedId.release()));
                                    }
                                }
                                *parentMatch10 = match;
                            }
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            nnsNode.reset(new otava::ast::NestedNameSpecifierNode(lexer.GetSpan(pos)));
                        }
                        *parentMatch4 = match;
                    }
                    *parentMatch3 = match;
                        ...
                        soul::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch7 = &match;
                            {
                                ...
                                soul::parser::Match* parentMatch8 = &match;
                                {
                                    ...
                                    if (match.hit)
                                    {
                                        nnsNode->AddNode(new otava::ast::ColonColonNode(lexer.GetSpan(pos)));
                                    }
                                    *parentMatch8 = match;
                                }
                                *parentMatch7 = match;
                                                ...
                                                soul::parser::Match* parentMatch15 = &match;
                                                {
                                                    ...
                                                    soul::parser::Match* parentMatch16 = &match;
                                                    {
                                                        ...
                                                        soul::parser::Match* parentMatch17 = &match;
                                                        {
                                                            ...
                                                            if (match.hit)
                                                            {
                                                                nnsNode->AddNode(new otava::ast::TemplateNode(lexer.GetSpan(pos)));
                                                            }
                                                            *parentMatch17 = match;
                                                        }
                                                        *parentMatch16 = match;
                                            ...
                                            lexer.SetPos(save);
                                            {
                                                ...
                                                soul::parser::Match* parentMatch23 = &match;
                                                {
                                                    ...
                                                    soul::parser::Match* parentMatch24 = &match;
                                                    {
                                                        ...
                                                        if (match.hit)
                                                        {
                                                            idNode.reset(otava::parser::token::ParseIdentifier(lexer.GetSpan(pos), lexer.FileName(), lexer.GetToken(pos)));
                                                        }
                                                        *parentMatch24 = match;
                                                    }
                                                    *parentMatch23 = match;
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    if (match.hit)
                    {
                        identifierListNode.reset(new otava::ast::IdentifierListNode(lexer.GetSpan(pos)));
...
soul::parser::Match IdentifierParser<LexerT>::TypeIdentifier(LexerT& lexer, otava::symbols::Context* context)
{
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            soul::parser::Match match = otava::parser::guard::GuardParser<LexerT>::AssumeTypeGuard(lexer, context);
            *parentMatch1 = match;
        }
        if (match.hit)
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    soul::parser::Match match = otava::parser::identifier::IdentifierParser<LexerT>::TypeIdentifierUnchecked(lexer, context);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    soul::parser::Match match = otava::parser::identifier::IdentifierParser<LexerT>::TypeIdentifierChecked(lexer, context);
...
soul::parser::Match IdentifierParser<LexerT>::TypeIdentifierChecked(LexerT& lexer, otava::symbols::Context* context)
{
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            ...
            otava::symbols::Symbol *symbol = context->GetSymbolTable()->Lookup(identifier->Str(), otava::symbols::SymbolGroupKind::typeSymbolGroup, context->MakeFullSpan(lexer.GetSpan(pos)), context);
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::UnnamedNode(lexer.GetSpan(pos)));
            }
        }
        *parentMatch0 = match;
    }
