...
// this file has been automatically generated from 'D:/work/soul-mod/tools/otava/projects/compiler/parser/attribute.parser' using soul parser generator ospg version 5.0.0
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    soul::parser::Match match = otava::parser::attribute::AttributeParser<LexerT>::AttributeSpecifier(lexer, context);
                    first.reset(static_cast<otava::ast::Node*>(match.value));
                    if (match.hit)
                    {
                        node.reset(new otava::ast::AttributeSpecifierSequenceNode(lexer.GetSpan(pos)));
...
soul::parser::Match AttributeParser<LexerT>::AttributeSpecifier(LexerT& lexer, otava::symbols::Context* context)
{
    ...
    soul::ast::Span lbSpan1 = soul::ast::Span();
    soul::ast::Span lbSpan2 = soul::ast::Span();
    soul::ast::Span rbSpan1 = soul::ast::Span();
    soul::ast::Span rbSpan2 = soul::ast::Span();
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        switch (*lexer)
        {
                ...
                soul::parser::Match* parentMatch2 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch3 = &match;
                    {
                                ...
                                if (match.hit)
                                {
                                    ...
                                    soul::parser::Match* parentMatch8 = &match;
                                    {
                                        ...
                                        soul::parser::Match* parentMatch9 = &match;
                                        {
                                            ...
                                            if (match.hit)
                                            {
                                                lbSpan2 = lexer.GetSpan(pos);
                                                span = lbSpan2;
                                                attributeSpecifierNode.reset(new otava::ast::AttributeSpecifierNode(span));
                                            }
                                            *parentMatch9 = match;
                                        }
                                        *parentMatch8 = match;
                                ...
                                soul::parser::Match* parentMatch10 = &match;
                                {
                                    ...
                                    soul::parser::Match* parentMatch11 = &match;
                                    {
                                        ...
                                        soul::parser::Match* parentMatch12 = &match;
                                        {
                                            ...
                                            {
                                                std::int64_t pos = lexer.GetPos();
                                                soul::parser::Match match = otava::parser::attribute::AttributeParser<LexerT>::AttributeUsingPrefix(lexer, context);
                        ...
                        if (match.hit)
                        {
                            ...
                            {
                                soul::parser::Match match = otava::parser::attribute::AttributeParser<LexerT>::AttributeList(lexer, context, attributeSpecifierNode.get());
                                *parentMatch14 = match;
                            }
                            *parentMatch4 = match;
                        }
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch17 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch18 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                rbSpan2 = lexer.GetSpan(pos);
                                attributeSpecifierNode->SetBracketSpans(lbSpan1, lbSpan2, rbSpan1, rbSpan2);
                                {
                                    #ifdef SOUL_PARSER_DEBUG_SUPPORT
            ...
            case otava::token::ALIGNAS:
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    soul::parser::Match match = otava::parser::attribute::AttributeParser<LexerT>::AlignmentSpecifier(lexer, context);
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        {
                            std::int64_t pos = lexer.GetPos();
                            soul::parser::Match match = otava::parser::attribute::AttributeParser<LexerT>::Attribute(lexer, context);
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch5 = &match;
                    {
                        soul::parser::Match match = otava::parser::attribute::AttributeParser<LexerT>::AttributeNamespace(lexer, context);
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::AttributeUsingPrefixNode(span, ns.release(), colonSpan));
            }
        }
        *parentMatch0 = match;
    }
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    soul::parser::Match match = otava::parser::attribute::AttributeParser<LexerT>::AttributeToken(lexer, context);
            ...
            if (match.hit)
            {
                ...
                soul::parser::Match* parentMatch4 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch5 = &match;
                    {
                        soul::parser::Match match = otava::parser::attribute::AttributeParser<LexerT>::AttributeArgumentClause(lexer, context);
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::AttributeNode(span, attributeToken.release(), attributeArgs.release()));
            }
        }
        *parentMatch0 = match;
    }
...
soul::parser::Match AttributeParser<LexerT>::AttributeToken(LexerT& lexer, otava::symbols::Context* context)
{
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        {
            std::int64_t pos = lexer.GetPos();
            soul::parser::Match match = otava::parser::attribute::AttributeParser<LexerT>::AttributeScopedToken(lexer, context);
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::AttributeScopedTokenNode(span, ns.release(), colonColon.release(), identifier.release()));
            }
        }
        *parentMatch0 = match;
    }
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch6 = &match;
                        {
                            soul::parser::Match match = otava::parser::attribute::AttributeParser<LexerT>::BalancedTokenSeq(lexer, context);
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::AttributeArgumentsNode(span, balancedTokenSeq.release(), lpSpan, rpSpan));
            }
        }
        *parentMatch0 = match;
    }
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    soul::parser::Match match = otava::parser::attribute::AttributeParser<LexerT>::BalancedToken(lexer, context);
                    first.reset(static_cast<otava::ast::Node*>(match.value));
                    if (match.hit)
                    {
                        sequence.reset(new otava::ast::BalancedTokenSequenceNode(lexer.GetSpan(pos)));
                    ...
                    case otava::token::LPAREN:
                    {
                        ...
                        soul::parser::Match* parentMatch4 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch5 = &match;
                            {
                                ...
                                {
                                    std::int64_t pos = lexer.GetPos();
                                    soul::parser::Match match = otava::parser::punctuation::PunctuationParser<LexerT>::LParen(lexer);
                                    lp.reset(static_cast<otava::ast::Node*>(match.value));
                                    if (match.hit)
                                    {
                                        seq.reset(new otava::ast::BalancedTokenSequenceNode(lexer.GetSpan(pos)));
                        ...
                        if (match.hit)
                        {
                            ...
                            soul::parser::Match* parentMatch9 = &match;
                            {
                                ...
                                {
                                    std::int64_t pos = lexer.GetPos();
                                    soul::parser::Match match = otava::parser::punctuation::PunctuationParser<LexerT>::RParen(lexer);
                ...
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        soul::parser::Match* parentMatch26 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                seq.reset(new otava::ast::TokenNode(lexer.GetSpan(pos), lexer.GetToken(pos).ToString()));
                            }
                            *parentMatch26 = match;
                        }
                        *parentMatch25 = match;
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::AlignmentSpecifierNode(span, alignment.release(), ellipsis.release(), lpSpan, rpSpan));
            }
        }
        *parentMatch0 = match;
    }
