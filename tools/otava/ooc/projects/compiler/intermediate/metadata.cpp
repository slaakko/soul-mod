...
MetadataRef::MetadataRef(const soul::ast::Span& span_, std::int32_t nodeId_) noexcept :
...
MetadataItem::MetadataItem(MetadataItemKind kind_) noexcept : kind(kind_)
{
}
...
MetadataBool::MetadataBool(bool value_) noexcept : MetadataItem(MetadataItemKind::metadataBool), value(value_)
{
}
...
MetadataLong::MetadataLong(std::int64_t value_) noexcept : MetadataItem(MetadataItemKind::metadataLong), value(value_)
{
}
...
MetadataItem* MetadataStruct::GetItem(const std::string& fieldName) const noexcept
{
...
Metadata::Metadata() noexcept : context(nullptr), trueItem(), falseItem()
{
}
