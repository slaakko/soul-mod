...
public:
    ...
    Value* MakeSymbolValue(const soul::ast::Span& span, Type* type, const std::string& symbol) { return data.MakeSymbolValue(span, type, symbol); }
    ...
    void SetLexer(soul::lexer::LexerBase<char32_t>* lexer_) noexcept { lexer = lexer_; }
private:
