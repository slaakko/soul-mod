...
std::map<std::int64_t, std::string>* GetRuleNameMapPtr()
{
    ...
    static std::map<std::int64_t, std::string> ruleNameMap = {
        ...
        { 2652886897990303804, "IntermediateParser.PLocalInstruction" },
        { 2652886897990303805, "IntermediateParser.LoadInstruction" },
        { 2652886897990303806, "IntermediateParser.ElemAddrInstruction" },
        { 2652886897990303807, "IntermediateParser.PtrOffsetInstruction" },
        { 2652886897990303808, "IntermediateParser.PtrDiffInstruction" },
        { 2652886897990303809, "IntermediateParser.GetRbpInstruction" },
        { 2652886897990303810, "IntermediateParser.FunctionCallInstruction" },
        { 2652886897990303811, "IntermediateParser.BlockValue" },
        { 2652886897990303812, "IntermediateParser.NoOperationInstruction" },
        { 2652886897990303813, "IntermediateParser.Metadata" },
        { 2652886897990303814, "IntermediateParser.MetadataStruct" },
        { 2652886897990303815, "IntermediateParser.MetadataField" },
        { 2652886897990303816, "IntermediateParser.MetadataItem" },
        { 2652886897990303817, "IntermediateParser.MetadataBool" },
        { 2652886897990303818, "IntermediateParser.MetadataLong" },
        { 2652886897990303819, "IntermediateParser.MetadataString" },
        { 2652886897990303820, "IntermediateParser.MetadataRef" }
    };
    return &ruleNameMap;
}
