...
export module string_parser.lexer;
...
export namespace string_parser::lexer {
...
template<typename Char>
soul::lexer::Lexer<string_lexer<Char>, Char> MakeLexer(const Char* start, const Char* end, const std::string& fileName);

template<typename Char>
soul::lexer::Lexer<string_lexer<Char>, Char> MakeLexer(const std::string& moduleFileName, util::ResourceFlags resourceFlags, const Char* start, const Char* end, const std::string& fileName);

soul::ast::common::TokenCollection* GetTokens();

struct string_lexer_Variables : public soul::lexer::Variables
{
    string_lexer_Variables();
};

template<typename Char>
struct string_lexer
{
    using Variables = string_lexer_Variables;
    ...
    static std::int64_t GetTokenId(std::int32_t ruleIndex, soul::lexer::LexerBase<Char>& lexer)
    {
        switch (ruleIndex)
        {
            ...
            {
                lexer.Retract();
                return string_parser::token::NAME;
                break;
            }
            case 2:
            {
                lexer.Retract();
                return string_parser::token::COMMA;
                break;
            }
            case 3:
            {
                lexer.Retract();
                return string_parser::token::LPAREN;
                break;
            }
            case 4:
            {
                lexer.Retract();
                return string_parser::token::RPAREN;
                break;
            }
        }
...
{
    static soul::lexer::ClassMap<Char>* classmap = soul::lexer::MakeClassMap<Char>("string_parser.lexer.classmap");
    return classmap;
}
...
{
    static soul::lexer::ClassMap<Char>* classmap = soul::lexer::MakeClassMap<Char>(moduleFileName, "string_parser.lexer.classmap", resourceFlags);
    return classmap;
}
...
soul::lexer::Lexer<string_lexer<Char>, Char> MakeLexer(const Char* start, const Char* end, const std::string& fileName)
{
    ...
    auto lexer = soul::lexer::Lexer<string_lexer<Char>, Char>(start, end, fileName);
