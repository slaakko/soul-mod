...
extern "C" void ort_preprocess_args(int argc, const char** argv);
...
int main(int argc, const char** argv)
{
    ort_init();
    ort_debug_memory();
    ort_preprocess_args(argc, argv);
    int retVal = fn___main_wrapper___6AD707E323E364CC721579A108E141F517AB5EF3(argc, argv);
    ort_done();
