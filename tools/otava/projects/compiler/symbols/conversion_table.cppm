...
{
    bool operator()(const ConversionTableEntry& left, const ConversionTableEntry& right) const noexcept;
};

struct ConversionTableEntryHash
{
    size_t operator()(const ConversionTableEntry& entry) const noexcept;
};
