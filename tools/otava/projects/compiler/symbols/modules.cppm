...
public:
    ...
    ModuleKind Kind() const noexcept { return kind; }
    ...
    inline std::int32_t ImportIndex() const noexcept { return importIndex; }
    inline void SetImportIndex(std::int32_t importIndex_) noexcept { importIndex = importIndex_; }
    inline SymbolTable* GetSymbolTable() noexcept { return &symbolTable; }
    inline EvaluationContext* GetEvaluationContext() noexcept { return &evaluationContext; }
    void AddExportModuleName(const std::string& exportModuleName);
    inline const std::vector<std::string>& ExportModuleNames() const noexcept { return exportModuleNames; }
    ...
    inline const std::vector<std::string>& ImportModuleNames() const noexcept { return importModuleNames; }
    ...
    void SetFile(otava::ast::File* astFile_) noexcept;
    inline otava::ast::File* GetFile() noexcept { return astFile.get(); }
    inline const std::vector<std::string>& ImplementationUnitNames() const noexcept { return implementationUnitNames; }
...
public:
    ...
    int32_t ModuleCount() const noexcept;
    const std::vector<std::unique_ptr<Module>>& Modules() const noexcept { return modules; }
private:
