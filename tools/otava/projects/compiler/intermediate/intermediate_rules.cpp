...
std::map<std::int64_t, std::string>* GetRuleNameMapPtr()
{
    ...
    static std::map<std::int64_t, std::string> ruleNameMap = {
        ...
        { 2652886897990303804, "IntermediateParser.ParsePLocalInstruction" },
        { 2652886897990303805, "IntermediateParser.ParseLoadInstruction" },
        { 2652886897990303806, "IntermediateParser.ParseElemAddrInstruction" },
        { 2652886897990303807, "IntermediateParser.ParsePtrOffsetInstruction" },
        { 2652886897990303808, "IntermediateParser.ParsePtrDiffInstruction" },
        { 2652886897990303809, "IntermediateParser.ParseGetRbpInstruction" },
        { 2652886897990303810, "IntermediateParser.ParseFunctionCallInstruction" },
        { 2652886897990303811, "IntermediateParser.BlockValue" },
        { 2652886897990303812, "IntermediateParser.ParseNoOperationInstruction" },
        { 2652886897990303813, "IntermediateParser.ParseMetadata" },
        { 2652886897990303814, "IntermediateParser.ParseMetadataStruct" },
        { 2652886897990303815, "IntermediateParser.ParseMetadataField" },
        { 2652886897990303816, "IntermediateParser.ParseMetadataItem" },
        { 2652886897990303817, "IntermediateParser.ParseMetadataBool" },
        { 2652886897990303818, "IntermediateParser.ParseMetadataLong" },
        { 2652886897990303819, "IntermediateParser.ParseMetadataString" },
        { 2652886897990303820, "IntermediateParser.ParseMetadataRef" }
    };
    return &ruleNameMap;
}
