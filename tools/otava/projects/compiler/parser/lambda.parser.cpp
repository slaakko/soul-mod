...
// this file has been automatically generated from 'D:/work/soul-mod/tools/otava/projects/compiler/parser/lambda.parser' using soul parser generator ospg version 5.0.0
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        {
                            std::int64_t pos = lexer.GetPos();
                            soul::parser::Match match = otava::parser::lambda::LambdaParser<LexerT>::LambdaIntroducer(lexer, context);
                    ...
                    if (match.hit)
                    {
                        ...
                        soul::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            {
                                soul::parser::Match match = otava::parser::lambda::LambdaParser<LexerT>::LambdaTemplateParams(lexer, context);
                ...
                if (match.hit)
                {
                    ...
                    {
                        soul::parser::Match match = otava::parser::lambda::LambdaParser<LexerT>::LambdaDeclarator(lexer, context);
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::LambdaExpressionNode(span, introducer.release(), templateParams.release(), declarator.release(), body.release()));
            }
        }
        *parentMatch0 = match;
    }
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch6 = &match;
                        {
                            soul::parser::Match match = otava::parser::lambda::LambdaParser<LexerT>::LambdaCapture(lexer, context);
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::LambdaIntroducerNode(span, capture.release(), lbSpan, rbSpan));
            }
        }
        *parentMatch0 = match;
    }
...
soul::parser::Match LambdaParser<LexerT>::LambdaCapture(LexerT& lexer, otava::symbols::Context* context)
{
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                node.reset(new otava::ast::LambdaCaptureNode(lexer.GetSpan(pos)));
            }
            *parentMatch1 = match;
        }
        *parentMatch0 = match;
        ...
        soul::parser::Match* parentMatch2 = &match;
        {
            ...
            soul::parser::Match* parentMatch3 = &match;
            {
                ...
                soul::parser::Match* parentMatch4 = &match;
                {
                    ...
                    {
                        std::int64_t save = lexer.GetPos();
                        soul::parser::Match match = otava::parser::lambda::LambdaParser<LexerT>::CaptureList(lexer, context, node.get());
                        *parentMatch5 = match;
                        if (!match.hit)
                        {
                            soul::parser::Match match(false);
                            ...
                            lexer.SetPos(save);
                            {
                                ...
                                soul::parser::Match* parentMatch7 = &match;
                                {
                                    ...
                                    {
                                        std::int64_t pos = lexer.GetPos();
                                        soul::parser::Match match = otava::parser::lambda::LambdaParser<LexerT>::CaptureDefault(lexer);
                ...
                {
                    {
                        ...
                        #endif
                        return soul::parser::Match(true, new otava::ast::DefaultRefCaptureNode(lexer.GetSpan(pos)));
                    }
                }
                *parentMatch1 = match;
            }
                ...
                {
                    {
                        ...
                        if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "CaptureDefault");
                        #endif
                        return soul::parser::Match(true, new otava::ast::DefaultCopyCaptureNode(lexer.GetSpan(pos)));
                    }
                }
                *parentMatch2 = match;
            }
...
soul::parser::Match LambdaParser<LexerT>::CaptureList(LexerT& lexer, otava::symbols::Context* context, otava::ast::Node* container)
{
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        {
            std::int64_t pos = lexer.GetPos();
            soul::parser::Match match = otava::parser::lambda::LambdaParser<LexerT>::Capture(lexer, context);
...
soul::parser::Match LambdaParser<LexerT>::Capture(LexerT& lexer, otava::symbols::Context* context)
{
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        {
            std::int64_t pos = lexer.GetPos();
            soul::parser::Match match = otava::parser::lambda::LambdaParser<LexerT>::InitCapture(lexer, context);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    soul::parser::Match match = otava::parser::lambda::LambdaParser<LexerT>::SimpleCapture(lexer, context);
                        ...
                        soul::parser::Match* parentMatch5 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                soul::parser::Match* parentMatch7 = &match;
                                {
                                    ...
                                    {
                                        span = lexer.GetSpan(pos);
                                        byRefCaptureNode.reset(new otava::ast::ByRefCaptureNode(span));
                                    }
                                    *parentMatch7 = match;
                                }
                                *parentMatch6 = match;
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::InitCaptureNode(span, identifier.release(), initializer.release(), byRefCaptureNode.release(), ellipsis.release()));
            }
        }
        *parentMatch0 = match;
    }
...
soul::parser::Match LambdaParser<LexerT>::SimpleCapture(LexerT& lexer, otava::symbols::Context* context)
{
    ...
    soul::ast::Span span = soul::ast::Span();
    soul::ast::Span thisPos = soul::ast::Span();
    std::unique_ptr<otava::ast::Node> byRefCaptureNode = std::unique_ptr<otava::ast::Node>();
    std::unique_ptr<otava::ast::Node> identifier;
    std::unique_ptr<otava::ast::Node> ellipsis;
    soul::parser::Match match(false);
                        ...
                        if (match.hit)
                        {
                            ...
                            soul::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                soul::parser::Match* parentMatch7 = &match;
                                {
                                    ...
                                    if (match.hit)
                                    {
                                        thisPos = lexer.GetSpan(pos);
                                        {
                                            #ifdef SOUL_PARSER_DEBUG_SUPPORT
                                            if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "SimpleCapture");
                                            #endif
                                            return soul::parser::Match(true, new otava::ast::CurrentObjectCopyCapture(span, thisPos));
                                        }
                                    }
                                    *parentMatch7 = match;
                                }
                        ...
                        soul::parser::Match* parentMatch8 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                ...
                                thisPos = span;
                                {
                                    ...
                                    if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "SimpleCapture");
                                    #endif
                                    return soul::parser::Match(true, new otava::ast::CurrentObjectByRefCapture(span, thisPos));
                                }
                            }
                            *parentMatch8 = match;
                        }
        ...
        {
            {
                ...
                if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "SimpleCapture");
                #endif
                return soul::parser::Match(true, new otava::ast::SimpleCaptureNode(span, identifier.release(), byRefCaptureNode.release(), ellipsis.release()));
            }
        }
        *parentMatch0 = match;
    }
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                        ...
                        soul::parser::Match* parentMatch5 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                soul::parser::Match* parentMatch7 = &match;
                                {
                                    ...
                                    soul::parser::Match* parentMatch8 = &match;
                                    {
                                        ...
                                        if (match.hit)
                                        {
                                            span = lexer.GetSpan(pos);
                                            lpSpan = span;
                                            parameterList.reset(new otava::ast::ParameterListNode(span));
                                        }
                                        *parentMatch8 = match;
                                    }
                                    *parentMatch7 = match;
                                ...
                                if (match.hit)
                                {
                                    ...
                                    soul::parser::Match* parentMatch9 = &match;
                                    {
                                        soul::parser::Match match = otava::parser::function::FunctionParser<LexerT>::ParameterDeclarationClause(lexer, context, parameterList.get());
                                        *parentMatch9 = match;
                                    }
                                    *parentMatch7 = match;
                                }
                                ...
                                soul::parser::Match* parentMatch10 = &match;
                                {
                                    ...
                                    soul::parser::Match* parentMatch11 = &match;
                                    {
                                        ...
                                        if (match.hit)
                                        {
                                            ...
                                            parameterList->SetLParenSpan(lpSpan);
                                            parameterList->SetRParenSpan(rpSpan);
                                        }
                                        *parentMatch11 = match;
                                    }
                                    *parentMatch10 = match;
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch12 = &match;
                    {
                        ...
                        {
                            std::int64_t pos = lexer.GetPos();
                            soul::parser::Match match = otava::parser::lambda::LambdaParser<LexerT>::LambdaSpecifiers(lexer, context);
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::LambdaDeclaratorNode(span, parameterList.release(), specifiers.release(), requiresClause.release()));
            }
        }
        *parentMatch0 = match;
    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::LambdaSpecifiersNode(span, declSpecifiers.release(), noexceptSpecifier.release(), attributes.release(), trailingReturnType.release()));
            }
        }
        *parentMatch0 = match;
    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::LambdaTemplateParamsNode(span, templateParams.release(), requiresClause.release()));
            }
        }
        *parentMatch0 = match;
    }
