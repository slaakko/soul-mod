                ...
                {
                    {
                        ...
                        #endif
                        return soul::parser::Match(true, new otava::ast::ExceptionDeclarationNode(sourcePos, typeSpecifiers.release(), declarator.release(), ellipsis.release(), attributes.release()));
                    }
                }
                *parentMatch5 = match;
            }
