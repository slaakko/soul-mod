...
// this file has been automatically generated from 'D:/work/soul-mod/tools/otava/projects/compiler/parser/expression.parser' using soul parser generator ospg version 5.0.0
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new otava::ast::ThrowExprNode(sourcePos, expr.release()));
            }
        }
        *parentMatch0 = match;
    }
