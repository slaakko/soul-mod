...
CharNode::CharNode(const soul::ast::SourcePos& sourcePos_) noexcept : Node(NodeKind::charNode, sourcePos_)
{
}
...
Char8Node::Char8Node(const soul::ast::SourcePos& sourcePos_) noexcept : Node(NodeKind::char8Node, sourcePos_)
{
}
...
Char16Node::Char16Node(const soul::ast::SourcePos& sourcePos_) noexcept : Node(NodeKind::char16Node, sourcePos_)
{
}
...
Char32Node::Char32Node(const soul::ast::SourcePos& sourcePos_) noexcept : Node(NodeKind::char32Node, sourcePos_)
{
}
...
WCharNode::WCharNode(const soul::ast::SourcePos& sourcePos_) noexcept : Node(NodeKind::wcharNode, sourcePos_)
{
}
...
BoolNode::BoolNode(const soul::ast::SourcePos& sourcePos_) noexcept : Node(NodeKind::boolNode, sourcePos_)
{
}
...
ShortNode::ShortNode(const soul::ast::SourcePos& sourcePos_) noexcept : Node(NodeKind::shortNode, sourcePos_)
{
}
...
IntNode::IntNode(const soul::ast::SourcePos& sourcePos_) noexcept : Node(NodeKind::intNode, sourcePos_)
{
}
...
LongNode::LongNode(const soul::ast::SourcePos& sourcePos_) noexcept : Node(NodeKind::longNode, sourcePos_)
{
}
...
SignedNode::SignedNode(const soul::ast::SourcePos& sourcePos_) noexcept : Node(NodeKind::signedNode, sourcePos_)
{
}
...
UnsignedNode::UnsignedNode(const soul::ast::SourcePos& sourcePos_) noexcept : Node(NodeKind::unsignedNode, sourcePos_)
{
}
...
FloatNode::FloatNode(const soul::ast::SourcePos& sourcePos_) noexcept : Node(NodeKind::floatNode, sourcePos_)
{
}
...
DoubleNode::DoubleNode(const soul::ast::SourcePos& sourcePos_) noexcept : Node(NodeKind::doubleNode, sourcePos_)
{
}
...
VoidNode::VoidNode(const soul::ast::SourcePos& sourcePos_) noexcept : Node(NodeKind::voidNode, sourcePos_)
{
}
