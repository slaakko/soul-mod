...
std::unique_ptr<soul::ast::slg::SlgFile> SlgFileParser<LexerT>::Parse(LexerT& lexer)
{
...
#endif
    ++lexer;
    soul::parser::Match match = SlgFileParser<LexerT>::SlgFile(lexer);
...
template<typename LexerT>
soul::parser::Match SlgFileParser<LexerT>::SlgFile(LexerT& lexer)
{
#ifdef SOUL_PARSER_DEBUG_SUPPORT
                        ...
                        while (true)
                        {
                            std::int64_t save = lexer.GetPos();
                            {
                                ...
                                soul::parser::Match* parentMatch10 = &match;
                                {
                                    ...
                                    {
                                        std::int64_t pos = lexer.GetPos();
                                        soul::parser::Match match = soul::slg::slg::file::parser::SlgFileParser<LexerT>::SlgFileDeclaration(lexer);
...
template<typename LexerT>
soul::parser::Match SlgFileParser<LexerT>::SlgFileDeclaration(LexerT& lexer)
{
#ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    soul::parser::Match match = soul::slg::slg::file::parser::SlgFileParser<LexerT>::TokenFileDeclaration(lexer);
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        {
                            std::int64_t pos = lexer.GetPos();
                            soul::parser::Match match = soul::slg::slg::file::parser::SlgFileParser<LexerT>::KeywordFileDeclaration(lexer);
            ...
            *parentMatch1 = match;
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    ...
                    {
                        std::int64_t pos = lexer.GetPos();
                        soul::parser::Match match = soul::slg::slg::file::parser::SlgFileParser<LexerT>::ExpressionFileDeclaration(lexer);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    soul::parser::Match match = soul::slg::slg::file::parser::SlgFileParser<LexerT>::LexerFileDeclaration(lexer);
...
template<typename LexerT>
soul::parser::Match SlgFileParser<LexerT>::TokenFileDeclaration(LexerT& lexer)
{
#ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
soul::parser::Match SlgFileParser<LexerT>::KeywordFileDeclaration(LexerT& lexer)
{
#ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
soul::parser::Match SlgFileParser<LexerT>::ExpressionFileDeclaration(LexerT& lexer)
{
#ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    soul::parser::Match match(false);
                    if (*lexer == soul::tool::token::EXPRESSIONS)
                    {
                        ++lexer;
                        match.hit = true;
                    }
...
template<typename LexerT>
soul::parser::Match SlgFileParser<LexerT>::LexerFileDeclaration(LexerT& lexer)
{
#ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
