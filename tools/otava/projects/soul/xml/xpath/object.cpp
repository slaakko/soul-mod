...
Boolean::Boolean() noexcept : Object(ObjectKind::boolean), value(false)
{
}

Boolean::Boolean(bool value_) noexcept : Object(ObjectKind::boolean), value(value_)
{
}
...
Number::Number() noexcept : Object(ObjectKind::number), value(0.0)
{
}

Number::Number(double value_) noexcept : Object(ObjectKind::number), value(value_)
{
}
...
String::String() noexcept : Object(ObjectKind::string), value()
{
}
