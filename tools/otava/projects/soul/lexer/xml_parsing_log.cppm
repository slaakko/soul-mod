...
{
public:
    XmlParsingLog(std::ostream& stream_) noexcept;
    XmlParsingLog(std::ostream& stream_, int maxLineLength_) noexcept;
    void IncIndent() noexcept override;
    void DecIndent() noexcept override;
    ...
    inline util::CodeFormatter& Formatter() noexcept { return formatter; }
private:
