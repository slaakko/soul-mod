...
MemoryStream::MemoryStream() noexcept : Stream(), data(), size(), readPos(0)
{
}

MemoryStream::MemoryStream(std::uint8_t* data_, std::int64_t size_) noexcept : Stream(), data(data_), size(size_), readPos(0)
{
}
