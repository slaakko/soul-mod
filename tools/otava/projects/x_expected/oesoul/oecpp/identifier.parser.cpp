...
std::expected<soul::parser::Match, int> CppIdentifierParser<LexerT>::CppIdentifier(LexerT& lexer, soul::ast::cpp::Context* context)
{
...
template<typename LexerT>
std::expected<soul::parser::Match, int> CppIdentifierParser<LexerT>::QualifiedCppId(LexerT& lexer, soul::ast::cpp::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
