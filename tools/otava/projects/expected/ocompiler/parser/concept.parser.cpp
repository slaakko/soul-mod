...
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::ConceptDefinition(LexerT& lexer, otava::symbols::Context* context)
{
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            ...
                            {
                                std::expected<soul::parser::Match, int> m = otava::parser::concepts::ConceptParser<LexerT>::ConceptName(lexer, context);
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch10 = &match;
                    {
                        ...
                        {
                            std::int64_t pos = lexer.GetPos();
                            std::expected<soul::parser::Match, int> m = otava::parser::concepts::ConceptParser<LexerT>::ConstraintExpression(lexer, context);
                            if (!m) return std::unexpected<int>(m.error());
                            soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::ConceptName(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::ConceptNameChecked(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::ConstraintExpression(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::RequiresClause(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                ...
                soul::parser::Match* parentMatch4 = &match;
                {
                    std::expected<soul::parser::Match, int> m = otava::parser::concepts::ConceptParser<LexerT>::ConstraintLogicalOrExpression(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::ConstraintLogicalOrExpression(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul::parser::Match, int> m = otava::parser::concepts::ConceptParser<LexerT>::ConstraintLogicalAndExpression(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::ConstraintLogicalAndExpression(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::RequiresExpression(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch6 = &match;
                        {
                            std::expected<soul::parser::Match, int> m = otava::parser::concepts::ConceptParser<LexerT>::RequirementParameterList(lexer, context);
                            if (!m) return std::unexpected<int>(m.error());
                            soul::parser::Match match = *m;
            ...
            if (match.hit)
            {
                ...
                soul::parser::Match* parentMatch7 = &match;
                {
                    std::expected<soul::parser::Match, int> m = otava::parser::concepts::ConceptParser<LexerT>::RequirementBody(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::RequirementParameterList(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch5 = &match;
                    {
                        std::expected<soul::parser::Match, int> m = otava::parser::function::FunctionParser<LexerT>::ParameterDeclarationClause(lexer, context, node.get());
                        if (!m) return std::unexpected<int>(m.error());
                        soul::parser::Match match = *m;
                        *parentMatch5 = match;
                    }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::RequirementBody(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch5 = &match;
                    {
                        std::expected<soul::parser::Match, int> m = otava::parser::concepts::ConceptParser<LexerT>::RequirementSeq(lexer, context, node.get());
                        if (!m) return std::unexpected<int>(m.error());
                        soul::parser::Match match = *m;
                        *parentMatch5 = match;
                    }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::RequirementSeq(LexerT& lexer, otava::symbols::Context* context, otava::ast::Node* requirementBody)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            {
                std::int64_t pos = lexer.GetPos();
                std::expected<soul::parser::Match, int> m = otava::parser::concepts::ConceptParser<LexerT>::Requirement(lexer, context);
                if (!m) return std::unexpected<int>(m.error());
                soul::parser::Match match = *m;
                requirement.reset(static_cast<otava::ast::Node*>(match.value));
                if (match.hit)
                {
                    auto rv = requirementBody->AddNode(requirement.release());
                    if (!rv) return std::unexpected<int>(rv.error());
                }
                *parentMatch2 = match;
            }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::Requirement(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        switch (*lexer)
        {
            case otava::token::REQUIRES:
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul::parser::Match, int> m = otava::parser::concepts::ConceptParser<LexerT>::NestedRequirement(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
            ...
            case otava::token::TYPENAME:
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul::parser::Match, int> m = otava::parser::concepts::ConceptParser<LexerT>::TypeRequirement(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
            ...
            case otava::token::LBRACE:
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul::parser::Match, int> m = otava::parser::concepts::ConceptParser<LexerT>::CompoundRequirement(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul::parser::Match, int> m = otava::parser::concepts::ConceptParser<LexerT>::SimpleRequirement(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::SimpleRequirement(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::TypeRequirement(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::CompoundRequirement(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    if (match.hit)
                    {
                        ...
                        soul::parser::Match* parentMatch11 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch12 = &match;
                            {
                                std::expected<soul::parser::Match, int> m = otava::parser::function::FunctionParser<LexerT>::Noexcept(lexer);
                                if (!m) return std::unexpected<int>(m.error());
                                soul::parser::Match match = *m;
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch13 = &match;
                    {
                        ...
                        {
                            std::expected<soul::parser::Match, int> m = otava::parser::concepts::ConceptParser<LexerT>::ReturnTypeRequirement(lexer, context);
                            if (!m) return std::unexpected<int>(m.error());
                            soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::ReturnTypeRequirement(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::NestedRequirement(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ConceptParser<LexerT>::TypeConstraint(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                            ...
                            soul::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    ...
                                    soul::parser::Match* parentMatch9 = &match;
                                    {
                                        ...
                                        {
                                            std::int64_t pos = lexer.GetPos();
                                            std::expected<soul::parser::Match, int> m = otava::parser::concepts::ConceptParser<LexerT>::ConceptNameChecked(lexer, context);
                                            if (!m) return std::unexpected<int>(m.error());
                                            soul::parser::Match match = *m;
