...
std::expected<bool, int> XmlParser<LexerT>::Parse(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    std::unique_ptr<soul::parser::Value<bool>> value;
    ...
    std::expected<soul::parser::Match, int> m = XmlParser<LexerT>::Document(lexer, processor);
    if (!m) return std::unexpected<int>(m.error());
    soul::parser::Match match = *m;
    value.reset(static_cast<soul::parser::Value<bool>*>(match.value));
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    if (lexer.Log())
    {
        lexer.Log()->DecIndent();
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Document(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    if (match.hit)
                    {
                        ...
                        {
                            std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Prolog(lexer, processor);
                            if (!m) return std::unexpected<int>(m.error());
                            soul::parser::Match match = *m;
                            *parentMatch6 = match;
                        }
                ...
                if (match.hit)
                {
                    ...
                    {
                        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Element(lexer, processor);
                        if (!m) return std::unexpected<int>(m.error());
                        soul::parser::Match match = *m;
                        *parentMatch7 = match;
                    }
                ...
                soul::parser::Match* parentMatch8 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch9 = &match;
                    {
                        while (true)
                        {
                            ...
                            {
                                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Misc(lexer, processor);
                                if (!m) return std::unexpected<int>(m.error());
                                soul::parser::Match match = *m;
                                if (match.hit)
                                {
        ...
        if (match.hit)
        {
            ...
            {
                #ifdef SOUL_PARSER_DEBUG_SUPPORT
                if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "Document");
                #endif
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Prolog(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::XmlDecl(lexer, processor);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
                    if (match.hit)
                    {
            ...
            soul::parser::Match* parentMatch6 = &match;
            {
                ...
                soul::parser::Match* parentMatch7 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch8 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch9 = &match;
                        {
                            std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::DocTypeDecl(lexer, processor);
                            if (!m) return std::unexpected<int>(m.error());
                            soul::parser::Match match = *m;
                            *parentMatch9 = match;
                        }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::XmlDecl(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            ...
                            soul::parser::Match* parentMatch6 = &match;
                            {
                                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::VersionInfo(lexer, processor);
                                if (!m) return std::unexpected<int>(m.error());
                                soul::parser::Match match = *m;
                                *parentMatch6 = match;
                            }
                    ...
                    if (match.hit)
                    {
                        ...
                        soul::parser::Match* parentMatch7 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch8 = &match;
                            {
                                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::EncodingDecl(lexer, processor);
                                if (!m) return std::unexpected<int>(m.error());
                                soul::parser::Match match = *m;
                                if (match.hit)
                                {
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch9 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch10 = &match;
                        {
                            std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::StandaloneDecl(lexer, processor);
                            if (!m) return std::unexpected<int>(m.error());
                            soul::parser::Match match = *m;
                            if (match.hit)
                            {
            ...
            if (match.hit)
            {
                ...
                soul::parser::Match* parentMatch11 = &match;
                {
                    ...
                    {
                        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::S(lexer);
                        if (!m) return std::unexpected<int>(m.error());
                        soul::parser::Match match = *m;
                        if (match.hit)
                        {
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::VersionInfo(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                ...
                soul::parser::Match* parentMatch5 = &match;
                {
                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Eq(lexer);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
                    *parentMatch5 = match;
                }
        ...
        if (match.hit)
        {
            ...
            soul::parser::Match* parentMatch6 = &match;
            {
                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::VersionNumber(lexer, processor);
                if (!m) return std::unexpected<int>(m.error());
                soul::parser::Match match = *m;
                *parentMatch6 = match;
            }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::S(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Eq(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::VersionNumber(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    {
        std::int64_t save = lexer.GetPos();
        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::VersionNumDQ(lexer, processor);
        if (!m) return std::unexpected<int>(m.error());
        soul::parser::Match match = *m;
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::VersionNumSQ(lexer, processor);
                if (!m) return std::unexpected<int>(m.error());
                soul::parser::Match match = *m;
                *parentMatch1 = match;
            }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::VersionNumDQ(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::VersionNum(lexer, processor);
                if (!m) return std::unexpected<int>(m.error());
                soul::parser::Match match = *m;
                *parentMatch2 = match;
            }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::VersionNumSQ(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::VersionNum(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::EncodingDecl(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            ...
            soul::parser::Match* parentMatch6 = &match;
            {
                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::EncodingName(lexer, processor);
                if (!m) return std::unexpected<int>(m.error());
                soul::parser::Match match = *m;
                *parentMatch6 = match;
            }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::EncodingName(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    {
        std::int64_t save = lexer.GetPos();
        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::EncNameDQ(lexer, processor);
        if (!m) return std::unexpected<int>(m.error());
        soul::parser::Match match = *m;
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::EncNameSQ(lexer, processor);
                if (!m) return std::unexpected<int>(m.error());
                soul::parser::Match match = *m;
                *parentMatch1 = match;
            }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::EncNameDQ(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::EncName(lexer, processor);
                if (!m) return std::unexpected<int>(m.error());
                soul::parser::Match match = *m;
                *parentMatch2 = match;
            }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::EncNameSQ(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::EncName(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::StandaloneDecl(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            ...
            soul::parser::Match* parentMatch6 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::YesNo(lexer);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::YesNo(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Misc(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        {
            std::int64_t save = lexer.GetPos();
            std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Comment(lexer, processor);
            if (!m) return std::unexpected<int>(m.error());
            soul::parser::Match match = *m;
            *parentMatch1 = match;
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::PI(lexer, processor);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
                    *parentMatch2 = match;
                }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Comment(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                                    ...
                                    soul::parser::Match* parentMatch7 = &match;
                                    {
                                        ...
                                        soul::parser::Match* parentMatch8 = &match;
                                        {
                                            ...
                                            soul::parser::Match* parentMatch9 = &match;
                                            {
                                                ...
                                                std::int64_t save = lexer.GetPos();
                                                {
                                                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Char(lexer);
                                                    if (!m) return std::unexpected<int>(m.error());
                                                    soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Char(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::PI(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    if (match.hit)
                    {
                        ...
                        soul::parser::Match* parentMatch6 = &match;
                        {
                            std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::PITarget(lexer);
                            if (!m) return std::unexpected<int>(m.error());
                            soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::PITarget(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            std::int64_t save = lexer.GetPos();
            {
                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Name(lexer);
                if (!m) return std::unexpected<int>(m.error());
                soul::parser::Match match = *m;
            ...
            if (match.hit)
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    lexer.SetPos(save);
                    save = tmp;
                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Xml(lexer);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
                    *parentMatch3 = match;
                }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Name(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::NameStartChar(lexer);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
                        ...
                        while (true)
                        {
                            std::int64_t save = lexer.GetPos();
                            {
                                ...
                                soul::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    {
                                        std::int64_t pos = lexer.GetPos();
                                        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::NameChar(lexer);
                                        if (!m) return std::unexpected<int>(m.error());
                                        soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::NameStartChar(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::NameChar(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Xml(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Element(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                                ...
                                std::int64_t save = lexer.GetPos();
                                {
                                    ...
                                    soul::parser::Match* parentMatch9 = &match;
                                    {
                                        ...
                                        if (match.hit)
                                        {
                                            ...
                                            soul::parser::Match* parentMatch11 = &match;
                                            {
                                                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Attribute(lexer, processor);
                                                if (!m) return std::unexpected<int>(m.error());
                                                soul::parser::Match match = *m;
                                                *parentMatch11 = match;
                                            }
                            ...
                            lexer.SetPos(save);
                            {
                                ...
                                soul::parser::Match* parentMatch19 = &match;
                                {
                                    ...
                                    if (match.hit)
                                    {
                                        ...
                                        {
                                            std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Content(lexer, processor);
                                            if (!m) return std::unexpected<int>(m.error());
                                            soul::parser::Match match = *m;
                                            *parentMatch22 = match;
                                        }
                                ...
                                if (match.hit)
                                {
                                    ...
                                    {
                                        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::ETag(lexer, processor);
                                        if (!m) return std::unexpected<int>(m.error());
                                        soul::parser::Match match = *m;
                                        *parentMatch23 = match;
                                    }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Attribute(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                ...
                soul::parser::Match* parentMatch6 = &match;
                {
                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::AttValue(lexer, processor);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::AttValue(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        {
            std::int64_t pos = lexer.GetPos();
            std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::AttValueDQ(lexer, processor);
            if (!m) return std::unexpected<int>(m.error());
            soul::parser::Match match = *m;
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::AttValueSQ(lexer, processor);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::AttValueDQ(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                                        ...
                                        soul::parser::Match* parentMatch8 = &match;
                                        {
                                            ...
                                            *parentMatch8 = match;
                                            if (!match.hit)
                                            {
                                                ...
                                                lexer.SetPos(save);
                                                {
                                                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Reference(lexer, processor);
                                                    if (!m) return std::unexpected<int>(m.error());
                                                    soul::parser::Match match = *m;
                                                    *parentMatch10 = match;
                                                }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::AttValueSQ(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Reference(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    {
        std::int64_t save = lexer.GetPos();
        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::CharRef(lexer, processor);
        if (!m) return std::unexpected<int>(m.error());
        soul::parser::Match match = *m;
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::EntityRef(lexer, processor);
                if (!m) return std::unexpected<int>(m.error());
                soul::parser::Match match = *m;
                *parentMatch1 = match;
            }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::CharRef(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    std::unique_ptr<soul::parser::Value<std::int32_t>> decCodePoint;
    std::unique_ptr<soul::parser::Value<std::int32_t>> hexCodePoint;
    soul::parser::Match match(false);
    soul::parser::Match* parentMatch0 = &match;
    {
        std::int64_t pos = lexer.GetPos();
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    if (match.hit)
                    {
                        ...
                        soul::parser::Match* parentMatch5 = &match;
                        {
                            std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::DecCodePoint(lexer);
                            if (!m) return std::unexpected<int>(m.error());
                            soul::parser::Match match = *m;
                            decCodePoint.reset(static_cast<soul::parser::Value<std::int32_t>*>(match.value));
                            *parentMatch5 = match;
                        }
                        *parentMatch4 = match;
                    }
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        soul::parser::Match* parentMatch9 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                ...
                                soul::parser::Match* parentMatch11 = &match;
                                {
                                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::HexCodePoint(lexer);
                                    if (!m) return std::unexpected<int>(m.error());
                                    soul::parser::Match match = *m;
                                    hexCodePoint.reset(static_cast<soul::parser::Value<std::int32_t>*>(match.value));
                                    *parentMatch11 = match;
                                }
                                *parentMatch10 = match;
                            }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::DecCodePoint(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new soul::parser::Value<std::int32_t>(val));
            }
        }
        *parentMatch0 = match;
    }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::HexCodePoint(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::EntityRef(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Content(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::CharData(lexer, processor);
                if (!m) return std::unexpected<int>(m.error());
                soul::parser::Match match = *m;
                if (match.hit)
                {
                                                ...
                                                soul::parser::Match* parentMatch10 = &match;
                                                {
                                                    ...
                                                    *parentMatch10 = match;
                                                    if (!match.hit)
                                                    {
                                                        ...
                                                        lexer.SetPos(save);
                                                        {
                                                            std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::CDSect(lexer, processor);
                                                            if (!m) return std::unexpected<int>(m.error());
                                                            soul::parser::Match match = *m;
                                                            *parentMatch13 = match;
                                                        }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::CharData(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                        ...
                        soul::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch7 = &match;
                            {
                                ...
                                soul::parser::Match* parentMatch8 = &match;
                                {
                                    ...
                                    std::int64_t save = lexer.GetPos();
                                    {
                                        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::CharDataChar(lexer);
                                        if (!m) return std::unexpected<int>(m.error());
                                        soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::CharDataChar(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::CDSect(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::ETag(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::DocTypeDecl(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                            ...
                            soul::parser::Match* parentMatch10 = &match;
                            {
                                ...
                                soul::parser::Match* parentMatch11 = &match;
                                {
                                    ...
                                    if (match.hit)
                                    {
                                        ...
                                        soul::parser::Match* parentMatch13 = &match;
                                        {
                                            std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::ExternalID(lexer);
                                            if (!m) return std::unexpected<int>(m.error());
                                            soul::parser::Match match = *m;
                                            *parentMatch13 = match;
                                        }
                            ...
                            soul::parser::Match* parentMatch19 = &match;
                            {
                                ...
                                soul::parser::Match* parentMatch20 = &match;
                                {
                                    ...
                                    if (match.hit)
                                    {
                                        ...
                                        soul::parser::Match* parentMatch22 = &match;
                                        {
                                            std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::IntSubset(lexer, processor);
                                            if (!m) return std::unexpected<int>(m.error());
                                            soul::parser::Match match = *m;
                                            *parentMatch22 = match;
                                        }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::ExternalID(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                ...
                soul::parser::Match* parentMatch5 = &match;
                {
                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::SystemLiteral(lexer);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
                    *parentMatch5 = match;
                }
                    ...
                    soul::parser::Match* parentMatch8 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch9 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                ...
                                soul::parser::Match* parentMatch13 = &match;
                                {
                                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::PubidLiteral(lexer);
                                    if (!m) return std::unexpected<int>(m.error());
                                    soul::parser::Match match = *m;
                                    *parentMatch13 = match;
                                }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::SystemLiteral(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::PubidLiteral(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                        while (true)
                        {
                            std::int64_t save = lexer.GetPos();
                            {
                                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::PubidChar(lexer);
                                if (!m) return std::unexpected<int>(m.error());
                                soul::parser::Match match = *m;
                                if (match.hit)
                                {
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::PubidChar(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::IntSubset(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        while (true)
        {
            std::int64_t save = lexer.GetPos();
            {
                ...
                soul::parser::Match* parentMatch1 = &match;
                {
                    ...
                    {
                        std::int64_t save = lexer.GetPos();
                        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::MarkupDecl(lexer, processor);
                        if (!m) return std::unexpected<int>(m.error());
                        soul::parser::Match match = *m;
                        *parentMatch2 = match;
                        if (!match.hit)
                        {
                            ...
                            lexer.SetPos(save);
                            {
                                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::DeclSep(lexer, processor);
                                if (!m) return std::unexpected<int>(m.error());
                                soul::parser::Match match = *m;
                                *parentMatch3 = match;
                            }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::MarkupDecl(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    {
                        std::int64_t save = lexer.GetPos();
                        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::ElementDecl(lexer, processor);
                        if (!m) return std::unexpected<int>(m.error());
                        soul::parser::Match match = *m;
                        *parentMatch4 = match;
                        if (!match.hit)
                        {
                            ...
                            lexer.SetPos(save);
                            {
                                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::AttlistDecl(lexer, processor);
                                if (!m) return std::unexpected<int>(m.error());
                                soul::parser::Match match = *m;
                                *parentMatch5 = match;
                            }
                    ...
                    *parentMatch3 = match;
                    if (!match.hit)
                    {
                        ...
                        lexer.SetPos(save);
                        {
                            std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::EntityDecl(lexer, processor);
                            if (!m) return std::unexpected<int>(m.error());
                            soul::parser::Match match = *m;
                            *parentMatch6 = match;
                        }
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::NotationDecl(lexer, processor);
                        if (!m) return std::unexpected<int>(m.error());
                        soul::parser::Match match = *m;
                        *parentMatch7 = match;
                    }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::ElementDecl(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                ...
                soul::parser::Match* parentMatch9 = &match;
                {
                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::ContentSpec(lexer);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
                    *parentMatch9 = match;
                }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::ContentSpec(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            *parentMatch1 = match;
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Mixed(lexer);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
                    *parentMatch4 = match;
                }
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Children(lexer);
                if (!m) return std::unexpected<int>(m.error());
                soul::parser::Match match = *m;
                *parentMatch5 = match;
            }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Mixed(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Choice(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch7 = &match;
                    {
                        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::CP(lexer);
                        if (!m) return std::unexpected<int>(m.error());
                        soul::parser::Match match = *m;
                        *parentMatch7 = match;
                    }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::CP(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    *parentMatch3 = match;
                    if (!match.hit)
                    {
                        ...
                        lexer.SetPos(save);
                        {
                            std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Choice(lexer);
                            if (!m) return std::unexpected<int>(m.error());
                            soul::parser::Match match = *m;
                            *parentMatch4 = match;
                        }
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Seq(lexer);
                        if (!m) return std::unexpected<int>(m.error());
                        soul::parser::Match match = *m;
                        *parentMatch5 = match;
                    }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Seq(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Children(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::AttlistDecl(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                ...
                soul::parser::Match* parentMatch7 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch8 = &match;
                    {
                        while (true)
                        {
                            std::int64_t save = lexer.GetPos();
                            {
                                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::AttDef(lexer, processor);
                                if (!m) return std::unexpected<int>(m.error());
                                soul::parser::Match match = *m;
                                if (match.hit)
                                {
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::AttDef(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                ...
                soul::parser::Match* parentMatch7 = &match;
                {
                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::AttType(lexer);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
                    *parentMatch7 = match;
                }
    ...
    if (match.hit)
    {
        ...
        soul::parser::Match* parentMatch9 = &match;
        {
            std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::DefaultDecl(lexer, processor);
            if (!m) return std::unexpected<int>(m.error());
            soul::parser::Match match = *m;
            *parentMatch9 = match;
        }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::AttType(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        {
            std::int64_t save = lexer.GetPos();
            std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::StringType(lexer);
            if (!m) return std::unexpected<int>(m.error());
            soul::parser::Match match = *m;
            *parentMatch1 = match;
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::TokenizedType(lexer);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
                    *parentMatch2 = match;
                }
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::EnumeratedType(lexer);
                if (!m) return std::unexpected<int>(m.error());
                soul::parser::Match match = *m;
                *parentMatch3 = match;
            }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::StringType(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::TokenizedType(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::EnumeratedType(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    {
        std::int64_t save = lexer.GetPos();
        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::NotationType(lexer);
        if (!m) return std::unexpected<int>(m.error());
        soul::parser::Match match = *m;
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Enumeration(lexer);
                if (!m) return std::unexpected<int>(m.error());
                soul::parser::Match match = *m;
                *parentMatch1 = match;
            }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::NotationType(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Enumeration(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch7 = &match;
                    {
                        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::Nmtoken(lexer);
                        if (!m) return std::unexpected<int>(m.error());
                        soul::parser::Match match = *m;
                        *parentMatch7 = match;
                    }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::Nmtoken(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::DefaultDecl(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::EntityDecl(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    {
        std::int64_t save = lexer.GetPos();
        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::GEDecl(lexer, processor);
        if (!m) return std::unexpected<int>(m.error());
        soul::parser::Match match = *m;
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::PEDecl(lexer, processor);
                if (!m) return std::unexpected<int>(m.error());
                soul::parser::Match match = *m;
                *parentMatch1 = match;
            }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::GEDecl(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                ...
                soul::parser::Match* parentMatch9 = &match;
                {
                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::EntityDef(lexer, processor);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
                    *parentMatch9 = match;
                }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::EntityDef(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    {
        std::int64_t save = lexer.GetPos();
        std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::EntityValue(lexer, processor);
        if (!m) return std::unexpected<int>(m.error());
        soul::parser::Match match = *m;
        *parentMatch0 = match;
        if (!match.hit)
                ...
                soul::parser::Match* parentMatch2 = &match;
                {
                    ...
                    if (match.hit)
                    {
                        ...
                        soul::parser::Match* parentMatch4 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch5 = &match;
                            {
                                std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::NDataDecl(lexer);
                                if (!m) return std::unexpected<int>(m.error());
                                soul::parser::Match match = *m;
                                if (match.hit)
                                {
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::EntityValue(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                                        ...
                                        soul::parser::Match* parentMatch7 = &match;
                                        {
                                            ...
                                            *parentMatch7 = match;
                                            if (!match.hit)
                                            {
                                                ...
                                                lexer.SetPos(save);
                                                {
                                                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::PEReference(lexer, processor);
                                                    if (!m) return std::unexpected<int>(m.error());
                                                    soul::parser::Match match = *m;
                                                    *parentMatch8 = match;
                                                }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::PEReference(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::PEDecl(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                ...
                soul::parser::Match* parentMatch13 = &match;
                {
                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::PEDef(lexer, processor);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
                    *parentMatch13 = match;
                }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::PEDef(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::NDataDecl(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::NotationDecl(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                        ...
                        soul::parser::Match* parentMatch11 = &match;
                        {
                            ...
                            *parentMatch11 = match;
                            if (!match.hit)
                            {
                                ...
                                lexer.SetPos(save);
                                {
                                    std::expected<soul::parser::Match, int> m = soul::xml::document::parser::XmlParser<LexerT>::PublicID(lexer);
                                    if (!m) return std::unexpected<int>(m.error());
                                    soul::parser::Match match = *m;
                                    *parentMatch12 = match;
                                }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::DeclSep(LexerT& lexer, soul::xml::processor::XmlProcessor* processor)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> XmlParser<LexerT>::PublicID(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
