...
public:
    ...
    std::expected<std::string, int> ErrorLines(const soul::ast::LineColLen& lineColLen);
    ...
    std::expected<Function*, int> AddFunctionDeclaration(const soul::ast::Span& span, Type* type, const std::string& functionId);
    ...
    std::expected<Instruction*, int> CreateLocal(Type* type);
    std::expected<Instruction*, int> CreateLocalInEntryBlock(Type* type);
    std::expected<Instruction*, int> CreateLoad(Value* ptr);
    ...
    std::expected<bool, int> WriteFile();
