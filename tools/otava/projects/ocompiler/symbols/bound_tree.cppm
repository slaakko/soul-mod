...
public:
    ...
    virtual std::expected<bool, int> Store(Emitter& emitter, OperationFlags flags, const soul::ast::SourcePos& sourcePos, Context* context);
...
public:
    ...
    std::expected<bool, int> AddDynamicInitialization(BoundExpressionNode* dynamicInitialization, BoundExpressionNode* atExitCall, 
        const soul::ast::SourcePos& sourcePos, Context* context);
    void Accept(BoundTreeVisitor& visitor) override;
    std::expected<bool, int> AddBoundNode(std::unique_ptr<BoundNode>&& node, Context* context);
    std::expected<bool, int> AddBoundNodeForClass(ClassTypeSymbol* cls, const soul::ast::SourcePos& sourcePos, Context* context);
    ...
    std::expected<otava::intermediate::Value*, int> CreateBoundGlobalVariable(
...
public:
    ...
    std::expected<bool, int> GenerateCode(BoundTreeVisitor& visitor, Emitter& emitter, Context* context);
private:
