...
enum class SymbolKind : std::uint8_t
{
    ...
    arrayValueSymbol, structureValueSymbol,
    ...
    classTemplateSpecializationSymbol, aliasTypeTemplateSpecializationSymbol, nestedTypeSymbol, dependentTypeSymbol, nullPtrValueSymbol, 
    symbolValueSymbol, invokeValueSymbol,
