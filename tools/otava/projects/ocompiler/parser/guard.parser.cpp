...
std::expected<soul::parser::Match, int> GuardParser<LexerT>::ConceptGuard(LexerT& lexer, otava::symbols::Context* context)
{
...
template<typename LexerT>
std::expected<soul::parser::Match, int> GuardParser<LexerT>::NotDefiningTypeSpecifierGuard(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> GuardParser<LexerT>::AssumeTypeGuard(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> GuardParser<LexerT>::MemberFunctionGuard(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> GuardParser<LexerT>::SavedMemberFunctionBodyGuard(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> GuardParser<LexerT>::SavedCtorInitializerGuard(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    {
        parser_debug_match_pos = lexer.GetPos();
        soul::lexer::WriteBeginRuleToLog(lexer, "SavedCtorInitializerGuard");
    }
    #endif
...
template<typename LexerT>
std::expected<soul::parser::Match, int> GuardParser<LexerT>::NoDeclSpecFunctionDeclarationGuard(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> GuardParser<LexerT>::NoDeclSpecFunctionDefinitionGuard(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
