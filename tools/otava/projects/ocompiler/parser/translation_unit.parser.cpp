...
std::expected<std::unique_ptr<otava::ast::Node>, int> TranslationUnitParser<LexerT>::Parse(LexerT& lexer, otava::symbols::Context* context)
{
    ...
    std::expected<soul::parser::Match, int> m = TranslationUnitParser<LexerT>::TranslationUnit(lexer, context);
...
template<typename LexerT>
std::expected<soul::parser::Match, int> TranslationUnitParser<LexerT>::TranslationUnit(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    std::expected<soul::parser::Match, int> m = otava::parser::translation::unit::TranslationUnitParser<LexerT>::ModuleUnit(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
                    ...
                    if (match.hit)
                    {
                        ...
                        if (!sp) return std::unexpected<int>(sp.error());
                        {
                            ...
                            #endif
                            return soul::parser::Match(true, new otava::ast::TranslationUnitNode(*sp, moduleUnit.release()));
                        }
                    }
                    *parentMatch3 = match;
                }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> TranslationUnitParser<LexerT>::ModuleUnit(LexerT& lexer, otava::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch5 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                {
                                    std::int64_t pos = lexer.GetPos();
                                    std::expected<soul::parser::Match, int> m = otava::parser::modules::ModuleParser<LexerT>::GlobalModuleFragment(lexer, context);
                                    if (!m) return std::unexpected<int>(m.error());
                                    soul::parser::Match match = *m;
            ...
            if (match.hit)
            {
                ...
                soul::parser::Match* parentMatch12 = &match;
                {
                    ...
                    {
                        std::expected<soul::parser::Match, int> m = otava::parser::modules::ModuleParser<LexerT>::PrivateModuleFragment(lexer, context);
                        if (!m) return std::unexpected<int>(m.error());
                        soul::parser::Match match = *m;
