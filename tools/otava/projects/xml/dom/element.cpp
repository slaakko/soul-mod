...
AttributeNode* Element::GetAttributeNode(const std::string& attributeName) const noexcept
{
...
std::string Element::GetAttribute(const std::string& name) const noexcept
{
...
bool Element::HasMultilineContent() const noexcept
{
