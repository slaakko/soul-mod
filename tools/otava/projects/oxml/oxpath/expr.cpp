...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> ToNumber(soul::xml::xpath::Object* object, Context& context)
{
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> ToNumber(soul::xml::Node* node, Context& context)
{
    std::unique_ptr<Object> stringValue(new String(StringValue(node)));
    return ToNumber(stringValue.get(), context);
}

std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> ToBoolean(soul::xml::xpath::Object* object, Context& context)
{
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> EvaluateUnaryMinusExpr(Expr* operand, Context& context)
{
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> EvaluateParenExpr(Expr* operand, Context& context)
{
    return operand->Evaluate(context);
}

std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> EvaluateOrExpr(Expr* left, Expr* right, Context& context)
{
    auto f = GetFunction(FunctionKind::boolean);
    if (!f) return std::unexpected<int>(f.error());
    Function* booleanFunction = *f;
    ...
    std::unique_ptr<soul::xml::xpath::Object> leftResult = std::move(*l);
    ...
    std::unique_ptr<soul::xml::xpath::Object> leftBooleanResult = std::move(*b);
    ...
    if (!r) return std::unexpected<int>(r.error());
    std::unique_ptr<soul::xml::xpath::Object> rightResult = std::move(*r);
    std::vector<Object*> rightArgs(1, rightResult.get());
    return booleanFunction->Evaluate(context, rightArgs);
}

std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> EvaluateAndExpr(Expr* left, Expr* right, Context& context)
{
    auto f = GetFunction(FunctionKind::boolean);
    if (!f) return std::unexpected<int>(f.error());
    Function* booleanFunction = *f;
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> Compare(NodeSet* left, NodeSet* right, Operator op)
{
    int n = left->Count();
    for (int i = 0; i < n; ++i)
    {
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> Compare(NodeSet* left, Boolean* right, Operator op, Context& context)
{
    auto b = ToBoolean(left, context);
    if (!b) return std::unexpected<int>(b.error());
    std::unique_ptr<soul::xml::xpath::Object> leftAsBoolean = std::move(*b);
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> Compare(Boolean* left, NodeSet* right, Operator op, Context& context)
{
    auto b = ToBoolean(right, context);
    if (!b) return std::unexpected<int>(b.error());
    std::unique_ptr<soul::xml::xpath::Object> rightAsBoolean = std::move(*b);
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> Compare(Boolean* left, Number* right, Operator op, Context& context)
{
    auto b = ToBoolean(right, context);
    if (!b) return std::unexpected<int>(b.error());
    std::unique_ptr<soul::xml::xpath::Object> rightAsBoolean = std::move(*b);
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> Compare(Number* left, Boolean* right, Operator op, Context& context)
{
    auto b = ToBoolean(left, context);
    if (!b) return std::unexpected<int>(b.error());
    std::unique_ptr<soul::xml::xpath::Object> leftAsBoolean = std::move(*b);
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> Compare(Boolean* left, String* right, Operator op, Context& context)
{
    auto b = ToBoolean(right, context);
    if (!b) return std::unexpected<int>(b.error());
    std::unique_ptr<soul::xml::xpath::Object> rightAsBoolean = std::move(*b);
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> Compare(String* left, Boolean* right, Operator op, Context& context)
{
    auto b = ToBoolean(left, context);
    if (!b) return std::unexpected<int>(b.error());
    std::unique_ptr<soul::xml::xpath::Object> leftAsBoolean = std::move(*b);
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> Compare(NodeSet* left, Number* right, Operator op, Context& context)
{
    int n = left->Count();
    for (int i = 0; i < n; ++i)
    {
        ...
        std::unique_ptr<soul::xml::xpath::Object> leftAsNumber = std::move(*num);
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> Compare(Number* left, NodeSet* right, Operator op, Context& context)
{
    int n = right->Count();
    for (int i = 0; i < n; ++i)
    {
        ...
        if (!num) return std::unexpected<int>(num.error());
        std::unique_ptr<soul::xml::xpath::Object> rightAsNumber = std::move(*num);
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> Compare(NodeSet* left, String* right, Operator op, Context& context)
{
    int n = left->Count();
    for (int i = 0; i < n; ++i)
    {
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> Compare(String* left, NodeSet* right, Operator op, Context& context)
{
    int n = right->Count();
    for (int i = 0; i < n; ++i)
    {
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> Compare(Number* left, String* right, Operator op, Context& context)
{
    auto n = ToNumber(right, context);
    if (!n) return std::unexpected<int>(n.error());
    std::unique_ptr<soul::xml::xpath::Object> rightAsNumber = std::move(*n);
    auto c = NumberCast(rightAsNumber.get());
    if (!c) return std::unexpected<int>(c.error());
    Number* rightNumber = *c;
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> Compare(String* left, Number* right, Operator op, Context& context)
{
    auto n = ToNumber(left, context);
    if (!n) return std::unexpected<int>(n.error());
    std::unique_ptr<soul::xml::xpath::Object> leftAsNumber = std::move(*n);
    auto c = NumberCast(leftAsNumber.get());
    if (!c) return std::unexpected<int>(c.error());
    Number* leftNumber = *c;
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> Compare(Expr* left, Expr* right, Operator op, Context& context)
{
    auto l = left->Evaluate(context);
    if (!l) return std::unexpected<int>(l.error());
    std::unique_ptr<soul::xml::xpath::Object> leftOperand = std::move(*l);
    auto r = right->Evaluate(context);
    if (!r) return std::unexpected<int>(r.error());
    std::unique_ptr<soul::xml::xpath::Object> rightOperand = std::move(*r);
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> EvaluateArithmeticOp(Expr* left, Expr* right, Operator op, Context& context)
{
    auto l = left->Evaluate(context);
    if (!l) return std::unexpected<int>(l.error());
    std::unique_ptr<soul::xml::xpath::Object> leftOperand = std::move(*l);
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> EvaluateUnionExpr(Expr* left, Expr* right, Context& context)
{
    auto l = left->Evaluate(context);
    if (!l) return std::unexpected<int>(l.error());
    std::unique_ptr<soul::xml::xpath::Object> leftOperand = std::move(*l);
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> EvaluateCombineStepExpr(Expr* left, Expr* right, Context& context)
{
    auto l = left->Evaluate(context);
    if (!l) return std::unexpected<int>(l.error());
    std::unique_ptr<soul::xml::xpath::Object> leftOperand = std::move(*l);
...
std::expected<soul::xml::Element*, int> Expr::ToXmlElement() const
{
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> UnaryExpr::Evaluate(Context& context) const
{
    switch (op)
    {
    case Operator::minus:
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> BinaryExpr::Evaluate(Context& context) const
{
    switch (op)
    {
    case Operator::or_:
...
std::expected<soul::xml::Element*, int> BinaryExpr::ToXmlElement() const
{
    auto e = Expr::ToXmlElement();
    if (!e) return e;
    soul::xml::Element* element = *e;
    element->SetAttribute("operator", OperatorStr(op));
    e = left->ToXmlElement();
    soul::xml::Element* leftElement = *e;
    if (!e) return e;
    auto rv = element->AppendChild(leftElement);
    if (!rv) return std::unexpected<int>(rv.error());
    e = right->ToXmlElement();
    if (!e) return e;
    soul::xml::Element* rightElement = *e;
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> Root::Evaluate(Context& context) const
{
    std::unique_ptr<soul::xml::xpath::NodeSet> nodeSet(new soul::xml::xpath::NodeSet());
    if (context.GetNode()->IsDocumentNode())
    {
        nodeSet->Add(context.GetNode());
    }
    else if (context.GetNode()->OwnerDocument())
    {
        nodeSet->Add(context.GetNode()->OwnerDocument());
    }
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> FilterExpr::Evaluate(Context& context) const
{
    auto s = subject->Evaluate(context);
    if (!s) return std::unexpected<int>(s.error());
    std::unique_ptr<soul::xml::xpath::Object> subjectResult = std::move(*s);
    if (subjectResult->IsNodeSet())
    {
        ...
        for (int i = 0; i < count; ++i)
        {
            ...
            else
            {
                ...
                if (!b) return std::unexpected<int>(b.error());
                std::unique_ptr<soul::xml::xpath::Object> booleanResult = std::move(*b);
...
std::expected<soul::xml::Element*, int> FilterExpr::ToXmlElement() const
{
    auto e = Expr::ToXmlElement();
    if (!e) return e;
    soul::xml::Element* element = *e;
    ...
    if (!e) return e;
    soul::xml::Element* subjectElement = *e;
    auto rv = element->AppendChild(subjectElement);
    if (!rv) return std::unexpected<int>(rv.error());
    e = predicate->ToXmlElement();
    if (!e) return e;
    soul::xml::Element* predicateElement = *e;
...
std::expected<soul::xml::Element*, int> NodeTest::ToXmlElement() const
{
...
std::expected<soul::xml::Element*, int> PILiteralNodeTest::ToXmlElement() const
{
...
std::expected<soul::xml::Element*, int> PrefixNodeTest::ToXmlElement() const
{
    auto e = NodeTest::ToXmlElement();
    if (!e) return e;
    soul::xml::Element* element = *e;
...
std::expected<soul::xml::Element*, int> NameNodeTest::ToXmlElement() const
{
    auto e = NodeTest::ToXmlElement();
    if (!e) return e;
    soul::xml::Element* element = *e;
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> LocationStepExpr::Evaluate(Context& context) const
{
    std::unique_ptr<soul::xml::xpath::NodeSet> nodeSet(new soul::xml::xpath::NodeSet());
    NodeSelectionOperation selectNodes(nodeTest.get(), *nodeSet, axis);
    context.GetNode()->Walk(selectNodes, axis);
    for (const auto& predicate : predicates)
    {
        ...
        for (int i = 0; i < count; ++i)
        {
            ...
            std::unique_ptr<soul::xml::xpath::Object> predicateResult = std::move(*p);
            bool include = false;
...
std::expected<soul::xml::Element*, int> LocationStepExpr::ToXmlElement() const
{
    auto e = Expr::ToXmlElement();
    if (!e) return e;
    soul::xml::Element* element = *e;
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> VariableReference::Evaluate(Context& context) const
{
    return std::unexpected<int>(util::AllocateError("error: variable references not implemented"));
}

std::expected<soul::xml::Element*, int> VariableReference::ToXmlElement() const
{
    auto e = Expr::ToXmlElement();
    if (!e) return e;
    soul::xml::Element* element = *e;
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> Literal::Evaluate(Context& context) const
{
    return std::unique_ptr<soul::xml::xpath::Object>(new String(value));
}

std::expected<soul::xml::Element*, int> Literal::ToXmlElement() const
{
    auto e = Expr::ToXmlElement();
    if (!e) return e;
    soul::xml::Element* element = *e;
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> NumberExpr::Evaluate(Context& context) const
{
    return std::unique_ptr<soul::xml::xpath::Object>(new Number(value));
}

std::expected<soul::xml::Element*, int> NumberExpr::ToXmlElement() const
{
    auto e = Expr::ToXmlElement();
    if (!e) return e;
    soul::xml::Element* element = *e;
...
std::expected<std::unique_ptr<soul::xml::xpath::Object>, int> FunctionCall::Evaluate(Context& context) const
{
...
std::expected<soul::xml::Element*, int> FunctionCall::ToXmlElement() const
{
    auto e = Expr::ToXmlElement();
    if (!e) return e;
    soul::xml::Element* element = *e;
