// this file has been automatically generated from 'D:/work/soul-mod/tools/otava/projects/oxml/oxpath/xpath.lexer' using soul lexer generator oslg version 5.0.0
...
template<typename CharT>
std::expected<soul::lexer::Lexer<XPathLexer<CharT>, CharT>, int> MakeLexer(const CharT* start, const CharT* end, const std::string& fileName);

template<typename CharT>
std::expected<soul::lexer::Lexer<XPathLexer<CharT>, CharT>, int> MakeLexer(const std::string& moduleFileName, util::ResourceFlags resourceFlags, const CharT* start, const CharT* end, const std::string& fileName);
...
struct XPathLexer
{
    ...
    static std::int64_t GetTokenId(std::int32_t ruleIndex, soul::lexer::LexerBase<CharT>& lexer)
    {
        switch (ruleIndex)
        {
            ...
            {
                lexer.Retract();
                return soul::xml::xpath::token::NAME;
                break;
            }
            case 2:
            {
                lexer.Retract();
                return soul::xml::xpath::token::NUMBER;
                break;
            }
            case 3:
            {
                lexer.Retract();
                return soul::xml::xpath::token::DQ_STRING;
                break;
            }
            case 4:
            {
                lexer.Retract();
                return soul::xml::xpath::token::SQ_STRING;
                break;
            }
            case 5:
            {
                lexer.Retract();
                return soul::xml::xpath::token::EQ;
                break;
            }
            case 6:
            {
                lexer.Retract();
                return soul::xml::xpath::token::NEQ;
                break;
            }
            case 7:
            {
                lexer.Retract();
                return soul::xml::xpath::token::LEQ;
                break;
            }
            case 8:
            {
                lexer.Retract();
                return soul::xml::xpath::token::GEQ;
                break;
            }
            case 9:
            {
                lexer.Retract();
                return soul::xml::xpath::token::LESS;
                break;
            }
            case 10:
            {
                lexer.Retract();
                return soul::xml::xpath::token::GREATER;
                break;
            }
            case 11:
            {
                lexer.Retract();
                return soul::xml::xpath::token::PLUS;
                break;
            }
            case 12:
            {
                lexer.Retract();
                return soul::xml::xpath::token::MINUS;
                break;
            }
            case 13:
            {
                lexer.Retract();
                return soul::xml::xpath::token::STAR;
                break;
            }
            case 14:
            {
                lexer.Retract();
                return soul::xml::xpath::token::UNION;
                break;
            }
            case 15:
            {
                lexer.Retract();
                return soul::xml::xpath::token::SLASH_SLASH;
                break;
            }
            case 16:
            {
                lexer.Retract();
                return soul::xml::xpath::token::SLASH;
                break;
            }
            case 17:
            {
                lexer.Retract();
                return soul::xml::xpath::token::DOT_DOT;
                break;
            }
            case 18:
            {
                lexer.Retract();
                return soul::xml::xpath::token::DOT;
                break;
            }
            case 19:
            {
                lexer.Retract();
                return soul::xml::xpath::token::COLON_COLON;
                break;
            }
            case 20:
            {
                lexer.Retract();
                return soul::xml::xpath::token::COLON;
                break;
            }
            case 21:
            {
                lexer.Retract();
                return soul::xml::xpath::token::DOLLAR;
                break;
            }
            case 22:
            {
                lexer.Retract();
                return soul::xml::xpath::token::COMMA;
                break;
            }
            case 23:
            {
                lexer.Retract();
                return soul::xml::xpath::token::AT;
                break;
            }
            case 24:
            {
                lexer.Retract();
                return soul::xml::xpath::token::LBRACKET;
                break;
            }
            case 25:
            {
                lexer.Retract();
                return soul::xml::xpath::token::RBRACKET;
                break;
            }
            case 26:
            {
                lexer.Retract();
                return soul::xml::xpath::token::LPAREN;
                break;
            }
            case 27:
            {
                lexer.Retract();
                return soul::xml::xpath::token::RPAREN;
                break;
            }
        }
...
std::expected<soul::lexer::ClassMap<CharT>*, int> GetClassMap()
{
    ...
    if (!classmap)
    {
        std::expected<soul::lexer::ClassMap<CharT>*, int> rv = soul::lexer::MakeClassMap<CharT>("soul.xml.xpath.lexer.classmap");
...
std::expected<soul::lexer::ClassMap<CharT>*, int> GetClassMap(const std::string & moduleFileName, util::ResourceFlags resourceFlags)
{
    ...
    if (!classmap)
    {
        std::expected<soul::lexer::ClassMap<CharT>*, int> rv = soul::lexer::MakeClassMap<CharT>(moduleFileName, "soul.xml.xpath.lexer.classmap", resourceFlags);
        if (!rv) return std::unexpected<int>(rv.error());
        classmap = *rv;
    }
    return classmap;
...
std::expected<soul::lexer::Lexer<XPathLexer<CharT>, CharT>, int> MakeLexer(const CharT* start, const CharT* end, const std::string& fileName)
{
    ...
    auto lexer = soul::lexer::Lexer<XPathLexer<CharT>, CharT>(start, end, fileName);
...
template class XPathLexer<char32_t>;
template class soul::lexer::Lexer<XPathLexer<char32_t>, char32_t>;
