...
std::expected<Function*, int> FunctionLibrary::GetFunction(FunctionKind kind) const
{
    ...
    if (!function)
    {
        return std::unexpected<int>(util::AllocateError("error: soul::xml::xpath::FunctionLibrary::GetFunction: function '" + FunctionName(kind) + "()' not installed"));
    }
...
std::expected<Function*, int> FunctionLibrary::GetFunction(const std::string& name) const
{
    ...
    {
        return std::unexpected<int>(util::AllocateError("error: soul::xml::xpath::FunctionLibrary::GetFunction: function '" + name + "()' not found"));
    }
}
