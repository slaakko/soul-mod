...
std::expected<std::unique_ptr<soul::ast::slg::ExpressionFile>, int> ExpressionFileParser<LexerT>::Parse(LexerT& lexer)
{
    ...
    std::expected<soul::parser::Match, int> m = ExpressionFileParser<LexerT>::ExpressionFile(lexer);
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ExpressionFileParser<LexerT>::ExpressionFile(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
                            ...
                            while (true)
                            {
                                std::int64_t save = lexer.GetPos();
                                {
                                    ...
                                    soul::parser::Match* parentMatch14 = &match;
                                    {
                                        ...
                                        {
                                            std::int64_t pos = lexer.GetPos();
                                            std::expected<soul::parser::Match, int> m = ExpressionFileParser<LexerT>::Expression(lexer);
                                            if (!m) return std::unexpected<int>(m.error());
                                            soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> ExpressionFileParser<LexerT>::Expression(LexerT& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
