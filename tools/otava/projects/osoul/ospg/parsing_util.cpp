...
bool IsGetNode(const soul::ast::cpp::TypeNameNode& node)
{
    soul::ast::cpp::Node* parent = node.Parent();
    if (parent && parent->Kind() == soul::ast::cpp::NodeKind::memberAccessNode)
    {
...
bool IsContainedBySwitchStatment(const soul::ast::cpp::TypeNameNode& node)
{
    soul::ast::cpp::Node* parent = node.Parent();
    while (parent)
    {
...
public:
    ...
    void Visit(soul::ast::cpp::TypeNameNode& node);
    void Visit(soul::ast::cpp::IdExprNode& node);
private:
    std::vector<NonterminalInfo>& nonterminalInfos;
};

void NonterminalCountingVisitor::Visit(soul::ast::cpp::TypeNameNode& node)
{
