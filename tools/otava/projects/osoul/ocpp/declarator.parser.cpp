...
// this file has been automatically generated from 'D:/work/soul-mod/tools/otava/projects/osoul/ocpp/declarator.parser' using soul parser generator ospg version 5.0.0
...
std::expected<soul::parser::Match, int> DeclaratorParser<LexerT>::InitDeclaratorList(LexerT& lexer, soul::ast::cpp::Context* context)
{
                ...
                soul::parser::Match* parentMatch4 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            {
                                std::int64_t pos = lexer.GetPos();
                                std::expected<soul::parser::Match, int> m = soul::cpp::declarator::parser::DeclaratorParser<LexerT>::InitDeclarator(lexer, context);
...
template<typename LexerT>
std::expected<soul::parser::Match, int> DeclaratorParser<LexerT>::InitDeclarator(LexerT& lexer, soul::ast::cpp::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                        std::expected<soul::parser::Match, int> m = soul::cpp::declarator::parser::DeclaratorParser<LexerT>::Initializer(lexer, context);
                        if (!m) return std::unexpected<int>(m.error());
                        soul::parser::Match match = *m;
        ...
        if (match.hit)
        {
            ...
            if (!sp) return std::unexpected<int>(sp.error());
            {
                ...
                #endif
                return soul::parser::Match(true, new soul::ast::cpp::InitDeclaratorNode(*sp, declarator->value, initializer.release()));
            }
        }
        *parentMatch0 = match;
    }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> DeclaratorParser<LexerT>::Declarator(LexerT& lexer, soul::ast::cpp::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            switch (*lexer)
            {
                ...
                case soul::cpp::token::ID:
                {
                    ...
                    {
                        std::int64_t pos = lexer.GetPos();
                        std::expected<soul::parser::Match, int> m = soul::cpp::declarator::parser::DeclaratorParser<LexerT>::DirectDeclarator(lexer, context);
                        if (!m) return std::unexpected<int>(m.error());
                        soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> DeclaratorParser<LexerT>::DirectDeclarator(LexerT& lexer, soul::ast::cpp::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul::parser::Match, int> m = soul::cpp::declarator::parser::DeclaratorParser<LexerT>::DeclaratorId(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> DeclaratorParser<LexerT>::DeclaratorId(LexerT& lexer, soul::ast::cpp::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> DeclaratorParser<LexerT>::TypeId(LexerT& lexer, soul::ast::cpp::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                    ...
                    soul::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            switch (*lexer)
                            {
                                ...
                                {
                                    std::expected<soul::parser::Match, int> m = soul::cpp::declarator::parser::DeclaratorParser<LexerT>::TypeSpecifierSeq(lexer, context, typeId.get());
                                    if (!m) return std::unexpected<int>(m.error());
                                    soul::parser::Match match = *m;
                                    if (match.hit)
                                    {
                        ...
                        soul::parser::Match* parentMatch9 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch10 = &match;
                            {
                                ...
                                soul::parser::Match* parentMatch11 = &match;
                                {
                                    ...
                                    {
                                        std::int64_t pos = lexer.GetPos();
                                        std::expected<soul::parser::Match, int> m = soul::cpp::declarator::parser::DeclaratorParser<LexerT>::AbstractDeclarator(lexer, context);
                                        if (!m) return std::unexpected<int>(m.error());
                                        soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> DeclaratorParser<LexerT>::Type(LexerT& lexer, soul::ast::cpp::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> DeclaratorParser<LexerT>::TypeSpecifierSeq(LexerT& lexer, soul::ast::cpp::Context* context, soul::ast::cpp::TypeIdNode* typeId)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> DeclaratorParser<LexerT>::AbstractDeclarator(LexerT& lexer, soul::ast::cpp::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            switch (*lexer)
            {
                ...
                case soul::punctuation::token::LPAREN:
                {
                    ...
                    {
                        std::int64_t pos = lexer.GetPos();
                        std::expected<soul::parser::Match, int> m = soul::cpp::declarator::parser::DeclaratorParser<LexerT>::DirectAbstractDeclarator(lexer, context);
                        if (!m) return std::unexpected<int>(m.error());
                        soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> DeclaratorParser<LexerT>::DirectAbstractDeclarator(LexerT& lexer, soul::ast::cpp::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> DeclaratorParser<LexerT>::PtrOperator(LexerT& lexer, soul::ast::cpp::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                        ...
                        soul::parser::Match* parentMatch5 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                soul::parser::Match* parentMatch7 = &match;
                                {
                                    ...
                                    {
                                        std::int64_t pos = lexer.GetPos();
                                        std::expected<soul::parser::Match, int> m = soul::cpp::declarator::parser::DeclaratorParser<LexerT>::CVQualifierSeq(lexer, context);
                                        if (!m) return std::unexpected<int>(m.error());
                                        soul::parser::Match match = *m;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> DeclaratorParser<LexerT>::CVQualifierSeq(LexerT& lexer, soul::ast::cpp::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename LexerT>
std::expected<soul::parser::Match, int> DeclaratorParser<LexerT>::Initializer(LexerT& lexer, soul::ast::cpp::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                ...
                case soul::cpp::op::token::ASSIGN:
                {
                    ...
                    if (match.hit)
                    {
                        ...
                        soul::parser::Match* parentMatch4 = &match;
                        {
                            ...
                            {
                                std::int64_t pos = lexer.GetPos();
                                std::expected<soul::parser::Match, int> m = soul::cpp::declarator::parser::DeclaratorParser<LexerT>::InitializerClause(lexer, context);
                                if (!m) return std::unexpected<int>(m.error());
                                soul::parser::Match match = *m;
                                ...
                                if (match.hit)
                                {
                                    auto sp = lexer.GetSourcePos(pos);
                                    if (!sp) return std::unexpected<int>(sp.error());
                                    initializer.reset(new soul::ast::cpp::InitializerNode(*sp, initializerClause.release()));
                                }
                                *parentMatch5 = match;
                            }
                            *parentMatch4 = match;
                ...
                case soul::punctuation::token::LPAREN:
                {
                    ...
                    soul::parser::Match* parentMatch6 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            ...
                            soul::parser::Match* parentMatch9 = &match;
                            {
                                std::expected<soul::parser::Match, int> m = soul::cpp::expression::parser::ExpressionParser<LexerT>::ExpressionList(lexer, context, initializer.get());
                                if (!m) return std::unexpected<int>(m.error());
                                soul::parser::Match match = *m;
                                *parentMatch9 = match;
                            }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> DeclaratorParser<LexerT>::InitializerClause(LexerT& lexer, soul::ast::cpp::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                    ...
                    case soul::cpp::token::CHAR_LITERAL:
                    {
                        ...
                        soul::parser::Match* parentMatch4 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                auto sp = lexer.GetSourcePos(pos);
                                if (!sp) return std::unexpected<int>(sp.error());
                                assignInit.reset(new soul::ast::cpp::AssignInitNode(*sp, expr.release()));
                            }
                            *parentMatch4 = match;
                        }
                        if (match.hit)
                    ...
                    case soul::punctuation::token::LBRACE:
                    {
                        ...
                        soul::parser::Match* parentMatch5 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                ...
                                soul::parser::Match* parentMatch8 = &match;
                                {
                                    std::expected<soul::parser::Match, int> m = soul::cpp::declarator::parser::DeclaratorParser<LexerT>::InitializerList(lexer, context, assignInit.get());
                                    if (!m) return std::unexpected<int>(m.error());
                                    soul::parser::Match match = *m;
                                    *parentMatch8 = match;
                                }
...
template<typename LexerT>
std::expected<soul::parser::Match, int> DeclaratorParser<LexerT>::InitializerList(LexerT& lexer, soul::ast::cpp::Context* context, soul::ast::cpp::AssignInitNode* init)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    std::int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
