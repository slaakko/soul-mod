...
template<typename CharT>
std::expected<soul::lexer::Lexer<SlgLexer<CharT>, CharT>, int> MakeLexer(const CharT* start, const CharT* end, const std::string& fileName);
...
std::expected<soul::lexer::ClassMap<CharT>*, int> GetClassMap()
{
    ...
    if (!classmap)
    {
        std::expected<soul::lexer::ClassMap<CharT>*, int> rv = soul::lexer::MakeClassMap<CharT>("soul.lex.slg.classmap");
...
std::expected<soul::lexer::ClassMap<CharT>*, int> GetClassMap(const std::string & moduleFileName, util::ResourceFlags resourceFlags)
{
    ...
    if (!classmap)
    {
        std::expected<soul::lexer::ClassMap<CharT>*, int> rv = soul::lexer::MakeClassMap<CharT>(moduleFileName, "soul.lex.slg.classmap", resourceFlags);
        if (!rv) return std::unexpected<int>(rv.error());
        classmap = *rv;
    }
    return classmap;
...
template class SlgLexer<char32_t>;
template class soul::lexer::Lexer<SlgLexer<char32_t>, char32_t>;
