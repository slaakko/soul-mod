...
{
    static soul::ast::common::TokenCollection tokens("soul.token.lexer.tokens");
    if (!tokens.Initialized())
    {
        tokens.SetInitialized();
        tokens.AddToken(new soul::ast::common::Token(WS, "WS", "white space"));
        tokens.AddToken(new soul::ast::common::Token(LINE_COMMENT, "LINE_COMMENT", "comment"));
        ...
        tokens.AddToken(new soul::ast::common::Token(PUNCT, "PUNCT", "punctuation"));
        ...
        tokens.AddToken(new soul::ast::common::Token(IMPLEMENTATION, "IMPLEMENTATION", "'implementation'"));
        tokens.AddToken(new soul::ast::common::Token(INTERFACE, "INTERFACE", "'interface'"));
        tokens.AddToken(new soul::ast::common::Token(PARSER, "PARSER", "'parser'"));
        tokens.AddToken(new soul::ast::common::Token(LEXER, "LEXER", "'lexer'"));
