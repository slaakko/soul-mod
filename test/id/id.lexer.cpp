// this file has been automatically generated from 'D:/work/soul-mod/test/id/id.lexer' using soul lexer generator slg version 5.0.0
...
{
    static soul::ast::slg::TokenCollection tokens("id.tokens");
