...
template<typename Char>
soul::lexer::Lexer<IdLexer<Char>, Char> MakeLexer(const Char* start, const Char* end, const std::string& fileName);

template<typename Char>
soul::lexer::Lexer<IdLexer<Char>, Char> MakeLexer(const std::string& moduleFileName, util::ResourceFlags resourceFlags, const Char* start, const Char* end, const std::string& fileName);

soul::ast::slg::TokenCollection* GetTokens();

struct IdLexer_Variables : public soul::lexer::Variables
{
    IdLexer_Variables();
};
...
{
    static soul::lexer::ClassMap<Char>* classmap = soul::lexer::MakeClassMap<Char>("id.classmap");
    return classmap;
}
...
{
    static soul::lexer::ClassMap<Char>* classmap = soul::lexer::MakeClassMap<Char>(moduleFileName, "id.classmap", resourceFlags);
    return classmap;
}
...
soul::lexer::Lexer<IdLexer<Char>, Char> MakeLexer(const Char* start, const Char* end, const std::string& fileName)
{
    ...
    auto lexer = soul::lexer::Lexer<IdLexer<Char>, Char>(start, end, fileName);
