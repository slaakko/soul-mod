...
function createClassElements(levelClasses, maxTextWidth, maxTextHeight) {
    ...
    for (var i = 0; i < n; ++i) {
        ...
        var svg = document.getElementById("classDiagram");
...
function drawClassDiagram() {
    var classes = [
        { name: "ns::Foo", id: "class_0", level: 0, subject: true, hasDerivedClasses: true, link: "../lib1.ex1/class_Foo_84A0D93AA887666032AC96172A6DF12DF77496B2.html" },
        { name: "ns::Bar", id: "class_1", level: 1, subject: false, hasDerivedClasses: false, link: "../lib1.ex2/class_Bar_D2F3E97FEC5D9EDEFED5804B960797D0FC00012F.html" }];
    drawDiagram(classes);
}
