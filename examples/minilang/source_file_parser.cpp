...
std::unique_ptr<minilang::tree::SourceFileNode> SourceFileParser<Lexer>::Parse(Lexer& lexer)
{
    std::unique_ptr<minilang::tree::SourceFileNode> value;
    ...
    value.reset(static_cast<minilang::tree::SourceFileNode*>(match.value));
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    if (lexer.Log())
    {
        lexer.Log()->DecIndent();
...
soul::parser::Match SourceFileParser<Lexer>::SourceFile(Lexer& lexer)
{
    ...
    std::unique_ptr<minilang::tree::SourceFileNode> sourceFile = std::unique_ptr<minilang::tree::SourceFileNode>();
    std::unique_ptr<minilang::tree::FunctionNode> function;
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    if (match.hit)
                    {
                        sourceFile.reset(new minilang::tree::SourceFileNode);
                    }
                    *parentMatch3 = match;
                }
                *parentMatch2 = match;
                            ...
                            int64_t save = lexer.GetPos();
                            {
                                ...
                                soul::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soul::parser::Match* parentMatch7 = &match;
                                    {
                                        ...
                                        function.reset(static_cast<minilang::tree::FunctionNode*>(match.value));
                                        if (match.hit)
                                        {
