...
module soul_expected.xml.element;
...
Element::Element(const soul_expected::ast::SourcePos& sourcePos_, const std::string& name_) : ParentNode(NodeKind::elementNode, sourcePos_, name_)
{
}
...
void Element::SetAttribute(const soul_expected::ast::SourcePos& sourcePos, const std::string& name, const std::string& value)
{
    AttributeNode* attributeNode = GetAttributeNode(name);
    if (attributeNode)
    {
...
{
    SetAttribute(soul_expected::ast::SourcePos(), name, value);
}
...
{
    return new Element(soul_expected::ast::SourcePos(), name);
}
