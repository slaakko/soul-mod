...
module soul_expected.xml.attribute.node;
...
AttributeNode::AttributeNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& name_, const std::string& value_) :
...
{
    return new AttributeNode(soul_expected::ast::SourcePos(), name, value);
}
