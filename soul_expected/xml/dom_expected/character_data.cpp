...
module soul_expected.xml.character.data;
...
CharacterData::CharacterData(NodeKind kind_, const soul_expected::ast::SourcePos& sourcePos_, const std::string& name_) :
    CharacterData(kind_, sourcePos_, name_, std::string())
{
}

CharacterData::CharacterData(NodeKind kind_, const soul_expected::ast::SourcePos& sourcePos_, const std::string& name_, const std::string& data_) :
