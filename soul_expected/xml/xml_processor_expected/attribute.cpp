...
module soul_expected.xml.processor.attribute;

namespace soul_expected::xml::processor {

Attribute::Attribute(const soul_expected::ast::SourcePos& sourcePos_, const std::string& namespaceUri_, const std::string& localName_, const std::string& qualifiedName_, 
