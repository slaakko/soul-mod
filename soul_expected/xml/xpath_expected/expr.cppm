...
public:
    ...
    virtual std::expected<std::unique_ptr<soul_expected::xml::xpath::Object>, int> Evaluate(Context& context) const = 0;
    virtual std::expected<soul_expected::xml::Element*, int> ToXmlElement() const;
private:
    ExprKind kind;
    std::string str;
};
...
public:
    ...
    std::expected<std::unique_ptr<soul_expected::xml::xpath::Object>, int> Evaluate(Context& context) const override;
...
public:
    ...
    virtual bool Select(soul_expected::xml::Node* node, soul_expected::xml::Axis axis) const;
    virtual std::expected<soul_expected::xml::Element*, int> ToXmlElement() const;
private:
    NodeTestKind kind;
};
...
public:
    ...
    bool Select(soul_expected::xml::Node* node, soul_expected::xml::Axis axis) const override;
    std::expected<soul_expected::xml::Element*, int> ToXmlElement() const override;
private:
...
{
public:
    LocationStepExpr(soul_expected::xml::Axis axis_, NodeTest* nodeTest_);
