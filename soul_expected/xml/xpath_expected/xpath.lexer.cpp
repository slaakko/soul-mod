...
{
    static soul_expected::ast::slg::TokenCollection tokens("soul_expected.xml.xpath.lexer.tokens");
    if (!tokens.Initialized())
    {
        tokens.SetInitialized();
        tokens.AddToken(new soul_expected::ast::slg::Token(OR, "OR", "'or'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(AND, "AND", "'and'"));
        ...
        tokens.AddToken(new soul_expected::ast::slg::Token(LESS, "LESS", "'<'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(GREATER, "GREATER", "'>'"));
        ...
        tokens.AddToken(new soul_expected::ast::slg::Token(DIV, "DIV", "'div'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(MOD, "MOD", "'mod'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(UNION, "UNION", "'|'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(SLASH_SLASH, "SLASH_SLASH", "'//'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(SLASH, "SLASH", "'/'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(DOT_DOT, "DOT_DOT", "'..'"));
        ...
        tokens.AddToken(new soul_expected::ast::slg::Token(ANCESTOR, "ANCESTOR", "'ancestor'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(ANCESTOR_OR_SELF, "ANCESTOR_OR_SELF", "'ancestor-or-self'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(ATTRIBUTE, "ATTRIBUTE", "'attribte'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(CHILD, "CHILD", "'child'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(DESCENDANT, "DESCENDANT", "'descendant"));
        tokens.AddToken(new soul_expected::ast::slg::Token(DESCENDANT_OR_SELF, "DESCENDANT_OR_SELF", "'descendant-or-self'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(FOLLOWING, "FOLLOWING", "'following'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(FOLLOWING_SIBLING, "FOLLOWING_SIBLING", "'following-sibling'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(NAMESPACE, "NAMESPACE", "'namespace'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(PARENT, "PARENT", "'parent'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(PRECEDING, "PRECEDING", "'preceding'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(PRECEDING_SIBLING, "PRECEDING_SIBLING", "'preceding-siblibg'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(SELF, "SELF", "'self'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(AT, "AT", "'@'"));
        ...
        tokens.AddToken(new soul_expected::ast::slg::Token(PROCESSING_INSTRUCTION, "PROCESSING_INSTRUCTION", "'processing-instructioon'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(COMMENT, "COMMENT", "'comment'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(TEXT, "TEXT", "'text'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(NODE, "NODE", "'node'"));
        tokens.AddToken(new soul_expected::ast::slg::Token(DQ_STRING, "DQ_STRING", "string"));
        tokens.AddToken(new soul_expected::ast::slg::Token(SQ_STRING, "SQ_STRING", "string"));
        tokens.AddToken(new soul_expected::ast::slg::Token(NUMBER, "NUMBER", "number"));
        tokens.AddToken(new soul_expected::ast::slg::Token(NAME, "NAME", "name"));
    }
    return &tokens;
}
