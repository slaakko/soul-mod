...
export module soul_expected.rex.lexer;
...
template<typename CharT>
std::expected<soul_expected::lexer::Lexer<RexLexer<CharT>, CharT>, int> MakeLexer(const CharT* start, const CharT* end, const std::string& fileName);

template<typename CharT>
std::expected<soul_expected::lexer::Lexer<RexLexer<CharT>, CharT>, int> MakeLexer(const std::string& moduleFileName, util::ResourceFlags resourceFlags, const CharT* start, const CharT* end, const std::string& fileName);

soul_expected::ast::slg::TokenCollection* GetTokens();

struct RexLexer_Variables : public soul_expected::lexer::Variables
{
    RexLexer_Variables();
};
...
struct RexLexer
{
    using Variables = RexLexer_Variables;
...
std::expected<soul_expected::lexer::Lexer<RexLexer<CharT>, CharT>, int> MakeLexer(const CharT* start, const CharT* end, const std::string& fileName)
{
    ...
    auto lexer = soul_expected::lexer::Lexer<RexLexer<CharT>, CharT>(start, end, fileName);
