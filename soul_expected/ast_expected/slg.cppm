...
public:
    ...
    soul_expected::ast::cpp::CompoundStatementNode* Code() const { return code.get(); }
...
public:
    ...
    soul_expected::ast::common::ExportModule* GetExportModule() const { return exportModule.get(); }
    void AddImport(soul_expected::ast::common::Import* imp);
    const std::vector<std::unique_ptr<soul_expected::ast::common::Import>>& Imports() const { return imports; }
