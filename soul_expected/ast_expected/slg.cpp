...
Keyword::Keyword(const soul_expected::ast::SourcePos& sourcePos_, const std::string& str_, const std::string& tokenName_, std::int64_t tokenId_) : 
    sourcePos(sourcePos_), str(str_), tokenName(tokenName_), tokenId(tokenId_), collection(nullptr)
{
}

Keyword::Keyword(const soul_expected::ast::SourcePos& sourcePos_, const std::string& str_, const std::string& tokenName_) : 
    sourcePos(sourcePos_), str(str_), tokenName(tokenName_), tokenId(-1), collection(nullptr)
{
}

KeywordCollection::KeywordCollection(const std::string& name_) : soul_expected::ast::common::Collection(soul_expected::ast::common::CollectionKind::keywordCollection, name_)
{
}
...
KeywordFile::KeywordFile(const std::string& filePath_) : soul_expected::ast::common::File(soul_expected::ast::common::FileKind::keywordFile, filePath_)
{
}
...
{
    soul_expected::ast::common::Collection* collection = GetCollection();
    soul_expected::ast::common::File* file = collection->GetFile();
    return file->FilePath();
}

ExpressionCollection::ExpressionCollection(const std::string& name_) : soul_expected::ast::common::Collection(soul_expected::ast::common::CollectionKind::expressionCollection, name_)
{
}
...
ExpressionFile::ExpressionFile(const std::string& filePath_) : soul_expected::ast::common::File(soul_expected::ast::common::FileKind::expressionFile, filePath_)
{
}
...
Lexer::Lexer(const std::string& name_) : soul_expected::ast::common::Collection(soul_expected::ast::common::CollectionKind::lexer, name_)
{
}
...
LexerFile::LexerFile(const std::string& filePath_) : soul_expected::ast::common::File(soul_expected::ast::common::FileKind::lexerFile, filePath_)
{
}
...
SlgFile::SlgFile(const std::string& filePath_, const std::string& projectName_) : soul_expected::ast::common::File(soul_expected::ast::common::FileKind::slgFile, filePath_), projectName(projectName_)
{
}
...
std::expected<bool, int> SlgFile::AddTokenFile(soul_expected::ast::common::TokenFile* tokenFile)
{
    ...
    collectionMap[tokenFile->GetTokenCollection()->Name()] = static_cast<soul_expected::ast::common::Collection*>(tokenFile->GetTokenCollection());
...
std::expected<bool, int> SlgFile::AddKeywordFile(KeywordFile* keywordFile)
{
    ...
    collectionMap[keywordFile->GetKeywordCollection()->Name()] = static_cast<soul_expected::ast::common::Collection*>(keywordFile->GetKeywordCollection());
...
std::expected<bool, int> SlgFile::AddExpressionFile(ExpressionFile* expressionFile)
{
    ...
    collectionMap[expressionFile->GetExpressionCollection()->Name()] = static_cast<soul_expected::ast::common::Collection*>(expressionFile->GetExpressionCollection());
...
std::expected<bool, int> SlgFile::AddLexerFile(LexerFile* lexerFile)
{
    ...
    collectionMap[lexerFile->GetLexer()->Name()] = static_cast<soul_expected::ast::common::Collection*>(lexerFile->GetLexer());
    collections.push_back(lexerFile->GetLexer());
    return std::expected<bool, int>(true);
}

std::expected<soul_expected::ast::common::Collection*, int> SlgFile::GetCollection(const std::string& name) const
{
    auto it = collectionMap.find(name);
    if (it != collectionMap.cend())
    {
        return std::expected<soul_expected::ast::common::Collection*, int>(it->second);
    }
    else
    {
...
void Tokens::AddToken(soul_expected::ast::common::Token* token)
{
