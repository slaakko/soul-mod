...
module soul_expected.ast.cpp;

namespace soul_expected::ast::cpp {
...
Node::Node(NodeKind kind_, const soul_expected::ast::SourcePos& sourcePos_) : kind(kind_), sourcePos(sourcePos_), parent(nullptr)
{
}
...
UnaryNode::UnaryNode(NodeKind kind_, const soul_expected::ast::SourcePos& sourcePos_, Node* child_) : Node(kind_, sourcePos_), child(child_)
{
...
BinaryNode::BinaryNode(NodeKind kind_, const soul_expected::ast::SourcePos& sourcePos_, Node* left_, Node* right_) : Node(kind_, sourcePos_), left(left_), right(right_)
{
    left->SetParent(this);
...
ExprListNode::ExprListNode(const soul_expected::ast::SourcePos& sourcePos_) : Node(NodeKind::exprListNode, sourcePos_)
{
}
...
ThisNode::ThisNode(const soul_expected::ast::SourcePos& sourcePos_) : Node(NodeKind::thisNode, sourcePos_)
{
}
...
IdExprNode::IdExprNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& id_) : Node(NodeKind::idExprNode, sourcePos_), id(id_)
{
}
...
IndexExprNode::IndexExprNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_, Node* index_) : UnaryNode(NodeKind::indexExprNode, sourcePos_, child_), index(index_)
{
...
InvokeNode::InvokeNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_) : UnaryNode(NodeKind::invokeNode, sourcePos_, child_)
{
}
...
MemberAccessNode::MemberAccessNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_, Node* member_) : UnaryNode(NodeKind::memberAccessNode, sourcePos_, child_), member(member_)
{
...
PtrMemberAccessNode::PtrMemberAccessNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_, Node* member_) :
...
PostIncrementNode::PostIncrementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_) : UnaryNode(NodeKind::postIncrementNode, sourcePos_, child_)
{
}
...
PostDecrementNode::PostDecrementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_) : UnaryNode(NodeKind::postDecrementNode, sourcePos_, child_)
{
}
...
CppCastNode::CppCastNode(NodeKind kind_, const soul_expected::ast::SourcePos& sourcePos_) : Node(kind_, sourcePos_)
{
}

StaticCastNode::StaticCastNode(const soul_expected::ast::SourcePos& sourcePos_) : CppCastNode(NodeKind::staticCastNode, sourcePos_)
{
}
...
DynamicCastNode::DynamicCastNode(const soul_expected::ast::SourcePos& sourcePos_) : CppCastNode(NodeKind::dynamicCastNode, sourcePos_)
{
}
...
ReinterpretCastNode::ReinterpretCastNode(const soul_expected::ast::SourcePos& sourcePos_) : CppCastNode(NodeKind::reinterpretCastNode, sourcePos_)
{
}
...
ConstCastNode::ConstCastNode(const soul_expected::ast::SourcePos& sourcePos_) : CppCastNode(NodeKind::constCastNode, sourcePos_)
{
}
...
PostCastNode::PostCastNode(const soul_expected::ast::SourcePos& sourcePos_, CppCastNode* cppCastNode_, Node* type_, Node* child_) :
...
TypeIdExprNode::TypeIdExprNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_) : UnaryNode(NodeKind::typeIdExprNode, sourcePos_, child_)
{
}
...
PreIncrementNode::PreIncrementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_) : UnaryNode(NodeKind::preIncrementNode, sourcePos_, child_)
{
}
...
PreDecrementNode::PreDecrementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_) : UnaryNode(NodeKind::preDecrementNode, sourcePos_, child_)
{
}
...
UnaryOpExprNode::UnaryOpExprNode(const soul_expected::ast::SourcePos& sourcePos_, Operator op_, Node* child_) : UnaryNode(NodeKind::unaryOpExprNode, sourcePos_, child_), op(op_)
{
}
...
SizeOfNode::SizeOfNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_, bool parens_) : UnaryNode(NodeKind::sizeOfNode, sourcePos_, child_), parens(parens_)
{
}
...
CastNode::CastNode(const soul_expected::ast::SourcePos& sourcePos_, Node* type_, Node* child_) : UnaryNode(NodeKind::castNode, sourcePos_, child_), type(type_)
{
    type->SetParent(this);
}
...
BinaryOpExprNode::BinaryOpExprNode(const soul_expected::ast::SourcePos& sourcePos_, Operator op_, Node* left_, Node* right_) :
...
ConditionalNode::ConditionalNode(const soul_expected::ast::SourcePos& sourcePos_, Node* condition_, Node* thenExpr_, Node* elseExpr_) :
...
NewNode::NewNode(const soul_expected::ast::SourcePos& sourcePos_, bool global_) : Node(NodeKind::newNode, sourcePos_), global(global_), parens(false), addToPlacement(false), addToInitializer(false)
{
}
...
DeleteNode::DeleteNode(const soul_expected::ast::SourcePos& sourcePos_, bool global_, bool isArray_, Node* child_) :
...
ParenExprNode::ParenExprNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_) : UnaryNode(NodeKind::parenExprNode, sourcePos_, child_)
{
}
...
LiteralNode::LiteralNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& rep_) : Node(NodeKind::literalNode, sourcePos_), rep(rep_)
{
}
...
StatementNode::StatementNode(NodeKind kind_, const soul_expected::ast::SourcePos& sourcePos_) : Node(kind_, sourcePos_)
{
}

LabeledStatementNode::LabeledStatementNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& label_, StatementNode* stmt_) :
...
CaseStatementNode::CaseStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* caseExpr_, StatementNode* stmt_) :
...
DefaultStatementNode::DefaultStatementNode(const soul_expected::ast::SourcePos& sourcePos_, StatementNode* stmt_) : StatementNode(NodeKind::defaultStatementNode, sourcePos_), stmt(stmt_)
{
    stmt->SetParent(this);
}
...
EmptyStatementNode::EmptyStatementNode(const soul_expected::ast::SourcePos& sourcePos_) : StatementNode(NodeKind::emptyStatementNode, sourcePos_)
{
}
...
ExpressionStatementNode::ExpressionStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* expr_) : StatementNode(NodeKind::expressionStatementNode, sourcePos_), expr(expr_)
{
    expr->SetParent(this);
}
...
CompoundStatementNode::CompoundStatementNode(const soul_expected::ast::SourcePos& sourcePos_) : StatementNode(NodeKind::compoundStatementNode, sourcePos_)
{
}
...
IfStatementNode::IfStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* cond_, StatementNode* thenStmt_, StatementNode* elseStmt_) :
...
SwitchStatementNode::SwitchStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* cond_, StatementNode* stmt_) :
...
WhileStatementNode::WhileStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* cond_, StatementNode* stmt_) :
...
DoStatementNode::DoStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* cond_, StatementNode* stmt_) :
...
ForStatementNode::ForStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* init_, Node* cond_, Node* iter_, StatementNode* stmt_) :
...
BreakStatementNode::BreakStatementNode(const soul_expected::ast::SourcePos& sourcePos_) : StatementNode(NodeKind::breakStatementNode, sourcePos_)
{
}
...
ContinueStatementNode::ContinueStatementNode(const soul_expected::ast::SourcePos& sourcePos_) : StatementNode(NodeKind::continueStatementNode, sourcePos_)
{
}
...
GotoStatementNode::GotoStatementNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& target_) : StatementNode(NodeKind::gotoStatementNode, sourcePos_), target(target_)
{
}
...
ReturnStatementNode::ReturnStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* expr_) : StatementNode(NodeKind::returnStatementNode, sourcePos_), expr(expr_)
{
    if (expr)
    {
        expr->SetParent(this);
...
ConditionWithDeclaratorNode::ConditionWithDeclaratorNode(const soul_expected::ast::SourcePos& sourcePos_, TypeIdNode* type_, const std::string& declarator_, Node* expression_) :
...
ForRangeDeclarationNode::ForRangeDeclarationNode(const soul_expected::ast::SourcePos& sourcePos_) :
...
RangeForStatementNode::RangeForStatementNode(const soul_expected::ast::SourcePos& sourcePos_, ForRangeDeclarationNode* declaration_, Node* container_, StatementNode* stmt_) :
...
DeclarationStatementNode::DeclarationStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* declaration_) :
...
IfdefStatementNode::IfdefStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* symbol_) : StatementNode(NodeKind::ifdefStatementNode, sourcePos_), symbol(symbol_)
{
...
EndIfStatementNode::EndIfStatementNode(const soul_expected::ast::SourcePos& sourcePos_) : StatementNode(NodeKind::endIfStatementNode, sourcePos_)
{
}
...
AssignInitNode::AssignInitNode(const soul_expected::ast::SourcePos& sourcePos_, Node* assignmentExpr_) : Node(NodeKind::assignInitNode, sourcePos_), assignmentExpr(assignmentExpr_)
{
    if (assignmentExpr)
    {
...
InitializerNode::InitializerNode(const soul_expected::ast::SourcePos& sourcePos_, AssignInitNode* assignInit_) : Node(NodeKind::initializerNode, sourcePos_), assignInit(assignInit_)
{
    if (assignInit)
    {
...
InitDeclaratorNode::InitDeclaratorNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& declarator_, InitializerNode* initializer_) :
...
InitDeclaratorListNode::InitDeclaratorListNode(const soul_expected::ast::SourcePos& sourcePos_) : Node(NodeKind::initDeclaratorListNode, sourcePos_)
{
}
...
DeclSpecifierNode::DeclSpecifierNode(NodeKind kind_, const soul_expected::ast::SourcePos& sourcePos_, const std::string& name_) : Node(kind_, sourcePos_), name(name_)
{
}
...
TypedefNode::TypedefNode(const soul_expected::ast::SourcePos& sourcePos_) : DeclSpecifierNode(NodeKind::typedefNode, sourcePos_, "typedef")
{
}
...
TypeSpecifierNode::TypeSpecifierNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& name_) :
    DeclSpecifierNode(NodeKind::typeSpecifierNode, sourcePos_, name_)
{
}

TypeSpecifierNode::TypeSpecifierNode(const soul_expected::ast::SourcePos& sourcePos_, NodeKind kind_, const std::string& name_) :
...
ConstNode::ConstNode(const soul_expected::ast::SourcePos& sourcePos_) : TypeSpecifierNode(sourcePos_, NodeKind::constNode, "const")
{
}
...
VolatileNode::VolatileNode(const soul_expected::ast::SourcePos& sourcePos_) : TypeSpecifierNode(sourcePos_, NodeKind::volatileNode, "volatile")
{
}
...
TypeNameNode::TypeNameNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& name_) :
...
TypeNode::TypeNode(const soul_expected::ast::SourcePos& sourcePos_) : Node(NodeKind::typeNode, sourcePos_)
{
}
...
StorageClassSpecifierNode::StorageClassSpecifierNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& name_) :
...
TypeIdNode::TypeIdNode(const soul_expected::ast::SourcePos& sourcePos_) : Node(NodeKind::typeIdNode, sourcePos_)
{
}
...
SimpleDeclarationNode::SimpleDeclarationNode(const soul_expected::ast::SourcePos& sourcePos_) : Node(NodeKind::simpleDeclarationNode, sourcePos_)
{
}
...
UsingObjectNode::UsingObjectNode(NodeKind kind_, const soul_expected::ast::SourcePos& sourcePos_, const std::string& name_) : Node(kind_, sourcePos_), name(name_)
{
}

NamespaceAliasNode::NamespaceAliasNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& aliasName_, const std::string& namespaceName_) :
...
UsingDeclarationNode::UsingDeclarationNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& usingId_) :
...
UsingDirectiveNode::UsingDirectiveNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& usingNs_) :
