...
export module soul_expected.ast.spg;
...
export namespace soul_expected::ast::spg {
...
{
public:
    ParamVar(const soul_expected::ast::SourcePos& sourcePos_, ParamVarKind kind_, soul_expected::ast::cpp::TypeIdNode* type_, const std::string& name_);
    virtual ~ParamVar();
    inline const soul_expected::ast::SourcePos& GetSourcePos() const { return sourcePos; }
    inline ParamVarKind Kind() const { return kind; }
    inline soul_expected::ast::cpp::TypeIdNode* Type() const { return type.get(); }
...
{
public:
    Parameter(const soul_expected::ast::SourcePos& sourcePos_, soul_expected::ast::cpp::TypeIdNode* type_, const std::string& name_);
...
{
public:
    Variable(const soul_expected::ast::SourcePos& sourcePos_, soul_expected::ast::cpp::TypeIdNode* type_, const std::string& name_);
    ParamVar* Clone() const override;
};
...
struct TokenIdLess
{
    inline bool operator()(const soul_expected::ast::common::Token* left, const soul_expected::ast::common::Token* right) const
    {
...
public:
    TokenSet();
    bool AddToken(const soul_expected::ast::common::Token* token);
    bool Merge(const TokenSet& that);
    bool Contains(const soul_expected::ast::common::Token* token) const;
    bool Intersects(const TokenSet& that) const;
    std::string ToString() const;
    inline const std::set<const soul_expected::ast::common::Token*, TokenIdLess>& Tokens() const { return tokens; }
private:
    std::set<const soul_expected::ast::common::Token*, TokenIdLess> tokens;
};
...
{
public:
    Parser(const soul_expected::ast::SourcePos& sourcePos_, ParserKind kind_);
    ...
    soul_expected::ast::common::TokenMap* GetTokenMap();
private:
    Parser* parent;
    soul_expected::ast::SourcePos sourcePos;
    ParserKind kind;
...
{
public:
    UnaryParser(const soul_expected::ast::SourcePos& sourcePos_, ParserKind kind_, Parser* child_);
...
{
public:
    BinaryParser(const soul_expected::ast::SourcePos& sourcePos_, ParserKind kind_, Parser* left_, Parser* right_);
...
{
public:
    ChoiceParser(const soul_expected::ast::SourcePos& sourcePos_, Parser* left_, Parser* right_);
    Parser* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::string Name() const override { return "choice"; }
    std::expected<bool, int> ComputeFirst(bool& changed, std::set<Parser*>& visited) override;
    std::expected<bool, int> SetOptimizationFlag(int& count);
...
{
public:
    CaseParser(const soul_expected::ast::SourcePos& sourcePos_, Parser* child_);
    Parser* Clone() const override;
    void Accept(Visitor& visitor) override;
...
{
public:
    SwitchParser(const soul_expected::ast::SourcePos& sourcePos_);
    Parser* Clone() const override;
    void Accept(Visitor& visitor) override;
...
{
public:
    SequenceParser(const soul_expected::ast::SourcePos& sourcePos_, Parser* left_, Parser* right_);
    Parser* Clone() const override;
    void Accept(Visitor& visitor) override;
...
{
public:
    DifferenceParser(const soul_expected::ast::SourcePos& sourcePos_, Parser* left_, Parser* right_);
    Parser* Clone() const override;
    void Accept(Visitor& visitor) override;
...
{
public:
    ListParser(const soul_expected::ast::SourcePos& sourcePos_, Parser* left_, Parser* right_);
    Parser* Clone() const override;
...
{
public:
    LookaheadParser(const soul_expected::ast::SourcePos& sourcePos_, Parser* child_);
    Parser* Clone() const override;
    void Accept(Visitor& visitor) override;
...
{
public:
    KleeneParser(const soul_expected::ast::SourcePos& sourcePos_, Parser* child_);
    Parser* Clone() const override;
    void Accept(Visitor& visitor) override;
...
{
public:
    PositiveParser(const soul_expected::ast::SourcePos& sourcePos_, Parser* child_);
    Parser* Clone() const override;
    void Accept(Visitor& visitor) override;
...
{
public:
    OptionalParser(const soul_expected::ast::SourcePos& sourcePos_, Parser* child_);
    Parser* Clone() const override;
    void Accept(Visitor& visitor) override;
...
{
public:
    ExpectationParser(const soul_expected::ast::SourcePos& sourcePos_, Parser* child_);
    Parser* Clone() const override;
    void Accept(Visitor& visitor) override;
...
{
public:
    ActionParser(const soul_expected::ast::SourcePos& sourcePos_, Parser* child_, 
        soul_expected::ast::cpp::CompoundStatementNode* successCode_, soul_expected::ast::cpp::CompoundStatementNode* failureCode_);
    inline soul_expected::ast::cpp::CompoundStatementNode* SuccessCode() const { return successCode.get(); }
    inline soul_expected::ast::cpp::CompoundStatementNode* FailureCode() const { return failureCode.get(); }
    Parser* Clone() const override;
    void Accept(Visitor& visitor) override;
...
{
public:
    NonterminalParser(const soul_expected::ast::SourcePos& sourcePos_, const std::string& ruleName_, const std::string& instanceName_, soul_expected::ast::cpp::ExprListNode* args_);
    inline const std::string& RuleName() const { return ruleName; }
    inline const std::string& InstanceName() const { return instanceName; }
    inline const std::unique_ptr<soul_expected::ast::cpp::ExprListNode>& Arguments() const { return arguments; }
...
private:
    ...
    std::unique_ptr<soul_expected::ast::cpp::ExprListNode> arguments;
    RuleParser* rule;
    bool recursive;
};
...
{
public:
    EmptyParser(const soul_expected::ast::SourcePos& sourcePos_);
    Parser* Clone() const override;
    void Accept(Visitor& visitor) override;
...
{
public:
    AnyParser(const soul_expected::ast::SourcePos& sourcePos_);
    Parser* Clone() const override;
    void Accept(Visitor& visitor) override;
...
{
public:
    TokenParser(const soul_expected::ast::SourcePos& sourcePos_, const std::string& tokenName_);
    Parser* Clone() const override;
    void Accept(Visitor& visitor) override;
    const std::string& TokenName() const { return tokenName; }
    std::string Name() const override { return "token"; }
    inline soul_expected::ast::common::Token* GetToken() const { return token; }
    inline void SetToken(soul_expected::ast::common::Token* token_) { token = token_; }
    std::expected<bool, int> ComputeFirst(bool& changed, std::set<Parser*>& visited) override;
private:
    std::string tokenName;
    soul_expected::ast::common::Token* token;
};

class CharParser : public Parser
{
public:
    CharParser(const soul_expected::ast::SourcePos& sourcePos_, char32_t chr_);
...
{
public:
    StringParser(const soul_expected::ast::SourcePos& sourcePos_, const std::u32string& str_);
...
{
public:
    CharSetParser(const soul_expected::ast::SourcePos& sourcePos_, CharSet* charSet_);
...
{
public:
    GroupParser(const soul_expected::ast::SourcePos& sourcePos_, Parser* child_);
    Parser* Clone() const override;
    void Accept(Visitor& visitor) override;
...
{
public:
    RuleParser(const soul_expected::ast::SourcePos& sourcePos_, const std::string& name_);
    ...
    void SetReturnType(soul_expected::ast::cpp::TypeIdNode* returnType_);
    inline soul_expected::ast::cpp::TypeIdNode* ReturnType() const { return returnType.get(); }
...
struct Using
{
    Using(const soul_expected::ast::SourcePos& sourcePos_, const std::string& parserRuleId_);
    soul_expected::ast::SourcePos sourcePos;
...
{
public:
    GrammarParser(const soul_expected::ast::SourcePos& sourcePos_, const std::string& name_);
    std::string Name() const override { return name; }
    ...
    void AddLexer(soul_expected::ast::cpp::TypeIdNode* lexerTypeId);
    inline const std::vector<std::unique_ptr<soul_expected::ast::cpp::TypeIdNode>>& Lexers() const { return lexers; }
    void AddUsing(const soul_expected::ast::SourcePos& sourcePos, const std::string& parserRuleId);
...
private:
    ...
    std::vector<std::unique_ptr<soul_expected::ast::cpp::TypeIdNode>> lexers;
...
{
public:
    SpgFileDeclaration(const soul_expected::ast::SourcePos& sourcePos_, soul_expected::ast::common::FileKind fileKind_, const std::string& filePath_);
    virtual ~SpgFileDeclaration();
    inline const soul_expected::ast::SourcePos& GetSourcePos() const { return sourcePos; }
    inline soul_expected::ast::common::FileKind GetFileKind() const { return fileKind; }
    inline const std::string& FilePath() const { return filePath; }
private:
    soul_expected::ast::SourcePos sourcePos;
    soul_expected::ast::common::FileKind fileKind;
    std::string filePath;
};
...
{
public:
    ParserFileDeclaration(const soul_expected::ast::SourcePos& sourcePos_, const std::string& filePath_, bool external_);
...
{
public:
    TokenFileDeclaration(const soul_expected::ast::SourcePos& sourcePos_, const std::string& filePath_, bool external_);
    inline bool External() const { return external; }
private:
    bool external;
};

class ParserFile : public soul_expected::ast::common::File
{
public:
    ParserFile(const std::string& filePath_);
    std::expected<bool, int> SetExportModule(soul_expected::ast::common::ExportModule* exportModule_);
    inline soul_expected::ast::common::ExportModule* ExportModule() const { return exportModule.get(); }
    void AddImport(soul_expected::ast::common::Import* imprt);
    inline const std::vector<std::unique_ptr<soul_expected::ast::common::Import>>& Imports() const { return imports; }
    void AddParser(soul_expected::ast::spg::GrammarParser* parser);
    inline const std::vector<std::unique_ptr<soul_expected::ast::spg::GrammarParser>>& Parsers() const { return parsers; }
    inline bool IsExternal() const { return external; }
    inline void SetExternal() { external = true; }
    void Accept(soul_expected::ast::common::Visitor& visitor) override;
    inline soul_expected::ast::common::TokenMap* GetTokenMap() { return &tokenMap; }
private:
    std::unique_ptr<soul_expected::ast::common::ExportModule> exportModule;
    std::vector<std::unique_ptr<soul_expected::ast::common::Import>> imports;
    std::vector<std::unique_ptr<soul_expected::ast::spg::GrammarParser>> parsers;
    bool external;
    soul_expected::ast::common::TokenMap tokenMap;
};

class SpgFile : public soul_expected::ast::common::File
{
public:
    ...
    void AddTokenFile(soul_expected::ast::common::TokenFile* tokenFile);
    inline const std::vector<std::unique_ptr<soul_expected::ast::common::TokenFile>>& TokenFiles() const { return tokenFiles; }
    ...
    soul_expected::ast::common::TokenCollection* GetTokenCollection(const std::string& tokenCollectionName) const;
    void Accept(soul_expected::ast::common::Visitor& visitor) override;
private:
    std::string projectName;
    std::vector<std::unique_ptr<SpgFileDeclaration>> declarations;
    std::vector<std::unique_ptr<ParserFile>> parserFiles;
    std::vector<std::unique_ptr<soul_expected::ast::common::TokenFile>> tokenFiles;
    std::map<std::string, GrammarParser*> parserMap;
    std::map<std::string, soul_expected::ast::common::TokenCollection*> tokenCollectionMap;
    std::vector<RuleParser*> rules;
};

class Visitor : public soul_expected::ast::common::Visitor
{
public:
