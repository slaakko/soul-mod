...
public:
    ...
    inline const std::vector<soul_expected::ast::re::Symbol*>& Symbols() const { return symbols; }
    Class* MakeClass();
    ...
    inline void SetCurrentExpression(soul_expected::ast::slg::Expression* currentExpression_) { currentExpression = currentExpression_; }
    ...
    inline soul_expected::ast::slg::Tokens* GetTokens() const { return tokens; }
    inline void SetTokens(soul_expected::ast::slg::Tokens* tokens_) { tokens = tokens_; }
    inline soul_expected::ast::slg::Keywords* GetKeywords() const { return keywords; }
    inline void SetKeywords(soul_expected::ast::slg::Keywords* keywords_) { keywords = keywords_; }
    inline soul_expected::ast::slg::Expressions* GetExpressions() const { return expressions; }
    inline void SetExpressions(soul_expected::ast::slg::Expressions* expressions_) { expressions = expressions_; }
    inline soul_expected::ast::slg::Lexer* GetLexer() const { return lexer; }
    inline void SetLexer(soul_expected::ast::slg::Lexer* lexer_) { lexer = lexer_; }
    int AddNfa(Nfa* nfa);
