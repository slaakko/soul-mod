...
export module soul_expected.ast.cpp;

import std;
import util_expected.code.formatter;
import soul_expected.ast.source.pos;

export namespace soul_expected::ast::cpp {
...
{
public:
    Node(NodeKind kind_, const soul_expected::ast::SourcePos& sourcePos_);
...
{
public:
    UnaryNode(NodeKind kind_, const soul_expected::ast::SourcePos& sourcePos_, Node* child_);
...
{
public:
    BinaryNode(NodeKind kind_, const soul_expected::ast::SourcePos& sourcePos_, Node* left_, Node* right_);
...
{
public:
    ExprListNode(const soul_expected::ast::SourcePos& sourcePos_);
    ...
    int Count() const { return static_cast<int>(exprs.size()); }
private:
...
{
public:
    ThisNode(const soul_expected::ast::SourcePos& sourcePos_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
...
{
public:
    IdExprNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& id_);
...
{
public:
    IndexExprNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_, Node* index_);
...
{
public:
    InvokeNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
    void Add(Node* node) override;
...
{
public:
    MemberAccessNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_, Node* member_);
...
{
public:
    PtrMemberAccessNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_, Node* member_);
    Node* Member() const { return member.get(); }
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
...
{
public:
    PostIncrementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
    std::string ToString() const override;
...
{
public:
    PostDecrementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
    std::string ToString() const override;
...
{
public:
    CppCastNode(NodeKind kind_, const soul_expected::ast::SourcePos& sourcePos_);
};

class StaticCastNode : public CppCastNode
{
public:
    StaticCastNode(const soul_expected::ast::SourcePos& sourcePos_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
...
{
public:
    DynamicCastNode(const soul_expected::ast::SourcePos& sourcePos_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
...
{
public:
    ReinterpretCastNode(const soul_expected::ast::SourcePos& sourcePos_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
...
{
public:
    ConstCastNode(const soul_expected::ast::SourcePos& sourcePos_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
...
{
public:
    PostCastNode(const soul_expected::ast::SourcePos& sourcePos_, CppCastNode* cppCastNode_, Node* type_, Node* child_);
...
{
public:
    TypeIdExprNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
    std::string ToString() const override;
...
{
public:
    PreIncrementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
    std::string ToString() const override;
...
{
public:
    PreDecrementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
    std::string ToString() const override;
...
{
public:
    UnaryOpExprNode(const soul_expected::ast::SourcePos& sourcePos_, Operator op_, Node* child_);
...
{
public:
    SizeOfNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_, bool parens_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
    std::string ToString() const override;
...
{
public:
    CastNode(const soul_expected::ast::SourcePos& sourcePos_, Node* type_, Node* child_);
    Node* Type() const { return type.get(); }
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
...
{
public:
    BinaryOpExprNode(const soul_expected::ast::SourcePos& sourcePos_, Operator op_, Node* left_, Node* right_);
    Operator Op() const { return op; }
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
...
{
public:
    ConditionalNode(const soul_expected::ast::SourcePos& sourcePos_, Node* condition_, Node* thenExpr_, Node* elseExpr_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
...
{
public:
    NewNode(const soul_expected::ast::SourcePos& sourcePos_, bool global_);
...
{
public:
    DeleteNode(const soul_expected::ast::SourcePos& sourcePos_, bool global_, bool isArray_, Node* child_);
    bool Global() const { return global; }
...
{
public:
    ParenExprNode(const soul_expected::ast::SourcePos& sourcePos_, Node* child_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
    std::string ToString() const override;
...
{
public:
    LiteralNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& rep_);
...
{
public:
    StatementNode(NodeKind kind_, const soul_expected::ast::SourcePos& sourcePos_);
...
{
public:
    LabeledStatementNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& label_, StatementNode* stmt_);
...
{
public:
    CaseStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* caseExpr_, StatementNode* stmt_);
...
{
public:
    DefaultStatementNode(const soul_expected::ast::SourcePos& sourcePos_, StatementNode* stmt_);
    StatementNode* Stmt() const { return stmt.get(); }
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
...
{
public:
    EmptyStatementNode(const soul_expected::ast::SourcePos& sourcePos_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
};
...
{
public:
    ExpressionStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* expr_);
...
{
public:
    CompoundStatementNode(const soul_expected::ast::SourcePos& sourcePos_);
...
{
public:
    IfStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* cond_, StatementNode* thenStmt_, StatementNode* elseStmt_);
...
{
public:
    SwitchStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* cond_, StatementNode* stmt_);
    Node* Cond() const { return cond.get(); }
    StatementNode* Stmt() const { return stmt.get(); }
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
...
{
public:
    WhileStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* cond_, StatementNode* stmt_);
    Node* Cond() const { return cond.get(); }
    StatementNode* Stmt() const { return stmt.get(); }
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
...
{
public:
    DoStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* cond_, StatementNode* stmt_);
    Node* Cond() const { return cond.get(); }
    StatementNode* Stmt() const { return stmt.get(); }
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
...
{
public:
    ForStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* init_, Node* cond_, Node* iter_, StatementNode* stmt_);
...
{
public:
    BreakStatementNode(const soul_expected::ast::SourcePos& sourcePos_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
};
...
{
public:
    ContinueStatementNode(const soul_expected::ast::SourcePos& sourcePos_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
};
...
{
public:
    GotoStatementNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& target_);
...
{
public:
    ReturnStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* expr_);
    Node* Expr() const { return expr.get(); }
...
{
public:
    ConditionWithDeclaratorNode(const soul_expected::ast::SourcePos& sourcePos_, TypeIdNode* type_, const std::string& declarator_, Node* expression_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
...
{
public:
    ForRangeDeclarationNode(const soul_expected::ast::SourcePos& sourcePos_);
...
{
public:
    RangeForStatementNode(const soul_expected::ast::SourcePos& sourcePos_, ForRangeDeclarationNode* declaration_, Node* container_, StatementNode* stmt_);
...
{
public:
    DeclarationStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* declaration_);
...
{
public:
    IfdefStatementNode(const soul_expected::ast::SourcePos& sourcePos_, Node* symbol_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
...
{
public:
    EndIfStatementNode(const soul_expected::ast::SourcePos& sourcePos_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
};
...
{
public:
    AssignInitNode(const soul_expected::ast::SourcePos& sourcePos_, Node* assignmentExpr_);
...
{
public:
    InitializerNode(const soul_expected::ast::SourcePos& sourcePos_, AssignInitNode* assignInit_);
...
{
public:
    InitDeclaratorNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& declarator_, InitializerNode* initializer_);
    const std::string& Declarator() const { return declarator; }
...
{
public:
    InitDeclaratorListNode(const soul_expected::ast::SourcePos& sourcePos_);
...
{
public:
    DeclSpecifierNode(NodeKind kind_, const soul_expected::ast::SourcePos& sourcePos_, const std::string& name_);
...
{
public:
    TypedefNode(const soul_expected::ast::SourcePos& sourcePos_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
    std::string ToString() const override;
...
{
public:
    TypeSpecifierNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& name_);
    TypeSpecifierNode(const soul_expected::ast::SourcePos& sourcePos_, NodeKind kind_, const std::string& name_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
...
{
public:
    ConstNode(const soul_expected::ast::SourcePos& sourcePos_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
};
...
{
public:
    VolatileNode(const soul_expected::ast::SourcePos& sourcePos_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
};
...
{
public:
    TypeNameNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& name_);
...
{
public:
    TypeNode(const soul_expected::ast::SourcePos& sourcePos_);
...
{
public:
    StorageClassSpecifierNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& name_);
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
    std::string ToString() const override;
...
{
public:
    TypeIdNode(const soul_expected::ast::SourcePos& sourcePos_);
    void Add(TypeSpecifierNode* typeSpecifier);
    const std::vector<std::unique_ptr<TypeSpecifierNode>>& TypeSpecifiers() const { return typeSpecifiers; }
    const std::string& Declarator() const { return declarator; }
    void SetDeclarator(const std::string& declarator_);
...
{
public:
    SimpleDeclarationNode(const soul_expected::ast::SourcePos& sourcePos_);
...
{
public:
    UsingObjectNode(NodeKind kind_, const soul_expected::ast::SourcePos& sourcePos_, const std::string& name_);
    const std::string& Name() const { return name; }
private:
    std::string name;
};
...
{
public:
    NamespaceAliasNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& aliasName_, const std::string& namespaceName_);
    std::expected<bool, int> Write(CodeFormatter& formatter) override;
    Node* Clone() const override;
    void Accept(Visitor& visitor) override;
private:
...
{
public:
    UsingDeclarationNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& usingId_);
...
{
public:
    UsingDirectiveNode(const soul_expected::ast::SourcePos& sourcePos_, const std::string& usingNs_);
