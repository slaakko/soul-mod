...
soul_expected::lexer::KeywordMap<char>* GetKeywords<char>()
{
    static const soul_expected::lexer::Keyword<char> keywords[] = {
         ...
         { "keywords", soul_expected::tool::token::KEYWORDS },
         { "expressions", soul_expected::tool::token::EXPRESSIONS },
         { "rules", soul_expected::tool::token::RULES },
         { "variables", soul_expected::tool::token::VARIABLES },
         { "actions", soul_expected::tool::token::ACTIONS },
...
soul_expected::lexer::KeywordMap<char8_t>* GetKeywords<char8_t>()
{
    static const soul_expected::lexer::Keyword<char8_t> keywords[] = {
         ...
         { u8"keywords", soul_expected::tool::token::KEYWORDS },
         { u8"expressions", soul_expected::tool::token::EXPRESSIONS },
         { u8"rules", soul_expected::tool::token::RULES },
         { u8"variables", soul_expected::tool::token::VARIABLES },
         { u8"actions", soul_expected::tool::token::ACTIONS },
...
soul_expected::lexer::KeywordMap<char16_t>* GetKeywords<char16_t>()
{
    static const soul_expected::lexer::Keyword<char16_t> keywords[] = {
         ...
         { u"keywords", soul_expected::tool::token::KEYWORDS },
         { u"expressions", soul_expected::tool::token::EXPRESSIONS },
         { u"rules", soul_expected::tool::token::RULES },
         { u"variables", soul_expected::tool::token::VARIABLES },
         { u"actions", soul_expected::tool::token::ACTIONS },
