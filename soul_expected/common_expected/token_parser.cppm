...
export module soul_expected.common.token.parser;
...
export namespace soul_expected::common::token::parser {

template<typename CharT>
std::expected<CharT, int> ParseCharLiteral(const std::string& fileName, const soul_expected::lexer::Token<CharT, soul_expected::lexer::LexerBase<CharT>>* token)
{
...
std::expected<std::basic_string<CharT>, int> ParseStringLiteral(const std::string& fileName,
    const soul_expected::lexer::Token<CharT, soul_expected::lexer::LexerBase<CharT>>* token)
{
...
template<typename CharT>
std::expected<std::string, int> MakeExprStringValue(const std::string& fileName, const soul_expected::lexer::Token<CharT, soul_expected::lexer::LexerBase<CharT>>* token)
{
...
template<typename CharT>
std::expected<std::string, int> MakeFilePath(const std::string& fileName, const soul_expected::lexer::Token<CharT, soul_expected::lexer::LexerBase<CharT>>* token)
{
    std::basic_string<CharT> strValue;
    const CharT* p = token->match.begin;
    const CharT* e = token->match.end;
...
} // namespace soul_expected::common::token::parser
