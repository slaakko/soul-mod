...
// this file has been automatically generated from 'D:/work/soul-mod/soul_expected/common_expected/token_file.parser' using soul parser generator espg version 5.0.0

module soul_expected.common.token.file.parser;
...
std::expected<soul_expected::parser::Match, int> TokenFileParser<LexerT>::Token(LexerT& lexer)
{
    ...
    #endif
    soul_expected::lexer::RuleGuard<LexerT> ruleGuard(lexer, 3949151656200896514);
...
template struct TokenFileParser<soul_expected::lexer::Lexer<soul_expected::lex::spg::SpgLexer<char32_t>, char32_t>>;
