...
using namespace soul_expected::cpp::literal::parser;
...
std::expected<soul_expected::parser::Match, int> ExpressionParser<LexerT>::AssignmentExpression(LexerT& lexer, soul_expected::ast::cpp::Context* context)
{
    ...
    soul_expected::parser::Match* parentMatch0 = &match;
    {
        ...
        soul_expected::parser::Match* parentMatch1 = &match;
        {
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::LogicalOrExpression(lexer, context);
                if (!m) return std::unexpected<int>(m.error());
                soul_expected::parser::Match match = *m;
                left.reset(static_cast<soul_expected::ast::cpp::Node*>(match.value));
                *parentMatch2 = match;
            ...
            if (match.hit)
            {
                ...
                soul_expected::parser::Match* parentMatch3 = &match;
                {
                    std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::AssignmentOp(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul_expected::parser::Match match = *m;
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::ConditionalExpression(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul_expected::parser::Match match = *m;
    ...
    soul_expected::parser::Match* parentMatch0 = &match;
    {
        ...
        soul_expected::parser::Match* parentMatch1 = &match;
        {
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::LogicalAndExpression(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul_expected::parser::Match match = *m;
                    left.reset(static_cast<soul_expected::ast::cpp::Node*>(match.value));
                    if (match.hit)
    ...
    soul_expected::parser::Match* parentMatch0 = &match;
    {
        ...
        soul_expected::parser::Match* parentMatch1 = &match;
        {
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::InclusiveOrExpression(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul_expected::parser::Match match = *m;
                    left.reset(static_cast<soul_expected::ast::cpp::Node*>(match.value));
                    if (match.hit)
    ...
    soul_expected::parser::Match* parentMatch0 = &match;
    {
        ...
        soul_expected::parser::Match* parentMatch1 = &match;
        {
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::ExclusiveOrExpression(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul_expected::parser::Match match = *m;
                    left.reset(static_cast<soul_expected::ast::cpp::Node*>(match.value));
                    if (match.hit)
    ...
    soul_expected::parser::Match* parentMatch0 = &match;
    {
        ...
        soul_expected::parser::Match* parentMatch1 = &match;
        {
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::AndExpression(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul_expected::parser::Match match = *m;
                    left.reset(static_cast<soul_expected::ast::cpp::Node*>(match.value));
                    if (match.hit)
    ...
    soul_expected::parser::Match* parentMatch0 = &match;
    {
        ...
        soul_expected::parser::Match* parentMatch1 = &match;
        {
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::EqualityExpression(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul_expected::parser::Match match = *m;
                    left.reset(static_cast<soul_expected::ast::cpp::Node*>(match.value));
                    if (match.hit)
    ...
    soul_expected::parser::Match* parentMatch0 = &match;
    {
        ...
        soul_expected::parser::Match* parentMatch1 = &match;
        {
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::RelationalExpression(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul_expected::parser::Match match = *m;
                    left.reset(static_cast<soul_expected::ast::cpp::Node*>(match.value));
                    if (match.hit)
                        ...
                        while (true)
                        {
                            std::int64_t save = lexer.GetPos();
                            {
                                ...
                                soul_expected::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soul_expected::parser::Match* parentMatch7 = &match;
                                    {
                                        std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::EqOp(lexer, context);
                                        if (!m) return std::unexpected<int>(m.error());
                                        soul_expected::parser::Match match = *m;
                                        op.reset(static_cast<soul_expected::parser::Value<soul_expected::ast::cpp::Operator>*>(match.value));
                                        *parentMatch7 = match;
    ...
    soul_expected::parser::Match* parentMatch0 = &match;
    {
        ...
        soul_expected::parser::Match* parentMatch1 = &match;
        {
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::ShiftExpression(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul_expected::parser::Match match = *m;
                    left.reset(static_cast<soul_expected::ast::cpp::Node*>(match.value));
                    if (match.hit)
                        ...
                        while (true)
                        {
                            std::int64_t save = lexer.GetPos();
                            {
                                ...
                                soul_expected::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soul_expected::parser::Match* parentMatch7 = &match;
                                    {
                                        std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::RelOp(lexer, context);
                                        if (!m) return std::unexpected<int>(m.error());
                                        soul_expected::parser::Match match = *m;
                                        op.reset(static_cast<soul_expected::parser::Value<soul_expected::ast::cpp::Operator>*>(match.value));
                                        *parentMatch7 = match;
    ...
    soul_expected::parser::Match* parentMatch0 = &match;
    {
        ...
        soul_expected::parser::Match* parentMatch1 = &match;
        {
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::AdditiveExpression(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul_expected::parser::Match match = *m;
                    left.reset(static_cast<soul_expected::ast::cpp::Node*>(match.value));
                    if (match.hit)
                        ...
                        while (true)
                        {
                            std::int64_t save = lexer.GetPos();
                            {
                                ...
                                soul_expected::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soul_expected::parser::Match* parentMatch7 = &match;
                                    {
                                        std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::ShiftOp(lexer, context);
                                        if (!m) return std::unexpected<int>(m.error());
                                        soul_expected::parser::Match match = *m;
                                        op.reset(static_cast<soul_expected::parser::Value<soul_expected::ast::cpp::Operator>*>(match.value));
                                        *parentMatch7 = match;
    ...
    soul_expected::parser::Match* parentMatch0 = &match;
    {
        ...
        soul_expected::parser::Match* parentMatch1 = &match;
        {
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::MultiplicativeExpression(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul_expected::parser::Match match = *m;
                    left.reset(static_cast<soul_expected::ast::cpp::Node*>(match.value));
                    if (match.hit)
                        ...
                        while (true)
                        {
                            std::int64_t save = lexer.GetPos();
                            {
                                ...
                                soul_expected::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soul_expected::parser::Match* parentMatch7 = &match;
                                    {
                                        std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::AddOp(lexer, context);
                                        if (!m) return std::unexpected<int>(m.error());
                                        soul_expected::parser::Match match = *m;
                                        op.reset(static_cast<soul_expected::parser::Value<soul_expected::ast::cpp::Operator>*>(match.value));
                                        *parentMatch7 = match;
    ...
    soul_expected::parser::Match* parentMatch0 = &match;
    {
        ...
        soul_expected::parser::Match* parentMatch1 = &match;
        {
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::PmExpression(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul_expected::parser::Match match = *m;
                    left.reset(static_cast<soul_expected::ast::cpp::Node*>(match.value));
                    if (match.hit)
                        ...
                        while (true)
                        {
                            std::int64_t save = lexer.GetPos();
                            {
                                ...
                                soul_expected::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soul_expected::parser::Match* parentMatch7 = &match;
                                    {
                                        std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::MulOp(lexer, context);
                                        if (!m) return std::unexpected<int>(m.error());
                                        soul_expected::parser::Match match = *m;
                                        op.reset(static_cast<soul_expected::parser::Value<soul_expected::ast::cpp::Operator>*>(match.value));
                                        *parentMatch7 = match;
    ...
    soul_expected::parser::Match* parentMatch0 = &match;
    {
        ...
        soul_expected::parser::Match* parentMatch1 = &match;
        {
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::CastExpression(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul_expected::parser::Match match = *m;
                    left.reset(static_cast<soul_expected::ast::cpp::Node*>(match.value));
                    if (match.hit)
                        ...
                        while (true)
                        {
                            std::int64_t save = lexer.GetPos();
                            {
                                ...
                                soul_expected::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soul_expected::parser::Match* parentMatch7 = &match;
                                    {
                                        std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::PmOp(lexer, context);
                                        if (!m) return std::unexpected<int>(m.error());
                                        soul_expected::parser::Match match = *m;
                                        op.reset(static_cast<soul_expected::parser::Value<soul_expected::ast::cpp::Operator>*>(match.value));
                                        *parentMatch7 = match;
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        {
                            std::int64_t pos = lexer.GetPos();
                            std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::UnaryExpression(lexer, context);
                            if (!m) return std::unexpected<int>(m.error());
                            soul_expected::parser::Match match = *m;
                                ...
                                soul_expected::parser::Match* parentMatch7 = &match;
                                {
                                    ...
                                    soul_expected::parser::Match* parentMatch8 = &match;
                                    {
                                        ...
                                        soul_expected::parser::Match* parentMatch9 = &match;
                                        {
                                            ...
                                            {
                                                std::int64_t pos = lexer.GetPos();
                                                std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::PostfixExpression(lexer, context);
                                                if (!m) return std::unexpected<int>(m.error());
                                                soul_expected::parser::Match match = *m;
                                            ...
                                            *parentMatch9 = match;
                                            if (!match.hit)
                                            {
                                                ...
                                                lexer.SetPos(save);
                                                {
                                                    ...
                                                    {
                                                        std::int64_t pos = lexer.GetPos();
                                                        std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::PostCastExpression(lexer, context);
                                                        if (!m) return std::unexpected<int>(m.error());
                                                        soul_expected::parser::Match match = *m;
                                ...
                                *parentMatch6 = match;
                                if (!match.hit)
                                {
                                    ...
                                    lexer.SetPos(save);
                                    {
                                        ...
                                        soul_expected::parser::Match* parentMatch22 = &match;
                                        {
                                            std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::UnaryOperator(lexer, context);
                                            if (!m) return std::unexpected<int>(m.error());
                                            soul_expected::parser::Match match = *m;
                                            op.reset(static_cast<soul_expected::parser::Value<soul_expected::ast::cpp::Operator>*>(match.value));
                                            *parentMatch22 = match;
                    ...
                    *parentMatch3 = match;
                    if (!match.hit)
                    {
                        ...
                        lexer.SetPos(save);
                        {
                            ...
                            {
                                std::int64_t pos = lexer.GetPos();
                                std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::NewExpression(lexer, context);
                                if (!m) return std::unexpected<int>(m.error());
                                soul_expected::parser::Match match = *m;
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        {
                            std::int64_t pos = lexer.GetPos();
                            std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::DeleteExpression(lexer, context);
                            if (!m) return std::unexpected<int>(m.error());
                            soul_expected::parser::Match match = *m;
    ...
    soul_expected::parser::Match* parentMatch0 = &match;
    {
        ...
        soul_expected::parser::Match* parentMatch1 = &match;
        {
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::PrimaryExpression(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul_expected::parser::Match match = *m;
                                                                ...
                                                                soul_expected::parser::Match* parentMatch18 = &match;
                                                                {
                                                                    ...
                                                                    if (match.hit)
                                                                    {
                                                                        ...
                                                                        soul_expected::parser::Match* parentMatch21 = &match;
                                                                        {
                                                                            ...
                                                                            soul_expected::parser::Match* parentMatch22 = &match;
                                                                            {
                                                                                std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::ExpressionList(lexer, context, expr.get());
                                                                                if (!m) return std::unexpected<int>(m.error());
                                                                                soul_expected::parser::Match match = *m;
                                                                                if (match.hit)
                                                                                {
    ...
    soul_expected::parser::Match* parentMatch0 = &match;
    {
        ...
        soul_expected::parser::Match* parentMatch1 = &match;
        {
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    std::int64_t pos = lexer.GetPos();
                    std::expected<soul_expected::parser::Match, int> m = LiteralParser<LexerT>::Literal(lexer, context);
                    if (!m) return std::unexpected<int>(m.error());
                    soul_expected::parser::Match match = *m;
                        ...
                        lexer.SetPos(save);
                        {
                            ...
                            if (match.hit)
                            {
                                ...
                                soul_expected::parser::Match* parentMatch10 = &match;
                                {
                                    ...
                                    {
                                        std::int64_t pos = lexer.GetPos();
                                        std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::OperatorFunctionId(lexer, context);
                                        if (!m) return std::unexpected<int>(m.error());
                                        soul_expected::parser::Match match = *m;
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                            ...
                            soul_expected::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    ...
                                    soul_expected::parser::Match* parentMatch17 = &match;
                                    {
                                        ...
                                        soul_expected::parser::Match* parentMatch18 = &match;
                                        {
                                            std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::NewPlacement(lexer, context, newExprNode.get());
                                            if (!m) return std::unexpected<int>(m.error());
                                            soul_expected::parser::Match match = *m;
                                            if (match.hit)
                                            {
                            ...
                            soul_expected::parser::Match* parentMatch21 = &match;
                            {
                                ...
                                soul_expected::parser::Match* parentMatch22 = &match;
                                {
                                    ...
                                    soul_expected::parser::Match* parentMatch23 = &match;
                                    {
                                        ...
                                        {
                                            std::int64_t pos = lexer.GetPos();
                                            std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::NewTypeId(lexer, context);
                                            if (!m) return std::unexpected<int>(m.error());
                                            soul_expected::parser::Match match = *m;
                ...
                if (match.hit)
                {
                    ...
                    soul_expected::parser::Match* parentMatch33 = &match;
                    {
                        ...
                        soul_expected::parser::Match* parentMatch34 = &match;
                        {
                            std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::NewInitializer(lexer, context, newExprNode.get());
                            if (!m) return std::unexpected<int>(m.error());
                            soul_expected::parser::Match match = *m;
                            if (match.hit)
                            {
...
std::expected<soul_expected::parser::Match, int> ExpressionParser<LexerT>::NewPlacement(LexerT& lexer, soul_expected::ast::cpp::Context* context, soul_expected::ast::cpp::Node* owner)
{
    ...
    soul_expected::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::ExpressionList(lexer, context, owner);
                if (!m) return std::unexpected<int>(m.error());
                soul_expected::parser::Match match = *m;
                *parentMatch2 = match;
            }
                ...
                soul_expected::parser::Match* parentMatch4 = &match;
                {
                    ...
                    soul_expected::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soul_expected::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            {
                                std::int64_t save = lexer.GetPos();
                                std::expected<soul_expected::parser::Match, int> m = DeclaratorParser<LexerT>::TypeSpecifierSeq(lexer, context, ti.get());
                                if (!m) return std::unexpected<int>(m.error());
                                soul_expected::parser::Match match = *m;
                                *parentMatch7 = match;
                                if (!match.hit)
                        ...
                        soul_expected::parser::Match* parentMatch10 = &match;
                        {
                            ...
                            soul_expected::parser::Match* parentMatch11 = &match;
                            {
                                ...
                                soul_expected::parser::Match* parentMatch12 = &match;
                                {
                                    ...
                                    {
                                        std::int64_t pos = lexer.GetPos();
                                        std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::NewDeclarator(lexer, context);
                                        if (!m) return std::unexpected<int>(m.error());
                                        soul_expected::parser::Match match = *m;
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        {
                            std::int64_t pos = lexer.GetPos();
                            std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::DirectNewDeclarator(lexer, context);
                            if (!m) return std::unexpected<int>(m.error());
                            soul_expected::parser::Match match = *m;
        ...
        soul_expected::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                ...
                soul_expected::parser::Match* parentMatch4 = &match;
                {
                    ...
                    {
                        std::int64_t pos = lexer.GetPos();
                        std::expected<soul_expected::parser::Match, int> m = ExpressionParser<LexerT>::Operator(lexer, context);
                        if (!m) return std::unexpected<int>(m.error());
                        soul_expected::parser::Match match = *m;
        ...
        soul_expected::parser::Match* parentMatch1 = &match;
        {
            ...
            soul_expected::parser::Match* parentMatch2 = &match;
            {
                ...
                soul_expected::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soul_expected::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        soul_expected::parser::Match* parentMatch5 = &match;
                        {
                            ...
                            soul_expected::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                soul_expected::parser::Match* parentMatch7 = &match;
                                {
                                    ...
                                    soul_expected::parser::Match* parentMatch8 = &match;
                                    {
                                        ...
                                        soul_expected::parser::Match* parentMatch9 = &match;
                                        {
                                            ...
                                            soul_expected::parser::Match* parentMatch10 = &match;
                                            {
                                                ...
                                                soul_expected::parser::Match* parentMatch11 = &match;
                                                {
                                                    ...
                                                    soul_expected::parser::Match* parentMatch12 = &match;
                                                    {
                                                        ...
                                                        soul_expected::parser::Match* parentMatch13 = &match;
                                                        {
                                                            ...
                                                            soul_expected::parser::Match* parentMatch14 = &match;
                                                            {
                                                                ...
                                                                soul_expected::parser::Match* parentMatch15 = &match;
                                                                {
                                                                    ...
                                                                    soul_expected::parser::Match* parentMatch16 = &match;
                                                                    {
                                                                        ...
                                                                        soul_expected::parser::Match* parentMatch17 = &match;
                                                                        {
                                                                            ...
                                                                            soul_expected::parser::Match* parentMatch18 = &match;
                                                                            {
                                                                                ...
                                                                                soul_expected::parser::Match* parentMatch19 = &match;
                                                                                {
                                                                                    ...
                                                                                    soul_expected::parser::Match* parentMatch20 = &match;
                                                                                    {
                                                                                        ...
                                                                                        soul_expected::parser::Match* parentMatch21 = &match;
                                                                                        {
                                                                                            ...
                                                                                            soul_expected::parser::Match* parentMatch22 = &match;
                                                                                            {
                                                                                                ...
                                                                                                soul_expected::parser::Match* parentMatch23 = &match;
                                                                                                {
                                                                                                    ...
                                                                                                    soul_expected::parser::Match* parentMatch24 = &match;
                                                                                                    {
                                                                                                        ...
                                                                                                        soul_expected::parser::Match* parentMatch25 = &match;
                                                                                                        {
                                                                                                            ...
                                                                                                            soul_expected::parser::Match* parentMatch26 = &match;
                                                                                                            {
                                                                                                                ...
                                                                                                                soul_expected::parser::Match* parentMatch27 = &match;
                                                                                                                {
                                                                                                                    ...
                                                                                                                    soul_expected::parser::Match* parentMatch28 = &match;
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        soul_expected::parser::Match* parentMatch29 = &match;
                                                                                                                        {
                                                                                                                            ...
                                                                                                                            soul_expected::parser::Match* parentMatch30 = &match;
                                                                                                                            {
                                                                                                                                ...
                                                                                                                                soul_expected::parser::Match* parentMatch31 = &match;
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    soul_expected::parser::Match* parentMatch32 = &match;
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        soul_expected::parser::Match* parentMatch33 = &match;
                                                                                                                                        {
                                                                                                                                            ...
                                                                                                                                            soul_expected::parser::Match* parentMatch34 = &match;
                                                                                                                                            {
                                                                                                                                                ...
                                                                                                                                                soul_expected::parser::Match* parentMatch35 = &match;
                                                                                                                                                {
                                                                                                                                                    ...
                                                                                                                                                    *parentMatch35 = match;
                                                                                                                                                    if (!match.hit)
                                                                                                                                                    {
                                                                                                                                                        ...
                                                                                                                                                        {
                                                                                                                                                            soul_expected::parser::Match match(false);
                                                                                                                                                            soul_expected::parser::Match* parentMatch60 = &match;
                                                                                                                                                            {
                                                                                                                                                                std::int64_t pos = lexer.GetPos();
                                                                                                                                                                soul_expected::parser::Match match(false);
                                                                                                                                                                if (*lexer == DISJUNCTION)
                                                                                                                                                ...
                                                                                                                                                *parentMatch34 = match;
                                                                                                                                                ...
                                                                                                                                                {
                                                                                                                                                    soul_expected::parser::Match match(false);
                                                                                                                                                    soul_expected::parser::Match* parentMatch61 = &match;
                                                                                                                                                    lexer.SetPos(save);
                                                                                                                                                    {
                                                                                                                                                        soul_expected::parser::Match match(false);
                                                                                                                                                        soul_expected::parser::Match* parentMatch62 = &match;
                                                                                                                                                        {
                                                                                                                                                            std::int64_t pos = lexer.GetPos();
                                                                                                                                                            soul_expected::parser::Match match(false);
                                                                                                                                                            if (*lexer == AMP_AMP)
                                                                                                                                            ...
                                                                                                                                            *parentMatch33 = match;
                                                                                                                                            ...
                                                                                                                                            {
                                                                                                                                                soul_expected::parser::Match match(false);
                                                                                                                                                soul_expected::parser::Match* parentMatch63 = &match;
                                                                                                                                                lexer.SetPos(save);
                                                                                                                                                {
                                                                                                                                                    soul_expected::parser::Match match(false);
                                                                                                                                                    soul_expected::parser::Match* parentMatch64 = &match;
                                                                                                                                                    {
                                                                                                                                                        std::int64_t pos = lexer.GetPos();
                                                                                                                                                        soul_expected::parser::Match match(false);
                                                                                                                                                        if (*lexer == LEQ)
                                                                                                                                        ...
                                                                                                                                        *parentMatch32 = match;
                                                                                                                                        ...
                                                                                                                                        {
                                                                                                                                            soul_expected::parser::Match match(false);
                                                                                                                                            soul_expected::parser::Match* parentMatch65 = &match;
                                                                                                                                            lexer.SetPos(save);
                                                                                                                                            {
                                                                                                                                                soul_expected::parser::Match match(false);
                                                                                                                                                soul_expected::parser::Match* parentMatch66 = &match;
                                                                                                                                                {
                                                                                                                                                    std::int64_t pos = lexer.GetPos();
                                                                                                                                                    soul_expected::parser::Match match(false);
                                                                                                                                                    if (*lexer == GEQ)
                                                                                                                                    ...
                                                                                                                                    *parentMatch31 = match;
                                                                                                                                    ...
                                                                                                                                    {
                                                                                                                                        soul_expected::parser::Match match(false);
                                                                                                                                        soul_expected::parser::Match* parentMatch67 = &match;
                                                                                                                                        lexer.SetPos(save);
                                                                                                                                        {
                                                                                                                                            soul_expected::parser::Match match(false);
                                                                                                                                            soul_expected::parser::Match* parentMatch68 = &match;
                                                                                                                                            {
                                                                                                                                                std::int64_t pos = lexer.GetPos();
                                                                                                                                                soul_expected::parser::Match match(false);
                                                                                                                                                if (*lexer == NEQ)
                                                                                                                                ...
                                                                                                                                *parentMatch30 = match;
                                                                                                                                ...
                                                                                                                                {
                                                                                                                                    soul_expected::parser::Match match(false);
                                                                                                                                    soul_expected::parser::Match* parentMatch69 = &match;
                                                                                                                                    lexer.SetPos(save);
                                                                                                                                    {
                                                                                                                                        soul_expected::parser::Match match(false);
                                                                                                                                        soul_expected::parser::Match* parentMatch70 = &match;
                                                                                                                                        {
                                                                                                                                            std::int64_t pos = lexer.GetPos();
                                                                                                                                            soul_expected::parser::Match match(false);
                                                                                                                                            if (*lexer == EQ)
                                                                                                                            ...
                                                                                                                            *parentMatch29 = match;
                                                                                                                            ...
                                                                                                                            {
                                                                                                                                soul_expected::parser::Match match(false);
                                                                                                                                soul_expected::parser::Match* parentMatch71 = &match;
                                                                                                                                lexer.SetPos(save);
                                                                                                                                {
                                                                                                                                    soul_expected::parser::Match match(false);
                                                                                                                                    soul_expected::parser::Match* parentMatch72 = &match;
                                                                                                                                    {
                                                                                                                                        std::int64_t pos = lexer.GetPos();
                                                                                                                                        soul_expected::parser::Match match(false);
                                                                                                                                        if (*lexer == SHIFT_LEFT_ASSIGN)
                                                                                                                        ...
                                                                                                                        *parentMatch28 = match;
                                                                                                                        ...
                                                                                                                        {
                                                                                                                            soul_expected::parser::Match match(false);
                                                                                                                            soul_expected::parser::Match* parentMatch73 = &match;
                                                                                                                            lexer.SetPos(save);
                                                                                                                            {
                                                                                                                                soul_expected::parser::Match match(false);
                                                                                                                                soul_expected::parser::Match* parentMatch74 = &match;
                                                                                                                                {
                                                                                                                                    std::int64_t pos = lexer.GetPos();
                                                                                                                                    soul_expected::parser::Match match(false);
                                                                                                                                    if (*lexer == SHIFT_RIGHT_ASSIGN)
                                                                                                                    ...
                                                                                                                    *parentMatch27 = match;
                                                                                                                    ...
                                                                                                                    {
                                                                                                                        soul_expected::parser::Match match(false);
                                                                                                                        soul_expected::parser::Match* parentMatch75 = &match;
                                                                                                                        lexer.SetPos(save);
                                                                                                                        {
                                                                                                                            soul_expected::parser::Match match(false);
                                                                                                                            soul_expected::parser::Match* parentMatch76 = &match;
                                                                                                                            {
                                                                                                                                std::int64_t pos = lexer.GetPos();
                                                                                                                                soul_expected::parser::Match match(false);
                                                                                                                                if (*lexer == SHIFT_LEFT)
                                                                                                                ...
                                                                                                                *parentMatch26 = match;
                                                                                                                ...
                                                                                                                {
                                                                                                                    soul_expected::parser::Match match(false);
                                                                                                                    soul_expected::parser::Match* parentMatch77 = &match;
                                                                                                                    lexer.SetPos(save);
                                                                                                                    {
                                                                                                                        soul_expected::parser::Match match(false);
                                                                                                                        soul_expected::parser::Match* parentMatch78 = &match;
                                                                                                                        {
                                                                                                                            std::int64_t pos = lexer.GetPos();
                                                                                                                            soul_expected::parser::Match match(false);
                                                                                                                            if (*lexer == SHIFT_RIGHT)
                                                                                                            ...
                                                                                                            *parentMatch25 = match;
                                                                                                            ...
                                                                                                            {
                                                                                                                soul_expected::parser::Match match(false);
                                                                                                                soul_expected::parser::Match* parentMatch79 = &match;
                                                                                                                lexer.SetPos(save);
                                                                                                                {
                                                                                                                    soul_expected::parser::Match match(false);
                                                                                                                    soul_expected::parser::Match* parentMatch80 = &match;
                                                                                                                    {
                                                                                                                        std::int64_t pos = lexer.GetPos();
                                                                                                                        soul_expected::parser::Match match(false);
                                                                                                                        if (*lexer == OR_ASSIGN)
                                                                                                        ...
                                                                                                        *parentMatch24 = match;
                                                                                                        ...
                                                                                                        {
                                                                                                            soul_expected::parser::Match match(false);
                                                                                                            soul_expected::parser::Match* parentMatch81 = &match;
                                                                                                            lexer.SetPos(save);
                                                                                                            {
                                                                                                                soul_expected::parser::Match match(false);
                                                                                                                soul_expected::parser::Match* parentMatch82 = &match;
                                                                                                                {
                                                                                                                    std::int64_t pos = lexer.GetPos();
                                                                                                                    soul_expected::parser::Match match(false);
                                                                                                                    if (*lexer == AND_ASSIGN)
                                                                                                    ...
                                                                                                    *parentMatch23 = match;
                                                                                                    ...
                                                                                                    {
                                                                                                        soul_expected::parser::Match match(false);
                                                                                                        soul_expected::parser::Match* parentMatch83 = &match;
                                                                                                        lexer.SetPos(save);
                                                                                                        {
                                                                                                            soul_expected::parser::Match match(false);
                                                                                                            soul_expected::parser::Match* parentMatch84 = &match;
                                                                                                            {
                                                                                                                std::int64_t pos = lexer.GetPos();
                                                                                                                soul_expected::parser::Match match(false);
                                                                                                                if (*lexer == XOR_ASSIGN)
                                                                                                ...
                                                                                                *parentMatch22 = match;
                                                                                                ...
                                                                                                {
                                                                                                    soul_expected::parser::Match match(false);
                                                                                                    soul_expected::parser::Match* parentMatch85 = &match;
                                                                                                    lexer.SetPos(save);
                                                                                                    {
                                                                                                        soul_expected::parser::Match match(false);
                                                                                                        soul_expected::parser::Match* parentMatch86 = &match;
                                                                                                        {
                                                                                                            std::int64_t pos = lexer.GetPos();
                                                                                                            soul_expected::parser::Match match(false);
                                                                                                            if (*lexer == REM_ASSIGN)
                                                                                            ...
                                                                                            *parentMatch21 = match;
                                                                                            ...
                                                                                            {
                                                                                                soul_expected::parser::Match match(false);
                                                                                                soul_expected::parser::Match* parentMatch87 = &match;
                                                                                                lexer.SetPos(save);
                                                                                                {
                                                                                                    soul_expected::parser::Match match(false);
                                                                                                    soul_expected::parser::Match* parentMatch88 = &match;
                                                                                                    {
                                                                                                        std::int64_t pos = lexer.GetPos();
                                                                                                        soul_expected::parser::Match match(false);
                                                                                                        if (*lexer == DIV_ASSIGN)
                                                                                        ...
                                                                                        *parentMatch20 = match;
                                                                                        ...
                                                                                        {
                                                                                            soul_expected::parser::Match match(false);
                                                                                            soul_expected::parser::Match* parentMatch89 = &match;
                                                                                            lexer.SetPos(save);
                                                                                            {
                                                                                                soul_expected::parser::Match match(false);
                                                                                                soul_expected::parser::Match* parentMatch90 = &match;
                                                                                                {
                                                                                                    std::int64_t pos = lexer.GetPos();
                                                                                                    soul_expected::parser::Match match(false);
                                                                                                    if (*lexer == MUL_ASSIGN)
                                                                                    ...
                                                                                    *parentMatch19 = match;
                                                                                    ...
                                                                                    {
                                                                                        soul_expected::parser::Match match(false);
                                                                                        soul_expected::parser::Match* parentMatch91 = &match;
                                                                                        lexer.SetPos(save);
                                                                                        {
                                                                                            soul_expected::parser::Match match(false);
                                                                                            soul_expected::parser::Match* parentMatch92 = &match;
                                                                                            {
                                                                                                std::int64_t pos = lexer.GetPos();
                                                                                                soul_expected::parser::Match match(false);
                                                                                                if (*lexer == MINUS_ASSIGN)
                                                                                ...
                                                                                *parentMatch18 = match;
                                                                                ...
                                                                                {
                                                                                    soul_expected::parser::Match match(false);
                                                                                    soul_expected::parser::Match* parentMatch93 = &match;
                                                                                    lexer.SetPos(save);
                                                                                    {
                                                                                        soul_expected::parser::Match match(false);
                                                                                        soul_expected::parser::Match* parentMatch94 = &match;
                                                                                        {
                                                                                            std::int64_t pos = lexer.GetPos();
                                                                                            soul_expected::parser::Match match(false);
                                                                                            if (*lexer == PLUS_ASSIGN)
                                                                            ...
                                                                            *parentMatch17 = match;
                                                                            ...
                                                                            {
                                                                                soul_expected::parser::Match match(false);
                                                                                soul_expected::parser::Match* parentMatch95 = &match;
                                                                                lexer.SetPos(save);
                                                                                {
                                                                                    soul_expected::parser::Match match(false);
                                                                                    soul_expected::parser::Match* parentMatch96 = &match;
                                                                                    {
                                                                                        std::int64_t pos = lexer.GetPos();
                                                                                        soul_expected::parser::Match match(false);
                                                                                        if (*lexer == LANGLE)
                                                                        ...
                                                                        *parentMatch16 = match;
                                                                        ...
                                                                        {
                                                                            soul_expected::parser::Match match(false);
                                                                            soul_expected::parser::Match* parentMatch97 = &match;
                                                                            lexer.SetPos(save);
                                                                            {
                                                                                soul_expected::parser::Match match(false);
                                                                                soul_expected::parser::Match* parentMatch98 = &match;
                                                                                {
                                                                                    std::int64_t pos = lexer.GetPos();
                                                                                    soul_expected::parser::Match match(false);
                                                                                    if (*lexer == RANGLE)
                                                                    ...
                                                                    *parentMatch15 = match;
                                                                    ...
                                                                    {
                                                                        soul_expected::parser::Match match(false);
                                                                        soul_expected::parser::Match* parentMatch99 = &match;
                                                                        lexer.SetPos(save);
                                                                        {
                                                                            soul_expected::parser::Match match(false);
                                                                            soul_expected::parser::Match* parentMatch100 = &match;
                                                                            {
                                                                                std::int64_t pos = lexer.GetPos();
                                                                                soul_expected::parser::Match match(false);
                                                                                if (*lexer == ASSIGN)
                                                                ...
                                                                *parentMatch14 = match;
                                                                ...
                                                                {
                                                                    soul_expected::parser::Match match(false);
                                                                    soul_expected::parser::Match* parentMatch101 = &match;
                                                                    lexer.SetPos(save);
                                                                    {
                                                                        soul_expected::parser::Match match(false);
                                                                        soul_expected::parser::Match* parentMatch102 = &match;
                                                                        {
                                                                            std::int64_t pos = lexer.GetPos();
                                                                            soul_expected::parser::Match match(false);
                                                                            if (*lexer == EXCLAMATION)
                                                            ...
                                                            *parentMatch13 = match;
                                                            ...
                                                            {
                                                                soul_expected::parser::Match match(false);
                                                                soul_expected::parser::Match* parentMatch103 = &match;
                                                                lexer.SetPos(save);
                                                                {
                                                                    soul_expected::parser::Match match(false);
                                                                    soul_expected::parser::Match* parentMatch104 = &match;
                                                                    {
                                                                        std::int64_t pos = lexer.GetPos();
                                                                        soul_expected::parser::Match match(false);
                                                                        if (*lexer == TILDE)
                                                        ...
                                                        *parentMatch12 = match;
                                                        ...
                                                        {
                                                            soul_expected::parser::Match match(false);
                                                            soul_expected::parser::Match* parentMatch105 = &match;
                                                            lexer.SetPos(save);
                                                            {
                                                                soul_expected::parser::Match match(false);
                                                                soul_expected::parser::Match* parentMatch106 = &match;
                                                                {
                                                                    std::int64_t pos = lexer.GetPos();
                                                                    soul_expected::parser::Match match(false);
                                                                    if (*lexer == AMP)
                                                    ...
                                                    *parentMatch11 = match;
                                                    ...
                                                    {
                                                        soul_expected::parser::Match match(false);
                                                        soul_expected::parser::Match* parentMatch107 = &match;
                                                        lexer.SetPos(save);
                                                        {
                                                            soul_expected::parser::Match match(false);
                                                            soul_expected::parser::Match* parentMatch108 = &match;
                                                            {
                                                                std::int64_t pos = lexer.GetPos();
                                                                soul_expected::parser::Match match(false);
                                                                if (*lexer == CARET)
                                                ...
                                                *parentMatch10 = match;
                                                ...
                                                {
                                                    soul_expected::parser::Match match(false);
                                                    soul_expected::parser::Match* parentMatch109 = &match;
                                                    lexer.SetPos(save);
                                                    {
                                                        soul_expected::parser::Match match(false);
                                                        soul_expected::parser::Match* parentMatch110 = &match;
                                                        {
                                                            std::int64_t pos = lexer.GetPos();
                                                            soul_expected::parser::Match match(false);
                                                            if (*lexer == PIPE)
                                            ...
                                            *parentMatch9 = match;
                                            ...
                                            {
                                                soul_expected::parser::Match match(false);
                                                soul_expected::parser::Match* parentMatch111 = &match;
                                                lexer.SetPos(save);
                                                {
                                                    soul_expected::parser::Match match(false);
                                                    soul_expected::parser::Match* parentMatch112 = &match;
                                                    {
                                                        std::int64_t pos = lexer.GetPos();
                                                        soul_expected::parser::Match match(false);
                                                        if (*lexer == REM)
                                        ...
                                        *parentMatch8 = match;
                                        ...
                                        {
                                            soul_expected::parser::Match match(false);
                                            soul_expected::parser::Match* parentMatch113 = &match;
                                            lexer.SetPos(save);
                                            {
                                                soul_expected::parser::Match match(false);
                                                soul_expected::parser::Match* parentMatch114 = &match;
                                                {
                                                    std::int64_t pos = lexer.GetPos();
                                                    soul_expected::parser::Match match(false);
                                                    if (*lexer == DIV)
                                    ...
                                    *parentMatch7 = match;
                                    ...
                                    {
                                        soul_expected::parser::Match match(false);
                                        soul_expected::parser::Match* parentMatch115 = &match;
                                        lexer.SetPos(save);
                                        {
                                            soul_expected::parser::Match match(false);
                                            soul_expected::parser::Match* parentMatch116 = &match;
                                            {
                                                std::int64_t pos = lexer.GetPos();
                                                soul_expected::parser::Match match(false);
                                                if (*lexer == STAR)
                                ...
                                *parentMatch6 = match;
                                ...
                                {
                                    soul_expected::parser::Match match(false);
                                    soul_expected::parser::Match* parentMatch117 = &match;
                                    lexer.SetPos(save);
                                    {
                                        soul_expected::parser::Match match(false);
                                        soul_expected::parser::Match* parentMatch118 = &match;
                                        {
                                            std::int64_t pos = lexer.GetPos();
                                            soul_expected::parser::Match match(false);
                                            if (*lexer == MINUS)
                            ...
                            *parentMatch5 = match;
                            ...
                            {
                                soul_expected::parser::Match match(false);
                                soul_expected::parser::Match* parentMatch119 = &match;
                                lexer.SetPos(save);
                                {
                                    soul_expected::parser::Match match(false);
                                    soul_expected::parser::Match* parentMatch120 = &match;
                                    {
                                        std::int64_t pos = lexer.GetPos();
                                        soul_expected::parser::Match match(false);
                                        if (*lexer == PLUS)
                        ...
                        *parentMatch4 = match;
                        ...
                        {
                            soul_expected::parser::Match match(false);
                            soul_expected::parser::Match* parentMatch121 = &match;
                            lexer.SetPos(save);
                            {
                                soul_expected::parser::Match match(false);
                                soul_expected::parser::Match* parentMatch122 = &match;
                                {
                                    soul_expected::parser::Match match(false);
                                    soul_expected::parser::Match* parentMatch123 = &match;
                                    {
                                        soul_expected::parser::Match match(false);
                                        if (*lexer == NEW)
                                        {
                                    ...
                                    {
                                        soul_expected::parser::Match match(false);
                                        soul_expected::parser::Match* parentMatch124 = &match;
                                        {
                                            soul_expected::parser::Match match(false);
                                            if (*lexer == LBRACKET)
                                            {
                                ...
                                {
                                    soul_expected::parser::Match match(false);
                                    soul_expected::parser::Match* parentMatch125 = &match;
                                    {
                                        soul_expected::parser::Match match(false);
                                        soul_expected::parser::Match* parentMatch126 = &match;
                                        {
                                            std::int64_t pos = lexer.GetPos();
                                            soul_expected::parser::Match match(false);
                                            if (*lexer == RBRACKET)
                    ...
                    *parentMatch3 = match;
                    ...
                    {
                        soul_expected::parser::Match match(false);
                        soul_expected::parser::Match* parentMatch127 = &match;
                        lexer.SetPos(save);
                        {
                            soul_expected::parser::Match match(false);
                            soul_expected::parser::Match* parentMatch128 = &match;
                            {
                                soul_expected::parser::Match match(false);
                                soul_expected::parser::Match* parentMatch129 = &match;
                                {
                                    soul_expected::parser::Match match(false);
                                    if (*lexer == DELETE)
                                    {
                                ...
                                {
                                    soul_expected::parser::Match match(false);
                                    soul_expected::parser::Match* parentMatch130 = &match;
                                    {
                                        soul_expected::parser::Match match(false);
                                        if (*lexer == LBRACKET)
                                        {
                            ...
                            {
                                soul_expected::parser::Match match(false);
                                soul_expected::parser::Match* parentMatch131 = &match;
                                {
                                    soul_expected::parser::Match match(false);
                                    soul_expected::parser::Match* parentMatch132 = &match;
                                    {
                                        std::int64_t pos = lexer.GetPos();
                                        soul_expected::parser::Match match(false);
                                        if (*lexer == RBRACKET)
                ...
                *parentMatch2 = match;
                ...
                {
                    soul_expected::parser::Match match(false);
                    soul_expected::parser::Match* parentMatch133 = &match;
                    lexer.SetPos(save);
                    {
                        soul_expected::parser::Match match(false);
                        soul_expected::parser::Match* parentMatch134 = &match;
                        {
                            std::int64_t pos = lexer.GetPos();
                            soul_expected::parser::Match match(false);
                            if (*lexer == NEW)
            ...
            *parentMatch1 = match;
            ...
            {
                soul_expected::parser::Match match(false);
                soul_expected::parser::Match* parentMatch135 = &match;
                lexer.SetPos(save);
                {
                    soul_expected::parser::Match match(false);
                    soul_expected::parser::Match* parentMatch136 = &match;
                    {
                        std::int64_t pos = lexer.GetPos();
                        soul_expected::parser::Match match(false);
                        if (*lexer == DELETE)
