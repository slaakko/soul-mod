...
module soul.cpp.expression.par;
...
import soul.cpp.declaration.par;
import soul.cpp.literal.par;
...
using namespace soul::cpp::declaration::par;
using namespace soul::cpp::literal::par;
