// this file has been automatically generated from 'C:/work/soul-mod/soul/cpp20/optimized_pp/pp.lexer' using soul lexer generator slg version 4.1.0

export module soul.cpp20.pp.lexer;
...
export namespace soul::cpp20::pp::lexer {
...
template<typename Char>
soul::lexer::Lexer<Cpp20PPLexer<Char>, Char> MakeLexer(const Char* start, const Char* end, const std::string& fileName);

soul::ast::slg::TokenCollection* GetTokens();

struct Cpp20PPLexer_Variables : public soul::lexer::Variables
{
    Cpp20PPLexer_Variables();
};

template<typename Char>
struct Cpp20PPLexer
{
    using Variables = Cpp20PPLexer_Variables;
...
{
    static ClassMap<Char>* classmap = MakeClassMap<Char>("soul.cpp20.pp.lexer.classmap");
    return classmap;
}
...
soul::lexer::Lexer<Cpp20PPLexer<Char>, Char> MakeLexer(const Char* start, const Char* end, const std::string& fileName)
{
    ...
    auto lexer = soul::lexer::Lexer<Cpp20PPLexer<Char>, Char>(start, end, fileName);
