...
std::map<int64_t, std::string>* GetRuleNameMapPtr()
{
    ...
    static std::map<int64_t, std::string> ruleNameMap = {
        ...
        { 5276324781484933159, "DeclarationParser.Declarator" },
        { 5276324781484933160, "DeclarationParser.PtrDeclarator" },
        { 5276324781484933161, "DeclarationParser.NoPtrDeclarator" },
        { 5276324781484933162, "DeclarationParser.ParametersAndQualifiers" },
        { 5276324781484933163, "DeclarationParser.TrailingReturnType" },
        { 5276324781484933164, "DeclarationParser.PtrOperator" },
        { 5276324781484933165, "DeclarationParser.AbstractDeclarator" },
        { 5276324781484933166, "DeclarationParser.NoPtrAbstractDeclarator" },
        { 5276324781484933167, "DeclarationParser.PtrAbstractDeclarator" },
        { 5276324781484933168, "DeclarationParser.AbstractPackDeclarator" },
        { 5276324781484933169, "DeclarationParser.NoPtrAbstractPackDeclarator" },
        { 5276324781484933170, "DeclarationParser.DeclaratorId" },
        { 5276324781484933171, "DeclarationParser.Ptr" },
        { 5276324781484933172, "DeclarationParser.LvalueRef" },
        { 5276324781484933173, "DeclarationParser.RvalueRef" },
        { 5276324781484933174, "DeclarationParser.RefQualifier" },
        { 5276324781484933175, "DeclarationParser.CVQualifierSeq" },
        { 5276324781484933176, "DeclarationParser.CVQualifier" },
        { 5276324781484933177, "DeclarationParser.NoexceptSpecifier" },
        { 5276324781484933178, "DeclarationParser.ThrowSpecifier" },
        { 5276324781484933179, "DeclarationParser.AttributeDeclaration" },
