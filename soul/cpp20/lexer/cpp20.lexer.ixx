...
template<typename Char>
soul::lexer::Lexer<Cpp20Lexer<Char>, Char> MakeLexer(const Char* start, const Char* end, const std::string& fileName);

soul::ast::slg::TokenCollection* GetTokens();

struct Cpp20Lexer_Variables : public soul::lexer::Variables
{
    Cpp20Lexer_Variables();
    int langleCount;
};
...
struct Cpp20Lexer
{
    using Variables = Cpp20Lexer_Variables;
...
{
    static ClassMap<Char>* classmap = MakeClassMap<Char>("soul.cpp20.lexer.classmap");
    return classmap;
}
...
soul::lexer::Lexer<Cpp20Lexer<Char>, Char> MakeLexer(const Char* start, const Char* end, const std::string& fileName)
{
    ...
    auto lexer = soul::lexer::Lexer<Cpp20Lexer<Char>, Char>(start, end, fileName);
