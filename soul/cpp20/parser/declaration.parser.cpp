...
// this file has been automatically generated from 'C:/work/soul-mod/soul/cpp20/parser/declaration.parser' using soul parser generator spg version 4.1.0
...
template<typename Lexer>
soul::parser::Match DeclarationParser<Lexer>::NamespaceDeclarationSeq(Lexer& lexer, soul::cpp20::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soul::parser::Match DeclarationParser<Lexer>::Declaration(Lexer& lexer, soul::cpp20::symbols::Context* context)
{
    ...
    std::unique_ptr<soul::cpp20::ast::Node> noDeclSpecDef;
                                            ...
                                            if (!match.hit)
                                            {
                                                ...
                                                lexer.SetPos(save);
                                                {
                                                    ...
                                                    soul::parser::Match* parentMatch21 = &match;
                                                    {
                                                        ...
                                                        noDeclSpecDef.reset(static_cast<soul::cpp20::ast::Node*>(match.value));
                                                        if (match.hit)
                                                        {
                                                            {
                                                                #ifdef SOUL_PARSER_DEBUG_SUPPORT
            ...
            if (match.hit)
            {
                ...
                soul::parser::Match* parentMatch20 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch21 = &match;
                    {
                        ...
                        {
                            rbPos = lexer.GetSourcePos(pos);
                            soul::cpp20::symbols::EndNamespace(nsName.get(), 1, context);
                        }
                        *parentMatch21 = match;
                    }
                    *parentMatch20 = match;
...
template<typename Lexer>
soul::parser::Match DeclarationParser<Lexer>::DeclaratorPushClassScope(Lexer& lexer, soul::cpp20::symbols::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                if (match.hit)
                {
                    context->PushSetFlag(soul::cpp20::symbols::ContextFlags::addClassScope);
                }
                *parentMatch2 = match;
            }
            *parentMatch1 = match;
...
soul::parser::Match DeclarationParser<Lexer>::DeclaratorId(Lexer& lexer, soul::cpp20::symbols::Context* context)
{
    ...
    std::unique_ptr<soul::cpp20::ast::Node> idExprNode = std::unique_ptr<soul::cpp20::ast::Node>();
    soul::ast::SourcePos sourcePos = soul::ast::SourcePos();
    std::unique_ptr<soul::cpp20::ast::Node> ellipsis;
                ...
                lexer.SetPos(save);
                {
                    ...
                    soul::parser::Match* parentMatch7 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            ...
                            soul::cpp20::symbols::AddParentScope(idExprNode.get(), context);
                            {
                                #ifdef SOUL_PARSER_DEBUG_SUPPORT
                                if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "DeclaratorId");
                                #endif
