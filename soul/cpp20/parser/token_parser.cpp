...
module soul.cpp20.parser.token;
    ...
    const soul::lexer::Token<char32_t, soul::lexer::LexerBase<char32_t>>& token)
{
    ...
    return new soul::cpp20::ast::IntegerLiteralNode(sourcePos, value, suffix, base, token.ToString());
}
    ...
    const soul::lexer::Token<char32_t, soul::lexer::LexerBase<char32_t>>& token)
{
    ...
    return new soul::cpp20::ast::FloatingLiteralNode(sourcePos, value, suffix, base, token.ToString());
}
    ...
    const soul::lexer::Token<char32_t, soul::lexer::LexerBase<char32_t>>& token)
{
    ...
    return new soul::cpp20::ast::CharacterLiteralNode(sourcePos, value, encodingPrefix, token.ToString(), hasMultipleCharacters);
}
...
soul::cpp20::ast::RawStringLiteralNode* ParseRawStringLiteral(const soul::ast::SourcePos& sourcePos, soul::lexer::LexerBase<char32_t>& lexer)
{
    ...
    return new soul::cpp20::ast::RawStringLiteralNode(sourcePos, value, encodingPrefix, dm, rep);
}
    ...
    const soul::lexer::Token<char32_t, soul::lexer::LexerBase<char32_t>>& token)
{
    ...
    return new soul::cpp20::ast::StringLiteralNode(sourcePos, value, encodingPrefix, token.ToString());
}
