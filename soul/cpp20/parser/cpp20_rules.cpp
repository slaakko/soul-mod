...
std::map<int64_t, std::string>* GetRuleNameMapPtr()
{
    ...
    static std::map<int64_t, std::string> ruleNameMap = {
        ...
        { 7901898380417171459, "ConceptParser.ConstraintExpression" },
        { 7901898380417171460, "ConceptParser.RequiresClause" },
        { 7901898380417171461, "ConceptParser.ConstraintLogicalOrExpression" },
        { 7901898380417171462, "ConceptParser.ConstraintLogicalAndExpression" },
        { 7901898380417171463, "ConceptParser.RequiresExpression" },
        { 7901898380417171464, "ConceptParser.RequirementParameterList" },
        { 7901898380417171465, "ConceptParser.RequirementBody" },
        { 7901898380417171466, "ConceptParser.RequirementSeq" },
        { 7901898380417171467, "ConceptParser.Requirement" },
        { 7901898380417171468, "ConceptParser.SimpleRequirement" },
        { 7901898380417171469, "ConceptParser.TypeRequirement" },
        { 7901898380417171470, "ConceptParser.CompoundRequirement" },
        { 7901898380417171471, "ConceptParser.ReturnTypeRequirement" },
        { 7901898380417171472, "ConceptParser.NestedRequirement" },
        { 7901898380417171473, "ConceptParser.TypeConstraint" },
