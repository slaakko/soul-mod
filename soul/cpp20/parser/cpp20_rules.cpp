...
std::map<int64_t, std::string>* GetRuleNameMapPtr()
{
    ...
    static std::map<int64_t, std::string> ruleNameMap = {
        ...
        { 8201428699560542228, "ClassParser.RetMemberFunctionDefinition" },
        { 8201428699560542229, "ClassParser.MemberTemplateDeclaration" },
        { 8201428699560542230, "ClassParser.MemberDeclaratorList" },
        { 8201428699560542231, "ClassParser.MemberDeclarator" },
        { 8201428699560542232, "ClassParser.CtorInitializer" },
        { 8201428699560542233, "ClassParser.MemberInitializerList" },
        { 8201428699560542234, "ClassParser.MemberInitializer" },
        { 8201428699560542235, "ClassParser.MemberInitializerId" },
        { 8201428699560542236, "ClassParser.PureSpecifier" },
        { 8201428699560542237, "ClassParser.AccessSpecifier" },
        { 8201428699560542238, "ClassParser.Private" },
        { 8201428699560542239, "ClassParser.VirtualSpecifier" },
