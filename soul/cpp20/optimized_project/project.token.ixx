...
// this file has been automatically generated from 'C:/work/soul-mod/soul/cpp20/optimized_project/project.token' using soul lexer generator version 4.0.0

export module soul.cpp20.proj.token;

import std.core;

export namespace soul::cpp20::proj::token {

constexpr int32_t tokenSetID = 918703099;

constexpr int64_t PROJECT = (static_cast<int64_t>(tokenSetID) << 32) | 1;
