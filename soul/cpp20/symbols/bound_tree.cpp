...
module soul.cpp20.symbols.bound.tree;
...
BoundCompileUnitNode::BoundCompileUnitNode() : BoundNode(BoundNodeKind::boundCompileUnitNode), operationRepository(nullptr)
{
}

void BoundCompileUnitNode::SetOperationRepository(OperationRepository* operationRepository_)
{
    operationRepository = operationRepository_;
}
...
Scope* BoundExpressionNode::GetMemberScope(soul::cpp20::ast::Node* op, const soul::ast::SourcePos& sourcePos, Context* context) const
{
    if (type)
    {
        if (op->IsDotNode())
...
BoundBinaryExprNode::BoundBinaryExprNode(BoundExpressionNode* left_, BoundExpressionNode* right_, soul::cpp20::ast::NodeKind kind_) :
    BoundExpressionNode(BoundNodeKind::boundBinaryExprNode, nullptr), left(left_), right(right_), kind(kind_)
{
}

void BoundBinaryExprNode::Accept(BoundTreeVisitor& visitor)
{
    visitor.Visit(*this);
}

BoundUnaryExprNode::BoundUnaryExprNode(BoundExpressionNode* child_, soul::cpp20::ast::NodeKind kind_) :
    BoundExpressionNode(BoundNodeKind::boundUnaryExprNode, nullptr), child(child_), kind(kind_)
{
}

void BoundUnaryExprNode::Accept(BoundTreeVisitor& visitor)
{
    visitor.Visit(*this);
}
