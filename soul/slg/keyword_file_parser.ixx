...
std::unique_ptr<soul::ast::slg::KeywordFile> KeywordFileParser<Lexer>::Parse(Lexer& lexer)
{
    ...
    if (lexer.Log())
    {
        lexer.Log()->WriteBeginRule(util::ToUtf32("parse"));
        lexer.Log()->IncIndent();
    }
    ...
    {
        lexer.Log()->DecIndent();
        lexer.Log()->WriteEndRule(util::ToUtf32("parse"));
    }
    #endif // SOUL_PARSER_DEBUG_SUPPORT
    if (match.hit)
    {
...
soul::parser::Match KeywordFileParser<Lexer>::KeywordFile(Lexer& lexer)
{
    ...
    if (parser_debug_write_to_log)
    {
        ...
        soul::lexer::WriteBeginRuleToLog(lexer, util::ToUtf32("KeywordFile"));
    }
    #endif // SOUL_PARSER_DEBUG_SUPPORT
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            ...
            {
                #ifdef SOUL_PARSER_DEBUG_SUPPORT
                if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, util::ToUtf32("KeywordFile"));
                #endif // SOUL_PARSER_DEBUG_SUPPORT
    ...
    if (parser_debug_write_to_log)
    {
        if (match.hit) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, util::ToUtf32("KeywordFile"));
        else soul::lexer::WriteFailureToLog(lexer, util::ToUtf32("KeywordFile"));
    }
    #endif // SOUL_PARSER_DEBUG_SUPPORT
    if (!match.hit)
    {
...
soul::parser::Match KeywordFileParser<Lexer>::Imports(Lexer& lexer, soul::ast::slg::KeywordFile* keywordFile)
{
    ...
    {
        parser_debug_match_pos = lexer.GetPos();
        soul::lexer::WriteBeginRuleToLog(lexer, util::ToUtf32("Imports"));
    }
    #endif // SOUL_PARSER_DEBUG_SUPPORT
    ...
    if (parser_debug_write_to_log)
    {
        if (match.hit) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, util::ToUtf32("Imports"));
        else soul::lexer::WriteFailureToLog(lexer, util::ToUtf32("Imports"));
    }
    #endif // SOUL_PARSER_DEBUG_SUPPORT
    if (!match.hit)
    {
...
soul::parser::Match KeywordFileParser<Lexer>::Keyword(Lexer& lexer)
{
    ...
    {
        parser_debug_match_pos = lexer.GetPos();
        soul::lexer::WriteBeginRuleToLog(lexer, util::ToUtf32("Keyword"));
    }
    #endif // SOUL_PARSER_DEBUG_SUPPORT
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            {
                #ifdef SOUL_PARSER_DEBUG_SUPPORT
                if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, util::ToUtf32("Keyword"));
                #endif // SOUL_PARSER_DEBUG_SUPPORT
    ...
    if (parser_debug_write_to_log)
    {
        if (match.hit) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, util::ToUtf32("Keyword"));
        else soul::lexer::WriteFailureToLog(lexer, util::ToUtf32("Keyword"));
    }
    #endif // SOUL_PARSER_DEBUG_SUPPORT
    if (!match.hit)
    {
