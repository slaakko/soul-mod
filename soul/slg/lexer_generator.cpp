...
{
    std::string interfaceFilePath = util::GetFullPath(util::Path::Combine(root, util::Path::GetFileNameWithoutExtension(lexerContext.FileName()) + ".ixx"));
    std::string sourceFilePath = util::GetFullPath(util::Path::Combine(root, util::Path::GetFileNameWithoutExtension(lexerContext.FileName()) + ".cpp"));
