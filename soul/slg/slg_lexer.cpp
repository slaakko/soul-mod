// this file has been automatically generated from 'C:/work/soul-mod/soul/slg/slg_lexer.lexer' using soul lexer generator slg version 4.0.0
...
namespace soul::slg::lex {

soul::ast::slg::TokenCollection* GetTokens()
{
    static soul::ast::slg::TokenCollection tokens("soul.slg.lex.tokens"); 
    ...
    tokens.AddToken(new soul::ast::slg::Token(BIT_OR, "BIT_OR", "'|'"));
    tokens.AddToken(new soul::ast::slg::Token(BIT_XOR, "BIT_XOR", "'^'"));
