...
soul::parser::Match TokenFileParser<Lexer>::TokenFile(Lexer& lexer)
{
    ...
    if (parser_debug_write_to_log)
    {
        ...
        soul::lexer::WriteBeginRuleToLog(lexer, util::ToUtf32("TokenFile"));
    }
    #endif // SOUL_PARSER_DEBUG_SUPPORT
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            ...
            {
                #ifdef SOUL_PARSER_DEBUG_SUPPORT
                if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, util::ToUtf32("TokenFile"));
                #endif // SOUL_PARSER_DEBUG_SUPPORT
    ...
    if (parser_debug_write_to_log)
    {
        if (match.hit) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, util::ToUtf32("TokenFile"));
        else soul::lexer::WriteFailureToLog(lexer, util::ToUtf32("TokenFile"));
    }
    #endif // SOUL_PARSER_DEBUG_SUPPORT
    if (!match.hit)
    {
...
soul::parser::Match TokenFileParser<Lexer>::Token(Lexer& lexer)
{
    ...
    {
        parser_debug_match_pos = lexer.GetPos();
        soul::lexer::WriteBeginRuleToLog(lexer, util::ToUtf32("Token"));
    }
    #endif // SOUL_PARSER_DEBUG_SUPPORT
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch11 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch12 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                info = ParseStringLiteral(lexer.FileName(), lexer.GetToken(pos));
                            }
                            *parentMatch12 = match;
                        }
                        *parentMatch11 = match;
        ...
        if (match.hit)
        {
            {
                #ifdef SOUL_PARSER_DEBUG_SUPPORT
                if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, util::ToUtf32("Token"));
                #endif // SOUL_PARSER_DEBUG_SUPPORT
    ...
    if (parser_debug_write_to_log)
    {
        if (match.hit) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, util::ToUtf32("Token"));
        else soul::lexer::WriteFailureToLog(lexer, util::ToUtf32("Token"));
    }
    #endif // SOUL_PARSER_DEBUG_SUPPORT
    if (!match.hit)
    {
