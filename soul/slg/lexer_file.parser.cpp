...
// this file has been automatically generated from 'C:/work/soul-mod/soul/slg/lexer_file.parser' using soul parser generator spg version 5.0.0
                        ...
                        soul::parser::Match* parentMatch5 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    ...
                                    {
                                        soul::parser::Match match = LexerFileParser<LexerT>::Imports(lexer, lexerFile.get());
                                        *parentMatch12 = match;
                                    }
                                    *parentMatch7 = match;
                                }
                        ...
                        soul::parser::Match* parentMatch20 = &match;
                        {
                            while (true)
                            {
                                int64_t save = lexer.GetPos();
                                {
                                    ...
                                    {
                                        soul::parser::Match match = LexerFileParser<LexerT>::LexerContent(lexer, lxr.get());
                                        *parentMatch21 = match;
                                    }
                                    if (match.hit)
                                    {
        ...
        soul::parser::Match* parentMatch1 = &match;
        {
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        soul::parser::Match match = LexerFileParser<LexerT>::Variables(lexer, lxr);
                        *parentMatch3 = match;
                    }
                    *parentMatch2 = match;
                }
            ...
            *parentMatch1 = match;
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    soul::parser::Match match = LexerFileParser<LexerT>::Actions(lexer, lxr);
                    *parentMatch4 = match;
                }
                *parentMatch1 = match;
            }
