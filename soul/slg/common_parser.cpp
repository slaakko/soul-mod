...
// this file has been automatically generated from 'C:/work/soul-mod/soul/slg/common_parser.parser' using soul parser generator spg version 4.0.0

module soul.slg.common.par;
...
template<typename Lexer>
soul::parser::Match CommonParser<Lexer>::ExportModule(Lexer& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    #endif // SOUL_PARSER_DEBUG_SUPPORT
    std::unique_ptr<soul::ast::spg::ExportModule> exp = std::unique_ptr<soul::ast::spg::ExportModule>();
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch6 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch7 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                exp.reset(new soul::ast::spg::ExportModule(moduleName->value));
                            }
                            *parentMatch7 = match;
                        }
                        *parentMatch6 = match;
...
template<typename Lexer>
soul::parser::Match CommonParser<Lexer>::Import(Lexer& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    #endif // SOUL_PARSER_DEBUG_SUPPORT
    std::unique_ptr<soul::ast::spg::Import> imp = std::unique_ptr<soul::ast::spg::Import>();
    soul::ast::spg::ImportPrefix prefix = soul::ast::spg::ImportPrefix();
    std::unique_ptr<soul::parser::Value<soul::ast::spg::ImportPrefix>> importPrefix;
    std::unique_ptr<soul::parser::Value<std::string>> moduleName;
    soul::parser::Match match(false);
    soul::parser::Match* parentMatch0 = &match;
    {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch5 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                {
                                    int64_t pos = lexer.GetPos();
                                    soul::parser::Match match = CommonParser<Lexer>::ImportPrefix(lexer);
                                    importPrefix.reset(static_cast<soul::parser::Value<soul::ast::spg::ImportPrefix>*>(match.value));
                                    if (match.hit)
                                    {
                                ...
                                if (!match.hit)
                                {
                                    ...
                                    lexer.SetPos(save);
                                    {
                                        ...
                                        soul::parser::Match* parentMatch9 = &match;
                                        {
                                            ...
                                            if (match.hit)
                                            {
                                                prefix = soul::ast::spg::ImportPrefix::interfacePrefix;
                                            }
                                            *parentMatch9 = match;
                                        }
                                        *parentMatch8 = match;
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch11 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch12 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                imp.reset(new soul::ast::spg::Import(moduleName->value, prefix));
                            }
                            *parentMatch12 = match;
                        }
                        *parentMatch11 = match;
...
template<typename Lexer>
soul::parser::Match CommonParser<Lexer>::ImportPrefix(Lexer& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            {
                {
                    ...
                    #endif // SOUL_PARSER_DEBUG_SUPPORT
                    return soul::parser::Match(true, new soul::parser::Value<soul::ast::spg::ImportPrefix>(soul::ast::spg::ImportPrefix::implementationPrefix));
                }
            }
            break;
        }
            ...
            {
                {
                    ...
                    if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "ImportPrefix");
                    #endif // SOUL_PARSER_DEBUG_SUPPORT
                    return soul::parser::Match(true, new soul::parser::Value<soul::ast::spg::ImportPrefix>(soul::ast::spg::ImportPrefix::interfacePrefix));
                }
            }
            break;
        }
...
template<typename Lexer>
soul::parser::Match CommonParser<Lexer>::ExprString(Lexer& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
template<typename Lexer>
soul::parser::Match CommonParser<Lexer>::FilePath(Lexer& lexer)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
