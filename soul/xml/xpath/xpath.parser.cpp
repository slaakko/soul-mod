...
// this file has been automatically generated from 'D:/work/soul-mod/soul/xml/xpath/xpath.parser' using soul parser generator spg version 5.0.0
...
soul::parser::Match XPathParser<LexerT>::PrimaryExpr(LexerT& lexer)
{
    ...
    switch (*lexer)
    {
        ...
        case soul::xml::xpath::token::NUMBER:
        {
            ...
            {
                std::int64_t pos = lexer.GetPos();
                soul::parser::Match match = soul::xml::xpath::parser::XPathParser<LexerT>::Number(lexer);
