// this file has been automatically generated from 'C:/work/soul-mod/soul/xml/serialization/xmlser.lexer' using soul lexer generator slg version 5.0.0
...
export namespace soul::xml::serialization::lexer {
...
template<typename Char>
soul::lexer::Lexer<XmlSerLexer<Char>, Char> MakeLexer(const Char* start, const Char* end, const std::string& fileName);

template<typename Char>
soul::lexer::Lexer<XmlSerLexer<Char>, Char> MakeLexer(const std::string& moduleFileName, util::ResourceFlags resourceFlags, const Char* start, const Char* end, const std::string& fileName);

soul::ast::common::TokenCollection* GetTokens();

struct XmlSerLexer_Variables : public soul::lexer::Variables
{
    XmlSerLexer_Variables();
};

template<typename Char>
struct XmlSerLexer
{
    using Variables = XmlSerLexer_Variables;
...
{
    static soul::lexer::ClassMap<Char>* classmap = soul::lexer::MakeClassMap<Char>("soul.xml.serialization.lexer.classmap");
    return classmap;
}
...
{
    static soul::lexer::ClassMap<Char>* classmap = soul::lexer::MakeClassMap<Char>(moduleFileName, "soul.xml.serialization.lexer.classmap", resourceFlags);
    return classmap;
}
...
soul::lexer::Lexer<XmlSerLexer<Char>, Char> MakeLexer(const Char* start, const Char* end, const std::string& fileName)
{
    ...
    auto lexer = soul::lexer::Lexer<XmlSerLexer<Char>, Char>(start, end, fileName);
