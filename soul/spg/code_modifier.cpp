...
public:
    CodeModifierVisitor(bool ptrType_, const std::vector<NonterminalInfo>& nonterminalInfos_, soul::ast::cpp::TypeIdNode* returnType_, bool noDebugSupport_, 
        const std::string& ruleName_, soul::lexer::FileMap& fileMap_);
    ...
    if (node.Expr())
    {
        ...
        if (!noDebugSupport)
        {
            ...
            if (parent->IsCompoundStatementNode())
            {
                ...
                soul::ast::cpp::InvokeNode* invokeNode = new soul::ast::cpp::InvokeNode(sourcePos, new soul::ast::cpp::IdExprNode(sourcePos, "soul::lexer::WriteSuccessToLog"));
