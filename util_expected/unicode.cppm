...
export module util_expected.unicode;
...
public:
    ...
    std::expected<const CharacterInfo*, int> GetCharacterInfo(char32_t codePoint);
    std::expected<CharacterInfo*, int> CreateCharacterInfo(char32_t codePoint);
    std::expected<ExtendedCharacterInfo*, int> GetExtendedCharacterInfo(char32_t codePoint);
...
inline std::expected<ExtendedCharacterInfo*, int> GetExtendedCharacterInfo(char32_t codePoint) { return CharacterTable::Instance().GetExtendedCharacterInfo(codePoint); }
